...
/*
 *	CFBamDbKeyHash224ColTable database interface for DbKeyHash224Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
