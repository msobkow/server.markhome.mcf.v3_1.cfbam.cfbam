	...
	implements ICFBamDelSubDep1
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDelSubDep1 rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDelSubDep1H rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtScope src ) {
		if( src instanceof CFBamProtBuffDelSubDep1 ) {
			setDelSubDep1( (CFBamProtBuffDelSubDep1)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffDelSubDep1 ) {
			setDelSubDep1( (CFBamPubBuffDelSubDep1)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
