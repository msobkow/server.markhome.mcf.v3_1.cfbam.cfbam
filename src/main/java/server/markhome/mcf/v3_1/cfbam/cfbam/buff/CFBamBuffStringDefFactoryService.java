...
// Description: Java 25 Factory service implementation for StringDef buffers
...
/*
 *	Java 25 Factory service implementation for StringDef buffers.
 */
@Service("cfbam31BuffStringDefFactoryService")
public class CFBamBuffStringDefFactoryService
	implements ICFBamStringDefFactory
{
	public CFBamBuffStringDefFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamStringDef",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamStringDef");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamStringDef",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamStringDef");
			}
		}
	}
