	...
	implements ICFBamInt32Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt32Type rhs ) {
		...
		else if( obj instanceof ICFBamInt32TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt32Type ) {
			setInt32Type( (CFBamProtBuffInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt32Type ) {
			setInt32Type( (CFBamPubBuffInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
