// Description: Java 25 edit object instance implementation for CFBam TZTimeType.
	...
	implements ICFBamTZTimeTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTZTimeTypeTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsTZTimeType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getTZTimeTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getTZTimeTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamTZTimeType origRec = getOrigAsTZTimeType().getTZTimeTypeRec();
		ICFBamTZTimeType myRec = getTZTimeTypeRec();
		origRec.set( myRec );
	}
