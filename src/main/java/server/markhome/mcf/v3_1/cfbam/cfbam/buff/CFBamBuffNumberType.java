	...
	implements ICFBamNumberType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNumberType rhs ) {
		...
		else if( obj instanceof ICFBamNumberTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNumberType ) {
			setNumberType( (CFBamProtBuffNumberType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNumberType ) {
			setNumberType( (CFBamPubBuffNumberType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
