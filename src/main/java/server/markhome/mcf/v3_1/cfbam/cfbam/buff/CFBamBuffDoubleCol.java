	...
	implements ICFBamDoubleCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDoubleCol rhs ) {
		...
		else if( obj instanceof ICFBamDoubleColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDoubleCol ) {
			setDoubleCol( (CFBamProtBuffDoubleCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDoubleCol ) {
			setDoubleCol( (CFBamPubBuffDoubleCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
