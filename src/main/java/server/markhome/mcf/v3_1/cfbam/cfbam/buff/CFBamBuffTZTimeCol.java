	...
	implements ICFBamTZTimeCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimeCol rhs ) {
		...
		else if( obj instanceof ICFBamTZTimeColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZTimeCol ) {
			setTZTimeCol( (CFBamProtBuffTZTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimeCol ) {
			setTZTimeCol( (CFBamPubBuffTZTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
