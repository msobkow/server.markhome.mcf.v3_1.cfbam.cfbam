// Description: Java 25 base object instance implementation for PopSubDep1
	...
	implements ICFBamPopSubDep1Obj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)schema).getPopSubDep1TableObj().getClassCode() );
	}
	...
	public ICFBamScopeObj realise() {
		ICFBamPopSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().realisePopSubDep1(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().reallyDeepDisposePopSubDep1( (ICFBamPopSubDep1Obj)this );
	}

	@Override
	public ICFBamScopeObj read() {
		ICFBamPopSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().readPopSubDep1ByIdIdx( getPKey(), false );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamScopeObj read( boolean forceRead ) {
		ICFBamPopSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().readPopSubDep1ByIdIdx( getPKey(), forceRead );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamPopSubDep1TableObj getPopSubDep1Table() {
		return( ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj() );
	}
	...
	public ICFBamScope getRec() {
		if( rec == null ) {
			if( isNew ) {
				rec = getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep1().newRec();
			}
			else {
				// Read the data rec via the backing store
				rec = getSchema().getCFBamBackingStore().getTablePopSubDep1().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public void setRec( ICFBamScope value ) {
		if( ! ( ( value == null ) || ! ( value instanceof ICFBamPopSubDep1 ) ) ) {
	...
	public ICFBamScopeEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().lockPopSubDep1( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getPopSubDep1TableObj().newEditInstance( lockobj );
	...
	public ICFBamPopTopDepObj getRequiredContainerContPopTopDep( boolean forceRead ) {
		if( ( requiredContainerContPopTopDep == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerContPopTopDep = ((ICFBamSchemaObj)getSchema()).getPopTopDepTableObj().readPopTopDepByIdIdx( getPopSubDep1Rec().getRequiredPopTopDepId(), forceRead );
			}
		}
	...
	@Override
	public $implJavaAtomType$ getRequiredPopTopDepId() {
