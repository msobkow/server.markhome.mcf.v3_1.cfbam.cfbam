// Description: Java 25 edit object instance implementation for CFBam Int16Def.
	...
	implements ICFBamInt16DefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt16DefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt16Def().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt16Def().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setOptionalInitValue( Short value ) {
		if( getInt16DefRec().getOptionalInitValue() != value ) {
			getInt16DefRec().setOptionalInitValue( value );
		}
	}
	...
	public void setOptionalMinValue( Short value ) {
		if( getInt16DefRec().getOptionalMinValue() != value ) {
			getInt16DefRec().setOptionalMinValue( value );
		}
	}
	...
	public void setOptionalMaxValue( Short value ) {
		if( getInt16DefRec().getOptionalMaxValue() != value ) {
			getInt16DefRec().setOptionalMaxValue( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamInt16Def origRec = getOrigAsInt16Def().getInt16DefRec();
		ICFBamInt16Def myRec = getInt16DefRec();
		origRec.set( myRec );
	}
