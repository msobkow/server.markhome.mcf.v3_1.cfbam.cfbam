	...
	implements ICFBamUuid6Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6Col rhs ) {
		...
		else if( obj instanceof ICFBamUuid6ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuid6Col ) {
			setUuid6Col( (CFBamProtBuffUuid6Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Col ) {
			setUuid6Col( (CFBamPubBuffUuid6Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
