	...
	implements ICFBamIndexTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> allIndex;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > > indexByTenantIdx;
	private Map< ICFBamIndexByUNameIdxKey,
		ICFBamIndexObj > indexByUNameIdx;
	private Map< ICFBamIndexByIdxTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > > indexByIdxTableIdx;
	private Map< ICFBamIndexByIdxCodeVisIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > > indexByIdxCodeVisIdx;
	private Map< ICFBamIndexByIdxTblCdVisXKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > > indexByIdxTblCdVisX;
	private Map< ICFBamIndexByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > > indexByDefSchemaIdx;
	public static String TABLE_NAME = "Index";
	public static String TABLE_DBNAME = "idxdef";

	public CFBamIndexTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamIndexObj>();
		allIndex = null;
	...
	public ICFBamIndexObj realiseIndex( ICFBamIndexObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByUNameIdx != null ) {
				ICFBamIndexByUNameIdxKey keyUNameIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByUNameIdxKey();
			...
			if( indexByIdxTableIdx != null ) {
				ICFBamIndexByIdxTableIdxKey keyIdxTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTableIdxKey();
				keyIdxTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > mapIdxTableIdx = indexByIdxTableIdx.get( keyIdxTableIdx );
			...
			if( indexByIdxCodeVisIdx != null ) {
				ICFBamIndexByIdxCodeVisIdxKey keyIdxCodeVisIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxCodeVisIdxKey();
				keyIdxCodeVisIdx.setRequiredCodeVis( keepObj.getRequiredCodeVis() );
				Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > mapIdxCodeVisIdx = indexByIdxCodeVisIdx.get( keyIdxCodeVisIdx );
			...
			if( indexByIdxTblCdVisX != null ) {
				ICFBamIndexByIdxTblCdVisXKey keyIdxTblCdVisX =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTblCdVisXKey();
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > mapIdxTblCdVisX = indexByIdxTblCdVisX.get( keyIdxTblCdVisX );
			...
			if( indexByDefSchemaIdx != null ) {
				ICFBamIndexByDefSchemaIdxKey keyDefSchemaIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByDefSchemaIdxKey();
				keyDefSchemaIdx.setOptionalDefSchemaId( keepObj.getOptionalDefSchemaId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
	...
	@Override
	public ICFBamIndexObj readIndex( $implCommaIJavaOptAtomType$ pkey ) {
		return( readIndex( pkey, false ) );
	}

	@Override
	public ICFBamIndexObj readIndex( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamIndexObj readCachedIndex( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamIndexObj obj = null;
	...
	public void reallyDeepDisposeIndex( ICFBamIndexObj obj )
	{
		...
		members.remove( pkey );
		ICFBamIndexByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByUNameIdxKey();
		keyUNameIdx.setRequiredTableId( existing.getRequiredTableId() );
		keyUNameIdx.setRequiredName( existing.getRequiredName() );

		ICFBamIndexByIdxTableIdxKey keyIdxTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTableIdxKey();
		keyIdxTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		ICFBamIndexByIdxCodeVisIdxKey keyIdxCodeVisIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxCodeVisIdxKey();
		keyIdxCodeVisIdx.setRequiredCodeVis( existing.getRequiredCodeVis() );

		ICFBamIndexByIdxTblCdVisXKey keyIdxTblCdVisX = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTblCdVisXKey();
		...
		ICFBamIndexByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByDefSchemaIdxKey();
	...
	@Override
	public void deepDisposeIndex( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamIndexObj lockIndex( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamIndexObj> readAllIndex( boolean forceRead ) {
		...
		if( ( allIndex == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamIndexObj>();
			allIndex = map;
	...
	@Override
	public ICFBamIndexObj readIndexByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamIndexObj readIndexByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public List<ICFBamIndexObj> readIndexByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamIndexObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamIndexObj>();
			ICFBamScopeObj obj;
	...
	@Override
	public ICFBamIndexObj readIndexByUNameIdx( ICFLibKeyHash256 TableId,
		String Name )
	{
		...
		String Name, boolean forceRead )
	{
		...
		ICFBamIndexByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamIndexObj> readIndexByIdxTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamIndexByIdxTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTableIdxKey();
		key.setRequiredTableId( TableId );
		Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict;
		if( indexByIdxTableIdx == null ) {
	...
	@Override
	public List<ICFBamIndexObj> readIndexByIdxTblCdVisX( ICFLibKeyHash256 TableId,
	...
	@Override
	public List<ICFBamIndexObj> readIndexByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamIndexByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByDefSchemaIdxKey();
	...
	@Override
	public ICFBamIndexObj readCachedIndexByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamIndexObj obj = null;
	...
	@Override
	public List<ICFBamIndexObj> readCachedIndexByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public ICFBamIndexObj readCachedIndexByUNameIdx( ICFLibKeyHash256 TableId,
		String Name )
	{
		ICFBamIndexObj obj = null;
		ICFBamIndexByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamIndexObj> readCachedIndexByIdxTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public List<ICFBamIndexObj> readCachedIndexByIdxTblCdVisX( ICFLibKeyHash256 TableId,
		ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
	...
	@Override
	public List<ICFBamIndexObj> readCachedIndexByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeIndexByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeIndexByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public void deepDisposeIndexByUNameIdx( ICFLibKeyHash256 TableId,
		String Name )
	{
	...
	@Override
	public void deepDisposeIndexByIdxTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeIndexByIdxTblCdVisX( ICFLibKeyHash256 TableId,
		ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
	...
	@Override
	public void deepDisposeIndexByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deleteIndexByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteIndexByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		ICFBamScopeByTenantIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryScope().newByTenantIdxKey();
		key.setRequiredTenantId( TenantId );
		if( indexByTenantIdx == null ) {
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict = indexByTenantIdx.get( key );
	...
	@Override
	public void deleteIndexByUNameIdx( ICFLibKeyHash256 TableId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamIndexByUNameIdxKey,
	...
	@Override
	public void deleteIndexByIdxTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamIndexByIdxTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByIdxTableIdx == null ) {
		...
		if( indexByIdxTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict = indexByIdxTableIdx.get( key );
	...
	public void deleteIndexByIdxCodeVisIdx( ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		...
		if( indexByIdxCodeVisIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict = indexByIdxCodeVisIdx.get( key );
	...
	@Override
	public void deleteIndexByIdxTblCdVisX( ICFLibKeyHash256 TableId,
		ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		ICFBamIndexByIdxTblCdVisXKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByIdxTblCdVisXKey();
		key.setRequiredTableId( TableId );
		...
		if( indexByIdxTblCdVisX.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict = indexByIdxTblCdVisX.get( key );
	...
	@Override
	public void deleteIndexByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamIndexByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryIndex().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamIndexObj> dict = indexByDefSchemaIdx.get( key );
