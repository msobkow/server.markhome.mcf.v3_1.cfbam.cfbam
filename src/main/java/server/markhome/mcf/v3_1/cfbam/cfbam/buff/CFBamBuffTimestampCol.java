	...
	implements ICFBamTimestampCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimestampCol rhs ) {
		...
		else if( obj instanceof ICFBamTimestampColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimestampCol ) {
			setTimestampCol( (CFBamProtBuffTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampCol ) {
			setTimestampCol( (CFBamPubBuffTimestampCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
