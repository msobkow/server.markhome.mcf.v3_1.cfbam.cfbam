	...
	implements ICFBamUuid6ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> allUuid6Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUuid6ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByContNextIdx;
	private Map< ICFBamUuid6ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "Uuid6Col";
	public static String TABLE_DBNAME = "uuid6col";

	public CFBamUuid6ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj>();
		allUuid6Col = null;
	...
	public ICFBamUuid6ColObj realiseUuid6Col( ICFBamUuid6ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamUuid6ColObj readUuid6Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readUuid6Col( pkey, false ) );
	}

	@Override
	public ICFBamUuid6ColObj readUuid6Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUuid6ColObj readCachedUuid6Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamUuid6ColObj obj = null;
	...
	public void reallyDeepDisposeUuid6Col( ICFBamUuid6ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamUuid6ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUuid6Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeUuid6Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamUuid6ColObj lockUuid6Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamUuid6ColObj> readAllUuid6Col( boolean forceRead ) {
		...
		if( ( allUuid6Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamUuid6ColObj>();
			allUuid6Col = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamUuid6ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj>();
			ICFBamValueObj obj;
	...
	public void deleteUuid6ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteUuid6ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteUuid6ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteUuid6ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteUuid6ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuid6ColObj> dict = indexByTableIdx.get( key );
