...
public class CFBamSecSysGrpObj
	implements ICFBamSecSysGrpObj
{
	...
	public CFBamSecSysGrpObj() {
		isNew = true;
	}

	public CFBamSecSysGrpObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
	}
	...
	public ICFLibAnyObj getNamedObject( String objName ) {
		...
		if( subObj == null ) {
			try {
				...
				subObj = ((ICFBamSchemaObj)getSchema()).getSecSysGrpIncTableObj().readSecSysGrpIncByIdIdx( getRequiredSecSysGrpId(),
				natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
		...
		if( subObj == null ) {
			try {
				...
				String natNextName = nextName;
				subObj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpTableObj().readSecClusGrpByUNameIdx( getRequiredSecSysGrpId(),
				natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
		...
		if( subObj == null ) {
			try {
				...
				String natNextName = nextName;
				subObj = ((ICFBamSchemaObj)getSchema()).getSecTentGrpTableObj().readSecTentGrpByUNameIdx( getRequiredSecSysGrpId(),
				natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
		...
		if( subObj == null ) {
			try {
				...
				String natNextName = nextName;
				subObj = ((ICFBamSchemaObj)getSchema()).getSecSysRoleTableObj().readSecSysRoleByUNameIdx( natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
			}
		...
		if( subObj == null ) {
			try {
				...
				String natNextName = nextName;
				subObj = ((ICFBamSchemaObj)getSchema()).getSecClusRoleTableObj().readSecClusRoleByUNameIdx( getRequiredSecSysGrpId(),
				natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
		...
		if( subObj == null ) {
			try {
				...
				String natNextName = nextName;
				subObj = ((ICFBamSchemaObj)getSchema()).getSecTentRoleTableObj().readSecTentRoleByUNameIdx( getRequiredSecSysGrpId(),
				natNextName, false );
			}
			catch (Throwable th) {
				subObj = null;
	...
	public ICFSecSecSysGrpObj realise() {
		ICFSecSecSysGrpObj retobj = ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().realiseSecSysGrp(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().reallyDeepDisposeSecSysGrp( (ICFSecSecSysGrpObj)this );
	}

	@Override
	public ICFSecSecSysGrpObj read() {
		ICFSecSecSysGrpObj retobj = ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().readSecSysGrpByIdIdx( getPKey(), false );
		return( (ICFSecSecSysGrpObj)retobj );
	}

	@Override
	public ICFSecSecSysGrpObj read( boolean forceRead ) {
		ICFSecSecSysGrpObj retobj = ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().readSecSysGrpByIdIdx( getPKey(), forceRead );
		return( (ICFSecSecSysGrpObj)retobj );
	}

	@Override
	public ICFSecSecSysGrpTableObj getSecSysGrpTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj() );
	}
	...
	public ICFSecSecSysGrp getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecSysGrp().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public ICFSecSecSysGrpEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().lockSecSysGrp( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecSysGrpTableObj().newEditInstance( lockobj );
	...
	public List<ICFSecSecClusGrpObj> getOptionalComponentsImplClusGrp() {
		...
		retval = ((ICFBamSchemaObj)getSchema()).getSecClusGrpTableObj().readSecClusGrpByNameIdx( getSecSysGrpRec().getRequiredName(),
			false );
		return( retval );
	}
	...
	public List<ICFSecSecTentGrpObj> getOptionalComponentsImplTentGrp() {
		...
		retval = ((ICFBamSchemaObj)getSchema()).getSecTentGrpTableObj().readSecTentGrpByNameIdx( getSecSysGrpRec().getRequiredName(),
			false );
		return( retval );
	}
	...
	public ICFSecSecSysRoleObj getOptionalComponentsImplSysRole( boolean forceRead ) {
		if( ( optionalComponentsImplSysRole == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				optionalComponentsImplSysRole = ((ICFBamSchemaObj)getSchema()).getSecSysRoleTableObj().readSecSysRoleByIdIdx( getPKey(), forceRead );
			}
		}
	...
	public List<ICFSecSecClusRoleObj> getOptionalComponentsImplClusRole() {
		...
		retval = ((ICFBamSchemaObj)getSchema()).getSecClusRoleTableObj().readSecClusRoleByNameIdx( getSecSysGrpRec().getRequiredName(),
			false );
		return( retval );
	}
	...
	public List<ICFSecSecTentRoleObj> getOptionalComponentsImplTentRole() {
		...
		retval = ((ICFBamSchemaObj)getSchema()).getSecTentRoleTableObj().readSecTentRoleByNameIdx( getSecSysGrpRec().getRequiredName(),
			false );
		return( retval );
	}
