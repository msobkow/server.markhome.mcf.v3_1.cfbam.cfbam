// Description: Java 25 interface for a UInt32Type record implementation
...
/**
 *	ICFBamUInt32Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUInt32Type extends ICFBamUInt32Def
{
