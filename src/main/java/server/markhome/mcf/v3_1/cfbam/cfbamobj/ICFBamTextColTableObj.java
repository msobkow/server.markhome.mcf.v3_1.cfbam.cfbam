...
public interface ICFBamTextColTableObj
{
	 ...
	 */
	ICFBamTextColObj readTextCol( ICFLibKeyHash256 pkey );
	...
	ICFBamTextColObj readCachedTextCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamTextColObj lockTextCol( ICFLibKeyHash256 pkey );
