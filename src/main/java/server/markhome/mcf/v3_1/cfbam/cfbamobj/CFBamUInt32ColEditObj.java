// Description: Java 25 edit object instance implementation for CFBam UInt32Col.
	...
	implements ICFBamUInt32ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt32ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsUInt32Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsUInt32Col().getSchema()).getTableTableObj().readTableByIdIdx( getUInt32ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getUInt32ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt32Col origRec = getOrigAsUInt32Col().getUInt32ColRec();
		ICFBamUInt32Col myRec = getUInt32ColRec();
		origRec.set( myRec );
	}
