	...
	implements ICFBamNumberColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> allNumberCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamNumberColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByContNextIdx;
	private Map< ICFBamNumberColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > > indexByTableIdx;
	public static String TABLE_NAME = "NumberCol";
	public static String TABLE_DBNAME = "numcol";

	public CFBamNumberColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNumberColObj>();
		allNumberCol = null;
	...
	public ICFBamNumberColObj realiseNumberCol( ICFBamNumberColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamNumberColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamNumberColObj readNumberCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readNumberCol( pkey, false ) );
	}

	@Override
	public ICFBamNumberColObj readNumberCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamNumberColObj readCachedNumberCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamNumberColObj obj = null;
	...
	public void reallyDeepDisposeNumberCol( ICFBamNumberColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamNumberColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeNumberCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamNumberColObj lockNumberCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamNumberColObj> readAllNumberCol( boolean forceRead ) {
		...
		if( ( allNumberCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamNumberColObj>();
			allNumberCol = map;
	...
	@Override
	public ICFBamNumberColObj readNumberColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamNumberColObj readNumberColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamNumberColObj readNumberColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamNumberColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNumberColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNumberColObj> readNumberColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamNumberColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
	...
	@Override
	public ICFBamNumberColObj readCachedNumberColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamNumberColObj obj = null;
	...
	@Override
	public ICFBamNumberColObj readCachedNumberColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamNumberColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNumberColObj> readCachedNumberColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeNumberColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeNumberColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeNumberColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeNumberColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeNumberColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNumberColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNumberColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNumberColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNumberColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteNumberColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteNumberColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteNumberColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteNumberColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteNumberColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteNumberColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteNumberColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteNumberColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteNumberColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamNumberColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNumberCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNumberColObj> dict = indexByTableIdx.get( key );
