// Description: Java 25 edit object instance implementation for CFBam SecGroup.
	...
	implements ICFBamSecGroupEditObj
{
	...
	public ICFSecClusterObj getRequiredContainerCluster( boolean forceRead ) {
		if( forceRead || ( requiredContainerCluster == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecClusterObj obj = ((ICFBamSchemaObj)getOrigAsSecGroup().getSchema()).getClusterTableObj().readClusterByIdIdx( getSecGroupRec().getRequiredClusterId() );
