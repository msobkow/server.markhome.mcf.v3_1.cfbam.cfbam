// Description: Java 25 edit object instance implementation for CFBam TSecGroup.
	...
	implements ICFBamTSecGroupEditObj
{
	...
	public ICFSecTenantObj getRequiredContainerTenant( boolean forceRead ) {
		if( forceRead || ( requiredContainerTenant == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecTenantObj obj = ((ICFBamSchemaObj)getOrigAsTSecGroup().getSchema()).getTenantTableObj().readTenantByIdIdx( getTSecGroupRec().getRequiredTenantId() );
