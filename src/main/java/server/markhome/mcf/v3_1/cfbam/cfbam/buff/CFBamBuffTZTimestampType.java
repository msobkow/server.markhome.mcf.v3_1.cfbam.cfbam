	...
	implements ICFBamTZTimestampType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimestampType rhs ) {
		...
		else if( obj instanceof ICFBamTZTimestampTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZTimestampType ) {
			setTZTimestampType( (CFBamProtBuffTZTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimestampType ) {
			setTZTimestampType( (CFBamPubBuffTZTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
