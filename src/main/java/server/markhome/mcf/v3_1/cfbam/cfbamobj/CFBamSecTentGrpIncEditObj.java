// Description: Java 25 edit object instance implementation for CFBam SecTentGrpInc.
...
public class CFBamSecTentGrpIncEditObj
	implements ICFBamSecTentGrpIncEditObj
{
	...
	public ICFSecSecTentGrpIncObj realise() {
		...
		ICFSecSecTentGrpIncObj retobj = getSchema().getSecTentGrpIncTableObj().realiseSecTentGrpInc( (ICFBamSecTentGrpIncObj)this );
		return( retobj );
	}
	...
	public ICFSecSecTentGrpIncObj create() {
		copyRecToOrig();
		ICFSecSecTentGrpIncObj retobj = ((ICFBamSchemaObj)getOrigAsSecTentGrpInc().getSchema()).getSecTentGrpIncTableObj().createSecTentGrpInc( getOrigAsSecTentGrpInc() );
