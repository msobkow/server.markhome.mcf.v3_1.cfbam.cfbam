...
public interface ICFBamPopDepTableObj
{
	 ...
	 */
	ICFBamPopDepObj readPopDep( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamPopDepObj readCachedPopDep( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposePopDep( ICFBamPopDepObj obj );

	void deepDisposePopDep( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamPopDepObj lockPopDep( $implCommaIJavaOptAtomType$ pkey );
