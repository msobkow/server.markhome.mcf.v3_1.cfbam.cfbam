// Description: Java 25 Instance Edit Object interface for CFBam Value.
	...
	extends ICFBamValueObj
{
	...
	/**
	 *	Get a list ICFBamTableColObj instances referenced by the RefTableCol key.
	 *
	 *	@return	The (potentially empty) list of ICFBamTableColObj instances referenced by the RefTableCol key.
	 */
	List<ICFBamTableColObj> getOptionalChildrenRefTableCol();

	/**
	 *	Get a list ICFBamIndexColObj instances referenced by the RefIndexCol key.
	 *
	 *	@return	The (potentially empty) list of ICFBamIndexColObj instances referenced by the RefIndexCol key.
	 */
