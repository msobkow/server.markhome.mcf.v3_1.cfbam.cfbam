	...
	implements ICFBamTextCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTextCol rhs ) {
		...
		else if( obj instanceof ICFBamTextColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTextCol ) {
			setTextCol( (CFBamProtBuffTextCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTextCol ) {
			setTextCol( (CFBamPubBuffTextCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
