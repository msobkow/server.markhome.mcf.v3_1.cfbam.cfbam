// Description: Java 25 interface for a DelSubDep2 record implementation
...
/**
 *	ICFBamDelSubDep2 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDelSubDep2 extends ICFBamDelDep
{
	...
	public default void setRequiredContainerDelSubDep1(ICFBamProtDelSubDep1 argObj) {
		if (argObj == null) {
			...
			setRequiredContainerDelSubDep1(argObj.getRequiredDelSubDep1Id());
		}
	}
