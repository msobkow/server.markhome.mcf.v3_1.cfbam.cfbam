// Description: Java 25 edit object instance implementation for CFBam SecTentRoleMemb.
...
public class CFBamSecTentRoleMembEditObj
	implements ICFBamSecTentRoleMembEditObj
{
	...
	public CFBamSecTentRoleMembEditObj( ICFSecSecTentRoleMembObj argOrig ) {
		orig = argOrig;
		getRec();
	...
	public ICFSecSecTentRoleMembObj realise() {
		...
		ICFSecSecTentRoleMembObj retobj = getSchema().getSecTentRoleMembTableObj().realiseSecTentRoleMemb( (ICFBamSecTentRoleMembObj)this );
		return( retobj );
	}
	...
	public ICFSecSecTentRoleMembObj create() {
		copyRecToOrig();
		ICFSecSecTentRoleMembObj retobj = ((ICFBamSchemaObj)getOrigAsSecTentRoleMemb().getSchema()).getSecTentRoleMembTableObj().createSecTentRoleMemb( getOrigAsSecTentRoleMemb() );
	...
	public ICFSecSecTentRoleObj getRequiredContainerRole( boolean forceRead ) {
		if( forceRead || ( requiredContainerRole == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecSecTentRoleObj obj = ((ICFBamSchemaObj)getOrigAsSecTentRoleMemb().getSchema()).getSecTentRoleTableObj().readSecTentRoleByIdIdx( getPKey().getRequiredSecTentRoleId() );
	...
	public ICFSecSecUserObj getRequiredParentUser( boolean forceRead ) {
		if( forceRead || ( requiredParentUser == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFSecSecUserObj obj = ((ICFBamSchemaObj)getOrigAsSecTentRoleMemb().getSchema()).getSecUserTableObj().readSecUserByULoginIdx( getPKey().getRequiredLoginId() );
