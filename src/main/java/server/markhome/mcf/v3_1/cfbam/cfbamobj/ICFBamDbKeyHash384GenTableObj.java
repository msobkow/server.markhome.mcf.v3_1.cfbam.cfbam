...
public interface ICFBamDbKeyHash384GenTableObj
{
	 ...
	 */
	ICFBamDbKeyHash384GenObj readDbKeyHash384Gen( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamDbKeyHash384GenObj readCachedDbKeyHash384Gen( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeDbKeyHash384Gen( ICFBamDbKeyHash384GenObj obj );

	void deepDisposeDbKeyHash384Gen( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamDbKeyHash384GenObj lockDbKeyHash384Gen( $implCommaIJavaOptAtomType$ pkey );
