	...
	implements ICFBamTZDateDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> allTZDateDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTZDateDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "TZDateDef";
	public static String TABLE_DBNAME = "dzdef";

	public CFBamTZDateDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj>();
		allTZDateDef = null;
	...
	public ICFBamTZDateDefObj realiseTZDateDef( ICFBamTZDateDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamTZDateDefObj readTZDateDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTZDateDef( pkey, false ) );
	}

	@Override
	public ICFBamTZDateDefObj readTZDateDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTZDateDefObj readCachedTZDateDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTZDateDefObj obj = null;
	...
	@Override
	public void deepDisposeTZDateDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTZDateDefObj lockTZDateDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTZDateDefObj> readAllTZDateDef( boolean forceRead ) {
		...
		if( ( allTZDateDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTZDateDefObj>();
			allTZDateDef = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTZDateDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj>();
			ICFBamValueObj obj;
	...
	public void deleteTZDateDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteTZDateDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteTZDateDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteTZDateDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZDateDefObj> dict = indexByContNextIdx.get( key );
