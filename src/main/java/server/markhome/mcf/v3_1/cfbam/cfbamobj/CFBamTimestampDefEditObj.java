// Description: Java 25 edit object instance implementation for CFBam TimestampDef.
	...
	implements ICFBamTimestampDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTimestampDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsTimestampDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryTimestampDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setOptionalDummy( String value ) {
		if( getTimestampDefRec().getOptionalDummy() != value ) {
			getTimestampDefRec().setOptionalDummy( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamTimestampDef origRec = getOrigAsTimestampDef().getTimestampDefRec();
		ICFBamTimestampDef myRec = getTimestampDefRec();
		origRec.set( myRec );
	}
