...
// Description: Java 25 Factory service implementation for DbKeyHash512Col buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash512Col buffers.
 */
@Service("cfbam31BuffDbKeyHash512ColFactoryService")
public class CFBamBuffDbKeyHash512ColFactoryService
	implements ICFBamDbKeyHash512ColFactory
{
	public CFBamBuffDbKeyHash512ColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash512Col",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash512Col");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash512Col",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash512Col");
			}
		}
	}
