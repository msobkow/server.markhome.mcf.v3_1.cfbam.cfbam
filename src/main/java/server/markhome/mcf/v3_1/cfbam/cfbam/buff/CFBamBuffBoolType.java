	...
	implements ICFBamBoolType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamBoolType rhs ) {
		...
		else if( obj instanceof ICFBamBoolTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffBoolType ) {
			setBoolType( (CFBamProtBuffBoolType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBoolType ) {
			setBoolType( (CFBamPubBuffBoolType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
