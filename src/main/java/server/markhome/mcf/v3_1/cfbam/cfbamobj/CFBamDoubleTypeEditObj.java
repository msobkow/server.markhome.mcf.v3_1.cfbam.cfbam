// Description: Java 25 edit object instance implementation for CFBam DoubleType.
	...
	implements ICFBamDoubleTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDoubleTypeTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsDoubleType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getDoubleTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getDoubleTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamDoubleType origRec = getOrigAsDoubleType().getDoubleTypeRec();
		ICFBamDoubleType myRec = getDoubleTypeRec();
		origRec.set( myRec );
	}
