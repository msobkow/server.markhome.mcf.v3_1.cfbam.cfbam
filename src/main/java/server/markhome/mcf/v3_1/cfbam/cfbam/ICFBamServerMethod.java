// Description: Java 25 interface for a ServerMethod record implementation
...
/**
 *	ICFBamServerMethod persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamServerMethod extends ICFBamScope
{
	...
	public default void setRequiredContainerForTable(ICFBamProtTable argObj) {
		if (argObj == null) {
			setRequiredContainerForTable((CFLibDbKeyHash256)null);
		}
		else {
