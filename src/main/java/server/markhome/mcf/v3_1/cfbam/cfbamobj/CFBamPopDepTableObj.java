	...
	implements ICFBamPopDepTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> allPopDep;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > > indexByTenantIdx;
	private Map< ICFBamPopDepByRelationIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > > indexByRelationIdx;
	private Map< ICFBamPopDepByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > > indexByDefSchemaIdx;
	public static String TABLE_NAME = "PopDep";
	public static String TABLE_DBNAME = "pop_dep";

	public CFBamPopDepTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamPopDepObj>();
		allPopDep = null;
	...
	public ICFBamPopDepObj realisePopDep( ICFBamPopDepObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByRelationIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > mapRelationIdx = indexByRelationIdx.get( keyRelationIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
	...
	@Override
	public ICFBamPopDepObj readPopDep( $implCommaIJavaOptAtomType$ pkey ) {
		return( readPopDep( pkey, false ) );
	}

	@Override
	public ICFBamPopDepObj readPopDep( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamPopDepObj readCachedPopDep( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamPopDepObj obj = null;
	...
	public void reallyDeepDisposePopDep( ICFBamPopDepObj obj )
	{
		...
		members.remove( pkey );
		ICFBamPopDepByRelationIdxKey keyRelationIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopDep().newByRelationIdxKey();
		keyRelationIdx.setRequiredRelationId( existing.getRequiredRelationId() );

		ICFBamPopDepByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopDep().newByDefSchemaIdxKey();
	...
	@Override
	public void deepDisposePopDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamPopDepObj lockPopDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamPopDepObj> readAllPopDep( boolean forceRead ) {
		...
		if( ( allPopDep == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamPopDepObj>();
			allPopDep = map;
	...
	@Override
	public ICFBamPopDepObj readPopDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamPopDepObj readPopDepByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public List<ICFBamPopDepObj> readPopDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamPopDepObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamPopDepObj>();
			ICFBamScopeObj obj;
	...
	@Override
	public List<ICFBamPopDepObj> readPopDepByRelationIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public List<ICFBamPopDepObj> readPopDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public ICFBamPopDepObj readCachedPopDepByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamPopDepObj obj = null;
	...
	@Override
	public List<ICFBamPopDepObj> readCachedPopDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public List<ICFBamPopDepObj> readCachedPopDepByRelationIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public List<ICFBamPopDepObj> readCachedPopDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposePopDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposePopDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public void deepDisposePopDepByRelationIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public void deepDisposePopDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deletePopDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deletePopDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		ICFBamScopeByTenantIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryScope().newByTenantIdxKey();
		key.setRequiredTenantId( TenantId );
		if( indexByTenantIdx == null ) {
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> dict = indexByTenantIdx.get( key );
	...
	@Override
	public void deletePopDepByRelationIdx( ICFLibKeyHash256 RelationId )
	{
		ICFBamPopDepByRelationIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopDep().newByRelationIdxKey();
		key.setRequiredRelationId( RelationId );
		if( indexByRelationIdx == null ) {
		...
		if( indexByRelationIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> dict = indexByRelationIdx.get( key );
	...
	@Override
	public void deletePopDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamPopDepByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopDep().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopDepObj> dict = indexByDefSchemaIdx.get( key );
