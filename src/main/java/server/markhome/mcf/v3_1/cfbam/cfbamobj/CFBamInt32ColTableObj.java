	...
	implements ICFBamInt32ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> allInt32Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamInt32ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByContNextIdx;
	private Map< ICFBamInt32ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "Int32Col";
	public static String TABLE_DBNAME = "int32col";

	public CFBamInt32ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj>();
		allInt32Col = null;
	...
	public ICFBamInt32ColObj realiseInt32Col( ICFBamInt32ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamInt32ColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Col().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamInt32ColObj readInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readInt32Col( pkey, false ) );
	}

	@Override
	public ICFBamInt32ColObj readInt32Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamInt32ColObj readCachedInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamInt32ColObj obj = null;
	...
	public void reallyDeepDisposeInt32Col( ICFBamInt32ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamInt32ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamInt32ColObj lockInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamInt32ColObj> readAllInt32Col( boolean forceRead ) {
		...
		if( ( allInt32Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamInt32ColObj>();
			allInt32Col = map;
	...
	@Override
	public ICFBamInt32ColObj readInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamInt32ColObj readInt32ColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamInt32ColObj readInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamInt32ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt32ColObj> readInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamInt32ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Col().newByTableIdxKey();
	...
	@Override
	public ICFBamInt32ColObj readCachedInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamInt32ColObj obj = null;
	...
	@Override
	public ICFBamInt32ColObj readCachedInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamInt32ColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32ColObj> readCachedInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamInt32ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Col().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32ColObj> dict = indexByTableIdx.get( key );
