...
// Description: Java 25 Factory service implementation for NmTokenDef buffers
...
/*
 *	Java 25 Factory service implementation for NmTokenDef buffers.
 */
@Service("cfbam31BuffNmTokenDefFactoryService")
public class CFBamBuffNmTokenDefFactoryService
	implements ICFBamNmTokenDefFactory
{
	public CFBamBuffNmTokenDefFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamNmTokenDef",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamNmTokenDef");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamNmTokenDef",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamNmTokenDef");
			}
		}
	}
