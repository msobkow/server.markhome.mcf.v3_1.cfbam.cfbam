// Description: Java 25 interface for a PopSubDep3 record implementation
 ...
 */
public interface ICFBamPopSubDep3 extends ICFBamPopDep
{
	...
	public default void setRequiredContainerPopSubDep2(ICFBamProtPopSubDep2 argObj) {
		if (argObj == null) {
			setRequiredContainerPopSubDep2((CFLibDbKeyHash256)null);
		}
		else {
