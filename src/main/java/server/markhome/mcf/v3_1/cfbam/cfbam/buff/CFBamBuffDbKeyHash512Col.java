	...
	implements ICFBamDbKeyHash512Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash512Col rhs ) {
		...
		else if( obj instanceof ICFBamDbKeyHash512ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash512Col ) {
			setDbKeyHash512Col( (CFBamProtBuffDbKeyHash512Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash512Col ) {
			setDbKeyHash512Col( (CFBamPubBuffDbKeyHash512Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
