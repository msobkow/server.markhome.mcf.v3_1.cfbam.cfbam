// Description: Java 25 Object interface for CFBam RoleDef.
...
{
	/**
	 *	Initially, the class code for an object is ICFBamRoleDef.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFBamRoleDef instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamRoleDef instance which currently backs this object.
	 */
	ICFBamRoleDef getRec();

	/**
	 *	Internal use only.
	 */
	void setRec( ICFBamRoleDef value );
