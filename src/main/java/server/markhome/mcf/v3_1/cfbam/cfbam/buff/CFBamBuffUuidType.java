	...
	implements ICFBamUuidType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuidType rhs ) {
		...
		else if( obj instanceof ICFBamUuidTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuidType ) {
			setUuidType( (CFBamProtBuffUuidType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidType ) {
			setUuidType( (CFBamPubBuffUuidType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
