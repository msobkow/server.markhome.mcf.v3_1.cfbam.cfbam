...
/*
 *	CFBamDbKeyHash384ColTable database interface for DbKeyHash384Col has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
