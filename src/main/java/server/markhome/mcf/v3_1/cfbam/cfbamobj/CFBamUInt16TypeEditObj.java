// Description: Java 25 edit object instance implementation for CFBam UInt16Type.
	...
	implements ICFBamUInt16TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt16TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsUInt16Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryUInt16Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsUInt16Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getUInt16TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getUInt16TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt16Type origRec = getOrigAsUInt16Type().getUInt16TypeRec();
		ICFBamUInt16Type myRec = getUInt16TypeRec();
		origRec.set( myRec );
	}
