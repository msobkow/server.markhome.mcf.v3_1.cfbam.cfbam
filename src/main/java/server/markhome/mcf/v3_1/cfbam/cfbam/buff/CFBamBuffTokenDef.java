	...
	implements ICFBamTokenDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTokenDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTokenDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTokenDef ) {
			setTokenDef( (CFBamProtBuffTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenDef ) {
			setTokenDef( (CFBamPubBuffTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
