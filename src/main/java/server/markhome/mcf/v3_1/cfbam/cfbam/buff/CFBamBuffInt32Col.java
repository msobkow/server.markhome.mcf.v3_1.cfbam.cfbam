	...
	implements ICFBamInt32Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt32Col rhs ) {
		...
		else if( obj instanceof ICFBamInt32ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt32Col ) {
			setInt32Col( (CFBamProtBuffInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt32Col ) {
			setInt32Col( (CFBamPubBuffInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
