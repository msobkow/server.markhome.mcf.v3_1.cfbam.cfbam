// Description: Java 25 interface for a TokenType record implementation
...
/**
 *	ICFBamTokenType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamTokenType extends ICFBamTokenDef
{
