	...
	implements ICFBamUInt64Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt64Col rhs ) {
		...
		else if( obj instanceof ICFBamUInt64ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt64Col ) {
			setUInt64Col( (CFBamProtBuffUInt64Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt64Col ) {
			setUInt64Col( (CFBamPubBuffUInt64Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
