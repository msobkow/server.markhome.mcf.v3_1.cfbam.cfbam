...
// Description: Java 25 Factory service implementation for PopSubDep3 buffers
...
/*
 *	Java 25 Factory service implementation for PopSubDep3 buffers.
 */
@Service("cfbam31BuffPopSubDep3FactoryService")
public class CFBamBuffPopSubDep3FactoryService
	implements ICFBamPopSubDep3Factory
{
	public CFBamBuffPopSubDep3FactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamPopSubDep3",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamPopSubDep3");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamPopSubDep3",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamPopSubDep3");
			}
		}
	}
