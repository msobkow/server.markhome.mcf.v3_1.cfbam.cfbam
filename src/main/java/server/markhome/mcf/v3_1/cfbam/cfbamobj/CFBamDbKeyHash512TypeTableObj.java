	...
	implements ICFBamDbKeyHash512TypeTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> members;
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> allDbKeyHash512Type;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash512TypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash512TypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > > indexBySchemaIdx;
	...
	public CFBamDbKeyHash512TypeTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj>();
	...
	public ICFBamDbKeyHash512TypeObj realiseDbKeyHash512Type( ICFBamDbKeyHash512TypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamDbKeyHash512TypeObj readDbKeyHash512Type( ICFLibKeyHash256 pkey ) {
		return( readDbKeyHash512Type( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash512TypeObj readDbKeyHash512Type( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash512TypeObj readCachedDbKeyHash512Type( ICFLibKeyHash256 pkey ) {
		ICFBamDbKeyHash512TypeObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash512Type( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamDbKeyHash512TypeObj lockDbKeyHash512Type( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamDbKeyHash512TypeObj> readAllDbKeyHash512Type( boolean forceRead ) {
		...
		if( ( allDbKeyHash512Type == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> map = new HashMap<ICFLibKeyHash256,ICFBamDbKeyHash512TypeObj>();
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj>();
			ICFBamValueObj obj;
	...
	public void deleteDbKeyHash512TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteDbKeyHash512TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteDbKeyHash512TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteDbKeyHash512TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteDbKeyHash512TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash512TypeObj> dict = indexBySchemaIdx.get( key );
