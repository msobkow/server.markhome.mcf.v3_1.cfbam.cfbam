// Description: Java 25 interface for a UInt32Def history object
...
/**
 *	ICFBamUInt32DefH provides access to history records matching the CFBamUInt32Def object change history.
 */
public interface ICFBamUInt32DefH extends ICFBamAtomH
{
