// Description: Java 25 edit object instance implementation for CFBam Int32Type.
	...
	implements ICFBamInt32TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt32TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt32Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt32Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsInt32Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getInt32TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getInt32TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamInt32Type origRec = getOrigAsInt32Type().getInt32TypeRec();
		ICFBamInt32Type myRec = getInt32TypeRec();
		origRec.set( myRec );
	}
