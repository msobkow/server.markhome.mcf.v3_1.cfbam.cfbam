// Description: Java 25 interface for a UInt16Type record implementation
...
/**
 *	ICFBamUInt16Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUInt16Type extends ICFBamUInt16Def
{
