// Description: Java 25 interface for a TZTimestampDef record declementation
...
/**
 *	ICFBamTZTimestampDef persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamTZTimestampDef
	extends ICFBamAtom
{
