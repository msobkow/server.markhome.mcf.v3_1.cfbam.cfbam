// Description: Java 25 interface for a IndexCol history object
...
/**
 *	ICFBamIndexColH provides access to history records matching the CFBamIndexCol object change history.
 */
public interface ICFBamIndexColH
{
