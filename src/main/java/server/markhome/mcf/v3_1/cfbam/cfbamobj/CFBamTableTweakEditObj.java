// Description: Java 25 edit object instance implementation for CFBam TableTweak.
	...
	implements ICFBamTableTweakEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTableTweakTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTableDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerTableDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsTableTweak().getSchema()).getTableTableObj().readTableByIdIdx( getTableTweakRec().getRequiredTableId() );
	...
	public void setRequiredContainerTableDef( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getTableTweakRec().setRequiredContainerTableDef(value.getTableRec());
		}
		requiredContainerTableDef = value;
	...
	public void copyRecToOrig() {
		ICFBamTableTweak origRec = getOrigAsTableTweak().getTableTweakRec();
		ICFBamTableTweak myRec = getTableTweakRec();
		origRec.set( myRec );
	}
