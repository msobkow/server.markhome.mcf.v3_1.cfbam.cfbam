...
public interface ICFBamDbKeyHash224TypeTableObj
{
	 ...
	 */
	ICFBamDbKeyHash224TypeObj readDbKeyHash224Type( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamDbKeyHash224TypeObj readCachedDbKeyHash224Type( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeDbKeyHash224Type( ICFBamDbKeyHash224TypeObj obj );

	void deepDisposeDbKeyHash224Type( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamDbKeyHash224TypeObj lockDbKeyHash224Type( $implCommaIJavaOptAtomType$ pkey );
