...
// Description: Java 25 Factory service implementation for TokenType buffers
...
/*
 *	Java 25 Factory service implementation for TokenType buffers.
 */
@Service("cfbam31BuffTokenTypeFactoryService")
public class CFBamBuffTokenTypeFactoryService
	implements ICFBamTokenTypeFactory
{
	public CFBamBuffTokenTypeFactoryService() {
	}
