// Description: Java 25 edit object instance implementation for CFBam DbKeyHash256Col.
	...
	implements ICFBamDbKeyHash256ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash256ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash256Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash256Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsDbKeyHash256Col().getSchema()).getTableTableObj().readTableByIdIdx( getDbKeyHash256ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		if( rec == null ) {
			getDbKeyHash256ColRec();
		}
		if( value != null ) {
			requiredContainerTable = value;
			getDbKeyHash256ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamDbKeyHash256Col origRec = getOrigAsDbKeyHash256Col().getDbKeyHash256ColRec();
		ICFBamDbKeyHash256Col myRec = getDbKeyHash256ColRec();
		origRec.set( myRec );
	}
