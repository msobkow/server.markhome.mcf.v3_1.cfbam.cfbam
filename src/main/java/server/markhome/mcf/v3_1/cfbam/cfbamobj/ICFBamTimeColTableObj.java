...
public interface ICFBamTimeColTableObj
{
	 ...
	 */
	ICFBamTimeColObj readTimeCol( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTimeColObj readCachedTimeCol( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTimeCol( ICFBamTimeColObj obj );

	void deepDisposeTimeCol( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTimeColObj lockTimeCol( $implCommaIJavaOptAtomType$ pkey );
