// Description: Java 25 edit object instance implementation for CFBam ServerProc.
	...
	implements ICFBamServerProcEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getServerProcTableObj().getClassCode() );
	}
	...
	public void copyRecToOrig() {
		ICFBamServerProc origRec = getOrigAsServerProc().getServerProcRec();
		ICFBamServerProc myRec = getServerProcRec();
		origRec.set( myRec );
	}
