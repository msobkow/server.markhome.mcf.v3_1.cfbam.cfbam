...
public interface ICFBamDbKeyHash160DefTableObj
{
	 ...
	 */
	ICFBamDbKeyHash160DefObj readDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamDbKeyHash160DefObj readCachedDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeDbKeyHash160Def( ICFBamDbKeyHash160DefObj obj );

	void deepDisposeDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamDbKeyHash160DefObj lockDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey );
