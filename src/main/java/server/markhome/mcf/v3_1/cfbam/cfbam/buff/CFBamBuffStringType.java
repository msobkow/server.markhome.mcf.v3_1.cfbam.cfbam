	...
	implements ICFBamStringType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamStringType rhs ) {
		...
		else if( obj instanceof ICFBamStringTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffStringType ) {
			setStringType( (CFBamProtBuffStringType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffStringType ) {
			setStringType( (CFBamPubBuffStringType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
