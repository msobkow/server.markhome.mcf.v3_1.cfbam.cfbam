// Description: Java 25 interface for a Uuid6Type record declementation
...
/**
 *	ICFBamUuid6Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUuid6Type
	extends ICFBamUuid6Def
{
