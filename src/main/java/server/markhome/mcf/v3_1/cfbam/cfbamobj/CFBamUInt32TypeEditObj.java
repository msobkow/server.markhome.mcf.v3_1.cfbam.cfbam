// Description: Java 25 edit object instance implementation for CFBam UInt32Type.
	...
	implements ICFBamUInt32TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt32TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsUInt32Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsUInt32Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getUInt32TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getUInt32TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt32Type origRec = getOrigAsUInt32Type().getUInt32TypeRec();
		ICFBamUInt32Type myRec = getUInt32TypeRec();
		origRec.set( myRec );
	}
