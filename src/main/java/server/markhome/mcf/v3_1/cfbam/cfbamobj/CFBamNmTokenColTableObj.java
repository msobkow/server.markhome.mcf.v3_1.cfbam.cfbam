	...
	implements ICFBamNmTokenColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> allNmTokenCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamNmTokenColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByContNextIdx;
	private Map< ICFBamNmTokenColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > > indexByTableIdx;
	public static String TABLE_NAME = "NmTokenCol";
	public static String TABLE_DBNAME = "nmtkncol";

	public CFBamNmTokenColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj>();
		allNmTokenCol = null;
	...
	public ICFBamNmTokenColObj realiseNmTokenCol( ICFBamNmTokenColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamNmTokenColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamNmTokenColObj readNmTokenCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readNmTokenCol( pkey, false ) );
	}

	@Override
	public ICFBamNmTokenColObj readNmTokenCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamNmTokenColObj readCachedNmTokenCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamNmTokenColObj obj = null;
	...
	public void reallyDeepDisposeNmTokenCol( ICFBamNmTokenColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamNmTokenColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeNmTokenCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamNmTokenColObj lockNmTokenCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamNmTokenColObj> readAllNmTokenCol( boolean forceRead ) {
		...
		if( ( allNmTokenCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamNmTokenColObj>();
			allNmTokenCol = map;
	...
	@Override
	public ICFBamNmTokenColObj readNmTokenColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamNmTokenColObj readNmTokenColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamNmTokenColObj readNmTokenColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamNmTokenColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokenColObj> readNmTokenColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamNmTokenColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
	...
	@Override
	public ICFBamNmTokenColObj readCachedNmTokenColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamNmTokenColObj obj = null;
	...
	@Override
	public ICFBamNmTokenColObj readCachedNmTokenColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamNmTokenColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokenColObj> readCachedNmTokenColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeNmTokenColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeNmTokenColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokenColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteNmTokenColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteNmTokenColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteNmTokenColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteNmTokenColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamNmTokenColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokenCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenColObj> dict = indexByTableIdx.get( key );
