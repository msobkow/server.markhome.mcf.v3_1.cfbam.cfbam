...
// Description: Java 25 Factory service implementation for DbKeyHash384Type buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash384Type buffers.
 */
@Service("cfbam31BuffDbKeyHash384TypeFactoryService")
public class CFBamBuffDbKeyHash384TypeFactoryService
	implements ICFBamDbKeyHash384TypeFactory
{
	public CFBamBuffDbKeyHash384TypeFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Type",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Type");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Type",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Type");
			}
		}
	}
