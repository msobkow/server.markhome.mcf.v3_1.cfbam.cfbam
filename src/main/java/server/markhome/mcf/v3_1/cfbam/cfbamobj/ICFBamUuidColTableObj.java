...
public interface ICFBamUuidColTableObj
{
	 ...
	 */
	ICFBamUuidColObj readUuidCol( ICFLibKeyHash256 pkey );
	...
	ICFBamUuidColObj readCachedUuidCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamUuidColObj lockUuidCol( ICFLibKeyHash256 pkey );
