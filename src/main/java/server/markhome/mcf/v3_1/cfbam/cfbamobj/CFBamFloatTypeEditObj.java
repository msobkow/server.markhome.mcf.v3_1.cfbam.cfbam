// Description: Java 25 edit object instance implementation for CFBam FloatType.
	...
	implements ICFBamFloatTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getFloatTypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsFloatType().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryFloatType().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsFloatType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getFloatTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getFloatTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamFloatType origRec = getOrigAsFloatType().getFloatTypeRec();
		ICFBamFloatType myRec = getFloatTypeRec();
		origRec.set( myRec );
	}
