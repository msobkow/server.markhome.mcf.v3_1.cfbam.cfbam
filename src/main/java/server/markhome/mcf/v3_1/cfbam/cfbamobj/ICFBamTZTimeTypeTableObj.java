...
public interface ICFBamTZTimeTypeTableObj
{
	 ...
	 */
	ICFBamTZTimeTypeObj readTZTimeType( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTZTimeTypeObj readCachedTZTimeType( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTZTimeType( ICFBamTZTimeTypeObj obj );

	void deepDisposeTZTimeType( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTZTimeTypeObj lockTZTimeType( $implCommaIJavaOptAtomType$ pkey );
