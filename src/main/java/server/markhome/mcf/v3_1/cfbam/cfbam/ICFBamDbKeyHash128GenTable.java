...
// Description: Java 25 DbIO interface for DbKeyHash128Gen.
...
/*
 *	CFBamDbKeyHash128GenTable database interface for DbKeyHash128Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDbKeyHash128GenTable
{
	 ...
	 */
	ICFBamDbKeyHash128Gen createDbKeyHash128Gen( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamDbKeyHash128Gen updateDbKeyHash128Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Gen rec );
	 ...
	 */
	void deleteDbKeyHash128Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash128Gen rec );
	/**
	 ...
	 */
	void deleteDbKeyHash128GenBySchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteDbKeyHash128GenByIdIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteDbKeyHash128GenByUNameIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@param	ScopeId	The DbKeyHash128Gen key attribute of the instance generating the id.
	 */
	void deleteDbKeyHash128GenByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId );
	 ...
	 */
	void deleteDbKeyHash128GenByDefSchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteDbKeyHash128GenByPrevIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteDbKeyHash128GenByNextIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@param	PrevId	The DbKeyHash128Gen key attribute of the instance generating the id.
	 */
	void deleteDbKeyHash128GenByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId,
		CFLibDbKeyHash256 argPrevId );
	 ...
	 *	@param	NextId	The DbKeyHash128Gen key attribute of the instance generating the id.
	 */
	void deleteDbKeyHash128GenByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId,
		CFLibDbKeyHash256 argNextId );
	 ...
	 */
	ICFBamDbKeyHash128Gen readDerived( ICFSecAuthorization Authorization,
	 ...
	 *		no such existing key value.
	 */
	ICFBamDbKeyHash128Gen lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 */
	ICFBamDbKeyHash128Gen[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 *		no such existing key value.
	 */
	ICFBamDbKeyHash128Gen readDerivedByIdIdx( ICFSecAuthorization Authorization,
	 ...
	 *		no such existing key value.
	 */
	ICFBamDbKeyHash128Gen readDerivedByUNameIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamDbKeyHash128Gen[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamDbKeyHash128Gen readRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen lockRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 */
	ICFBamDbKeyHash128Gen[] readAllRec( ICFSecAuthorization Authorization );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen readRecByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen readRecByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamDbKeyHash128Gen[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId );
	 ...
	 */
	ICFBamDbKeyHash128Gen moveRecUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	ICFBamDbKeyHash128Gen moveRecDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
