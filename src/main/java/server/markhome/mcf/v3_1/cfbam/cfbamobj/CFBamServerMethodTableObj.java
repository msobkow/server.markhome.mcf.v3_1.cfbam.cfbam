	...
	implements ICFBamServerMethodTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> allServerMethod;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > > indexByTenantIdx;
	...
	private Map< ICFBamServerMethodByMethTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > > indexByMethTableIdx;
	private Map< ICFBamServerMethodByMethCodeVisIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > > indexByMethCodeVisIdx;
	private Map< ICFBamServerMethodByMethTableVisIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > > indexByMethTableVisIdx;
	private Map< ICFBamServerMethodByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > > indexByDefSchemaIdx;
	public static String TABLE_NAME = "ServerMethod";
	public static String TABLE_DBNAME = "srvmeth";

	public CFBamServerMethodTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj>();
	...
	public ICFBamServerMethodObj realiseServerMethod( ICFBamServerMethodObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByMethTableIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > mapMethTableIdx = indexByMethTableIdx.get( keyMethTableIdx );
			...
			if( indexByMethCodeVisIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > mapMethCodeVisIdx = indexByMethCodeVisIdx.get( keyMethCodeVisIdx );
			...
			if( indexByMethTableVisIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > mapMethTableVisIdx = indexByMethTableVisIdx.get( keyMethTableVisIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
	...
	@Override
	public ICFBamServerMethodObj readServerMethod( $implCommaIJavaOptAtomType$ pkey ) {
		return( readServerMethod( pkey, false ) );
	}

	@Override
	public ICFBamServerMethodObj readServerMethod( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamServerMethodObj readCachedServerMethod( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamServerMethodObj obj = null;
	...
	public void reallyDeepDisposeServerMethod( ICFBamServerMethodObj obj )
	{
		...
		members.remove( pkey );
		ICFBamServerMethodByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByUNameIdxKey();
		keyUNameIdx.setRequiredTableId( existing.getRequiredTableId() );
		keyUNameIdx.setRequiredName( existing.getRequiredName() );

		ICFBamServerMethodByMethTableIdxKey keyMethTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByMethTableIdxKey();
		keyMethTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		ICFBamServerMethodByMethCodeVisIdxKey keyMethCodeVisIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByMethCodeVisIdxKey();
		keyMethCodeVisIdx.setRequiredCodeVis( existing.getRequiredCodeVis() );

		ICFBamServerMethodByMethTableVisIdxKey keyMethTableVisIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByMethTableVisIdxKey();
		...
		ICFBamServerMethodByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByDefSchemaIdxKey();
	...
	@Override
	public void deepDisposeServerMethod( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamServerMethodObj lockServerMethod( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamServerMethodObj> readAllServerMethod( boolean forceRead ) {
		...
		if( ( allServerMethod == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamServerMethodObj>();
			allServerMethod = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamServerMethodObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj>();
			ICFBamScopeObj obj;
	...
	@Override
	public List<ICFBamServerMethodObj> readServerMethodByMethCodeVisIdx( ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
	...
	@Override
	public List<ICFBamServerMethodObj> readCachedServerMethodByMethCodeVisIdx( ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
	...
	@Override
	public void deepDisposeServerMethodByMethCodeVisIdx( ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		...
		ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		...
		ICFBamServerMethodObj obj;
		List<ICFBamServerMethodObj> arrayList = readCachedServerMethodByMethTableVisIdx( TableId,
				CodeVis );
		if( arrayList != null )  {
			Iterator<ICFBamServerMethodObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deleteServerMethodByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict = indexByTenantIdx.get( key );
	...
	public void deleteServerMethodByMethTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByMethTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict = indexByMethTableIdx.get( key );
	...
	@Override
	public void deleteServerMethodByMethCodeVisIdx( ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		ICFBamServerMethodByMethCodeVisIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryServerMethod().newByMethCodeVisIdxKey();
		key.setRequiredCodeVis( CodeVis );
		if( indexByMethCodeVisIdx == null ) {
		...
		if( indexByMethCodeVisIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict = indexByMethCodeVisIdx.get( key );
		...
		ICFBamPubSchema.CodeVisibilityEnum CodeVis )
	{
		...
		if( indexByMethTableVisIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict = indexByMethTableVisIdx.get( key );
		...
		deepDisposeServerMethodByMethTableVisIdx( TableId,
				CodeVis );
	}
	...
	public void deleteServerMethodByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamServerMethodObj> dict = indexByDefSchemaIdx.get( key );
