	...
	implements ICFBamUInt16Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt16Col rhs ) {
		...
		else if( obj instanceof ICFBamUInt16ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt16Col ) {
			setUInt16Col( (CFBamProtBuffUInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt16Col ) {
			setUInt16Col( (CFBamPubBuffUInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
