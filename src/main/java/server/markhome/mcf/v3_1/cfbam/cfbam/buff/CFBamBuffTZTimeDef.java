	...
	implements ICFBamTZTimeDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimeDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimeDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZTimeDef ) {
			setTZTimeDef( (CFBamProtBuffTZTimeDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimeDef ) {
			setTZTimeDef( (CFBamPubBuffTZTimeDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
