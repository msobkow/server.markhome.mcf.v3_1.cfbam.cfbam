	...
	implements ICFBamUInt32DefTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamUInt32DefObj> members;
	private Map<ICFLibKeyHash256, ICFBamUInt32DefObj> allUInt32Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUInt32DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "UInt32Def";
	public static String TABLE_DBNAME = "u32def";

	public CFBamUInt32DefTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamUInt32DefObj>();
		allUInt32Def = null;
	...
	public ICFBamUInt32DefObj realiseUInt32Def( ICFBamUInt32DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt32DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamUInt32DefObj readUInt32Def( ICFLibKeyHash256 pkey ) {
		return( readUInt32Def( pkey, false ) );
	}

	@Override
	public ICFBamUInt32DefObj readUInt32Def( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUInt32DefObj readCachedUInt32Def( ICFLibKeyHash256 pkey ) {
		ICFBamUInt32DefObj obj = null;
	...
	@Override
	public void deepDisposeUInt32Def( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamUInt32DefObj lockUInt32Def( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamUInt32DefObj> readAllUInt32Def( boolean forceRead ) {
		...
		if( ( allUInt32Def == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> map = new HashMap<ICFLibKeyHash256,ICFBamUInt32DefObj>();
			allUInt32Def = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamUInt32DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamUInt32DefObj>();
			ICFBamValueObj obj;
	...
	public void deleteUInt32DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteUInt32DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteUInt32DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteUInt32DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt32DefObj> dict = indexByContNextIdx.get( key );
