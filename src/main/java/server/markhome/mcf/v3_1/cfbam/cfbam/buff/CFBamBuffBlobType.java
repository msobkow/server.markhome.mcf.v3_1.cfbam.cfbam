	...
	implements ICFBamBlobType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamBlobType rhs ) {
		...
		else if( obj instanceof ICFBamBlobTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffBlobType ) {
			setBlobType( (CFBamProtBuffBlobType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBlobType ) {
			setBlobType( (CFBamPubBuffBlobType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
