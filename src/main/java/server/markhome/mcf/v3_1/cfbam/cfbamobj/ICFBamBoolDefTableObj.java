...
public interface ICFBamBoolDefTableObj
{
	 ...
	 */
	ICFBamBoolDefObj readBoolDef( ICFLibKeyHash256 pkey );
	...
	ICFBamBoolDefObj readCachedBoolDef( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamBoolDefObj lockBoolDef( ICFLibKeyHash256 pkey );
