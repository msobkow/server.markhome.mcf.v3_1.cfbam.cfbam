// Description: Java 25 interface for a Uuid6Def record declementation
...
/**
 *	ICFBamUuid6Def persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUuid6Def
	extends ICFBamAtom
{
