	...
	implements ICFBamStringCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamStringCol rhs ) {
		...
		else if( obj instanceof ICFBamStringColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffStringCol ) {
			setStringCol( (CFBamProtBuffStringCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffStringCol ) {
			setStringCol( (CFBamPubBuffStringCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
