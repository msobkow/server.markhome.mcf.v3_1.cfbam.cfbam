// Description: Java 25 base object instance implementation for ClearSubDep1
	...
	implements ICFBamClearSubDep1Obj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)schema).getClearSubDep1TableObj().getClassCode() );
	}
	...
	public ICFBamScopeObj realise() {
		ICFBamClearSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().realiseClearSubDep1(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().reallyDeepDisposeClearSubDep1( (ICFBamClearSubDep1Obj)this );
	}

	@Override
	public ICFBamScopeObj read() {
		ICFBamClearSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().readClearSubDep1ByIdIdx( getPKey(), false );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamScopeObj read( boolean forceRead ) {
		ICFBamClearSubDep1Obj retobj = ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().readClearSubDep1ByIdIdx( getPKey(), forceRead );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamClearSubDep1TableObj getClearSubDep1Table() {
		return( ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj() );
	}
	...
	public ICFBamScope getRec() {
		if( rec == null ) {
			if( isNew ) {
				rec = getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryClearSubDep1().newRec();
			}
			else {
				// Read the data rec via the backing store
				rec = getSchema().getCFBamBackingStore().getTableClearSubDep1().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public void setRec( ICFBamScope value ) {
		if( ! ( ( value == null ) || ! ( value instanceof ICFBamClearSubDep1 ) ) ) {
			throw new CFLibUnsupportedClassException( getClass(),
				"setRec",
				"value",
				value,
				"CFBamClearSubDep1Rec" );
		}
		rec = value;
		copyRecToPKey();
	...
	public ICFBamScopeEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().lockClearSubDep1( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getClearSubDep1TableObj().newEditInstance( lockobj );
	...
	public ICFBamClearTopDepObj getRequiredContainerClearTopDep( boolean forceRead ) {
		if( ( requiredContainerClearTopDep == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerClearTopDep = ((ICFBamSchemaObj)getSchema()).getClearTopDepTableObj().readClearTopDepByIdIdx( getClearSubDep1Rec().getRequiredClearTopDepId(), forceRead );
			}
		}
	...
	@Override
	public $implJavaAtomType$ getRequiredClearTopDepId() {
