...
// Description: Java 25 Factory service implementation for Table buffers
...
/*
 *	Java 25 Factory service implementation for Table buffers.
 */
@Service("cfbam31BuffTableFactoryService")
public class CFBamBuffTableFactoryService
	implements ICFBamTableFactory
{
	public CFBamBuffTableFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamTable",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamTable");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamTable",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamTable");
			}
		}
	}
