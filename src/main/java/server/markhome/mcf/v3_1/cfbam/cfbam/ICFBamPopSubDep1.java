// Description: Java 25 interface for a PopSubDep1 record implementation
...
/**
 *	ICFBamPopSubDep1 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPopSubDep1 extends ICFBamPopDep
{
	...
	public default void setRequiredContainerContPopTopDep(ICFBamProtPopTopDep argObj) {
		if (argObj == null) {
			setRequiredContainerContPopTopDep((ICFBamPopTopDep)null);
		}
		else {
			setRequiredContainerContPopTopDep(argObj.getRequiredPopTopDepId());
		}
	}
