	...
	implements ICFBamSubProjectTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> allSubProject;
	private Map< ICFIntSubProjectByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj > > indexByTenantIdx;
	private Map< ICFIntSubProjectByTopProjectIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj > > indexByTopProjectIdx;
	...
	public CFBamSubProjectTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj>();
		allSubProject = null;
	...
	public static int getBackingClassCode() {
		return( CFIntSubProjectTableObj.getBackingClassCode() );
	}
	...
	public ICFIntSubProjectObj realiseSubProject( ICFIntSubProjectObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByTopProjectIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj > mapTopProjectIdx = indexByTopProjectIdx.get( keyTopProjectIdx );
	...
	@Override
	public ICFIntSubProjectObj readSubProject( $implCommaIJavaOptAtomType$ pkey ) {
		return( readSubProject( pkey, false ) );
	}

	@Override
	public ICFIntSubProjectObj readSubProject( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntSubProjectObj readCachedSubProject( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntSubProjectObj obj = null;
	...
	@Override
	public void deepDisposeSubProject( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntSubProjectObj lockSubProject( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntSubProjectObj> readAllSubProject( boolean forceRead ) {
		...
		if( ( allSubProject == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntSubProjectObj>();
			allSubProject = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFIntSubProjectByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFIntSubProjectObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj>();
			ICFIntSubProjectObj obj;
	...
	public void deleteSubProjectByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> dict = indexByTenantIdx.get( key );
	...
	public void deleteSubProjectByTopProjectIdx( ICFLibKeyHash256 TopProjectId )
	{
		...
		if( indexByTopProjectIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntSubProjectObj> dict = indexByTopProjectIdx.get( key );
