...
public interface ICFBamDbKeyHash256ColTableObj
{
	 ...
	 */
	ICFBamDbKeyHash256ColObj readDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamDbKeyHash256ColObj readCachedDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeDbKeyHash256Col( ICFBamDbKeyHash256ColObj obj );

	void deepDisposeDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamDbKeyHash256ColObj lockDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey );
