// Description: Java 25 interface for a PopSubDep2 record implementation
...
/**
 *	ICFBamPopSubDep2 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamPopSubDep2 extends ICFBamPopDep
{
	...
	public default void setRequiredContainerPopSubDep1(ICFBamProtPopSubDep1 argObj) {
		if (argObj == null) {
			setRequiredContainerPopSubDep1((ICFBamPopSubDep1)null);
		}
		else {
			setRequiredContainerPopSubDep1(argObj.getRequiredPopSubDep1Id());
		}
	}
