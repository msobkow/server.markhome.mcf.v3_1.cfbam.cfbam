	...
	implements ICFBamStringDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> allStringDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamStringDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "StringDef";
	public static String TABLE_DBNAME = "strdef";

	public CFBamStringDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamStringDefObj>();
		allStringDef = null;
	...
	public ICFBamStringDefObj realiseStringDef( ICFBamStringDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamStringDefObj readStringDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readStringDef( pkey, false ) );
	}

	@Override
	public ICFBamStringDefObj readStringDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamStringDefObj readCachedStringDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamStringDefObj obj = null;
	...
	@Override
	public void deepDisposeStringDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamStringDefObj lockStringDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamStringDefObj> readAllStringDef( boolean forceRead ) {
		...
		if( ( allStringDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamStringDefObj>();
			allStringDef = map;
	...
	@Override
	public ICFBamStringDefObj readStringDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamStringDefObj readStringDefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamStringDefObj readStringDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamStringDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamStringDefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamStringDefObj> readStringDefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamStringDefObj readCachedStringDefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamStringDefObj obj = null;
	...
	@Override
	public ICFBamStringDefObj readCachedStringDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamStringDefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamStringDefObj> readCachedStringDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeStringDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeStringDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeStringDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeStringDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeStringDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeStringDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeStringDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeStringDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteStringDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteStringDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteStringDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteStringDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteStringDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteStringDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteStringDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteStringDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamStringDefObj> dict = indexByContNextIdx.get( key );
