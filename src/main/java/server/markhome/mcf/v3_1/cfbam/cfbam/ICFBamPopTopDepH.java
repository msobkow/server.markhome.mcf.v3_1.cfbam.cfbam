// Description: Java 25 interface for a PopTopDep history object
...
/**
 *	ICFBamPopTopDepH provides access to history records matching the CFBamPopTopDep object change history.
 */
