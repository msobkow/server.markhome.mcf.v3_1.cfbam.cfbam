...
// Description: Java 25 Factory service implementation for ClearSubDep1 buffers
...
/*
 *	Java 25 Factory service implementation for ClearSubDep1 buffers.
 */
@Service("cfbam31BuffClearSubDep1FactoryService")
public class CFBamBuffClearSubDep1FactoryService
	implements ICFBamClearSubDep1Factory
{
	public CFBamBuffClearSubDep1FactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearSubDep1",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearSubDep1");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearSubDep1",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearSubDep1");
			}
		}
	}
