...
public interface ICFBamPopSubDep1TableObj
{
	 ...
	 */
	ICFBamPopSubDep1Obj readPopSubDep1( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamPopSubDep1Obj readCachedPopSubDep1( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposePopSubDep1( ICFBamPopSubDep1Obj obj );

	void deepDisposePopSubDep1( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamPopSubDep1Obj lockPopSubDep1( $implCommaIJavaOptAtomType$ pkey );
