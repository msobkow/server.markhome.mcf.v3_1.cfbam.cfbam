...
/*
 *	CFBamDbKeyHash256TypeTable database interface for DbKeyHash256Type has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
