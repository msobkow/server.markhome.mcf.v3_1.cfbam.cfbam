...
public interface ICFBamUInt64DefTableObj
{
	 ...
	 */
	ICFBamUInt64DefObj readUInt64Def( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamUInt64DefObj readCachedUInt64Def( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeUInt64Def( ICFBamUInt64DefObj obj );

	void deepDisposeUInt64Def( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamUInt64DefObj lockUInt64Def( $implCommaIJavaOptAtomType$ pkey );
