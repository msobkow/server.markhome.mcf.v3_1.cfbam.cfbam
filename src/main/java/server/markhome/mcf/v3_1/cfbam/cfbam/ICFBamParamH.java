// Description: Java 25 interface for a Param history object
...
/**
 *	ICFBamParamH provides access to history records matching the CFBamParam object change history.
 */
public interface ICFBamParamH
{
