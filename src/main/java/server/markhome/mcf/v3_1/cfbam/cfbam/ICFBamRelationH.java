// Description: Java 25 interface for a Relation history object
...
/**
 *	ICFBamRelationH provides access to history records matching the CFBamRelation object change history.
 */
