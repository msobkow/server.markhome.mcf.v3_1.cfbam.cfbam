	...
	implements ICFBamUInt64Def
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt64Def rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt64DefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt64Def ) {
			setUInt64Def( (CFBamProtBuffUInt64Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt64Def ) {
			setUInt64Def( (CFBamPubBuffUInt64Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
