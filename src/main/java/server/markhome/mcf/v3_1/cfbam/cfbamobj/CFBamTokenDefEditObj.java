// Description: Java 25 edit object instance implementation for CFBam TokenDef.
	...
	implements ICFBamTokenDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTokenDefTableObj().getClassCode() );
	}
	...
	public void copyRecToOrig() {
		ICFBamTokenDef origRec = getOrigAsTokenDef().getTokenDefRec();
		ICFBamTokenDef myRec = getTokenDefRec();
		origRec.set( myRec );
	}
