// Description: Java 25 interface for a RoleDef history object
...
/**
 *	ICFBamRoleDefH provides access to history records matching the CFBamRoleDef object change history.
 */
public interface ICFBamRoleDefH
{
