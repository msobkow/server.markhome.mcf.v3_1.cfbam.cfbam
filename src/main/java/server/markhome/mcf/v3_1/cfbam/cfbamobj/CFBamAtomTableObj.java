	...
	implements ICFBamAtomTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> allAtom;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamAtomObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > > indexByContNextIdx;
	public static String TABLE_NAME = "Atom";
	public static String TABLE_DBNAME = "atomdef";

	public CFBamAtomTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamAtomObj>();
		allAtom = null;
	...
	public ICFBamAtomObj realiseAtom( ICFBamAtomObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamAtomObj readAtom( $implCommaIJavaOptAtomType$ pkey ) {
		return( readAtom( pkey, false ) );
	}

	@Override
	public ICFBamAtomObj readAtom( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamAtomObj readCachedAtom( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamAtomObj obj = null;
	...
	@Override
	public void deepDisposeAtom( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamAtomObj lockAtom( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamAtomObj> readAllAtom( boolean forceRead ) {
		...
		if( ( allAtom == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamAtomObj>();
			allAtom = map;
	...
	@Override
	public ICFBamAtomObj readAtomByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamAtomObj readAtomByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamAtomObj readAtomByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamAtomObj> readAtomByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamAtomObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamAtomObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamAtomObj> readAtomByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readAtomByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readAtomByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readAtomByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamAtomObj> readAtomByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamAtomObj readCachedAtomByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamAtomObj obj = null;
	...
	@Override
	public ICFBamAtomObj readCachedAtomByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamAtomObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamAtomObj> readCachedAtomByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeAtomByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeAtomByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeAtomByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeAtomByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeAtomByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeAtomByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeAtomByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeAtomByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteAtomByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteAtomByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteAtomByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteAtomByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteAtomByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteAtomByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteAtomByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteAtomByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamAtomObj> dict = indexByContNextIdx.get( key );
