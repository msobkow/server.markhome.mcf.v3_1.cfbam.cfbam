	...
	implements ICFBamTimeType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimeType rhs ) {
		...
		else if( obj instanceof ICFBamTimeTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimeType ) {
			setTimeType( (CFBamProtBuffTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeType ) {
			setTimeType( (CFBamPubBuffTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
