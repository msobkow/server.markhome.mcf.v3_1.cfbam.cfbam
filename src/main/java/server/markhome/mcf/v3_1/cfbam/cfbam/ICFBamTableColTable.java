...
/*
 *	CFBamTableColTable database interface for TableCol has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
