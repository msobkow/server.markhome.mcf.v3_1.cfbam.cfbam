	...
	implements ICFBamDoubleType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDoubleType rhs ) {
		...
		else if( obj instanceof ICFBamDoubleTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDoubleType ) {
			setDoubleType( (CFBamProtBuffDoubleType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDoubleType ) {
			setDoubleType( (CFBamPubBuffDoubleType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
