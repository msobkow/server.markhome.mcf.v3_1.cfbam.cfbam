...
// Description: Java 25 DbIO interface for ClearDep.
...
/*
 *	CFBamClearDepTable database interface for ClearDep has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamClearDepTable
{
	 ...
	 */
	ICFBamClearDep createClearDep( ICFSecAuthorization Authorization,
		ICFBamClearDep rec );
	 ...
	 */
	ICFBamClearDep updateClearDep( ICFSecAuthorization Authorization,
		ICFBamClearDep rec );
	 ...
	 */
	void deleteClearDep( ICFSecAuthorization Authorization,
		ICFBamClearDep rec );
	/**
	 ...
	 */
	ICFBamClearDep[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamClearDep[] readAllRec( ICFSecAuthorization Authorization );
