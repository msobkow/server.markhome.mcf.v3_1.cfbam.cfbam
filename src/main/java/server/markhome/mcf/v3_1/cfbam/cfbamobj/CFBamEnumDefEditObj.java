// Description: Java 25 edit object instance implementation for CFBam EnumDef.
	...
	implements ICFBamEnumDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getEnumDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsEnumDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryEnumDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamEnumDef origRec = getOrigAsEnumDef().getEnumDefRec();
		ICFBamEnumDef myRec = getEnumDefRec();
		origRec.set( myRec );
	}
