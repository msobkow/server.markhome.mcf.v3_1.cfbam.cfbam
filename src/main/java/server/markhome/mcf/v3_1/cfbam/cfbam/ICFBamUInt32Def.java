// Description: Java 25 interface for a UInt32Def record implementation
...
/**
 *	ICFBamUInt32Def persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUInt32Def extends ICFBamAtom
{
