...
public interface ICFBamDateColTableObj
{
	 ...
	 */
	ICFBamDateColObj readDateCol( ICFLibKeyHash256 pkey );
	...
	ICFBamDateColObj readCachedDateCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamDateColObj lockDateCol( ICFLibKeyHash256 pkey );
