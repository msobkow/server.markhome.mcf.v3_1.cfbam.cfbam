	...
	implements ICFBamURLProtocolTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj> allURLProtocol;
	...
	private Map< ICFIntURLProtocolByIsSecureIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj > > indexByIsSecureIdx;
	public static String TABLE_NAME = "URLProtocol";
	public static String TABLE_DBNAME = "urlproto";

	public CFBamURLProtocolTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj>();
		allURLProtocol = null;
	...
	public static int getBackingClassCode() {
		return( CFIntURLProtocolTableObj.getBackingClassCode() );
	}
	...
	public ICFIntURLProtocolObj realiseURLProtocol( ICFIntURLProtocolObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByIsSecureIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj > mapIsSecureIdx = indexByIsSecureIdx.get( keyIsSecureIdx );
	...
	@Override
	public ICFIntURLProtocolObj readURLProtocol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readURLProtocol( pkey, false ) );
	}

	@Override
	public ICFIntURLProtocolObj readURLProtocol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntURLProtocolObj readCachedURLProtocol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntURLProtocolObj obj = null;
	...
	@Override
	public void deepDisposeURLProtocol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntURLProtocolObj lockURLProtocol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntURLProtocolObj> readAllURLProtocol( boolean forceRead ) {
		...
		if( ( allURLProtocol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntURLProtocolObj>();
			allURLProtocol = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj> dict;
		if( indexByIsSecureIdx == null ) {
			indexByIsSecureIdx = new HashMap< ICFIntURLProtocolByIsSecureIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFIntURLProtocolObj > >();
		}
		if( ( ! forceRead ) && indexByIsSecureIdx.containsKey( key ) ) {
			dict = indexByIsSecureIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj>();
			ICFIntURLProtocolObj obj;
	...
	public void deleteURLProtocolByIsSecureIdx( boolean IsSecure )
	{
		...
		if( indexByIsSecureIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntURLProtocolObj> dict = indexByIsSecureIdx.get( key );
