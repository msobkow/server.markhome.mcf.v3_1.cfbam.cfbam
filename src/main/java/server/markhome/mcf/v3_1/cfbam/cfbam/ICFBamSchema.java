	...
	ICFIntSchema
{
	...
	public static final CFSecTableData TABLE_DATA[] = {new CFSecTableData("CFBam", "Atom", "Value", true, false, "Tenant", "Public"),
		...
		new CFSecTableData("CFBam", "Chain", null, true, false, "Tenant", "Public"),
