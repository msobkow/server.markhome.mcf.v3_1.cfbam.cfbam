	...
	implements ICFBamTopDomainTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> allTopDomain;
	private Map< ICFIntTopDomainByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj > > indexByTenantIdx;
	private Map< ICFIntTopDomainByTldIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj > > indexByTldIdx;
	...
	public CFBamTopDomainTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj>();
		allTopDomain = null;
	...
	public static int getBackingClassCode() {
		return( CFIntTopDomainTableObj.getBackingClassCode() );
	}
	...
	public ICFIntTopDomainObj realiseTopDomain( ICFIntTopDomainObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByTldIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj > mapTldIdx = indexByTldIdx.get( keyTldIdx );
				if( mapTldIdx != null ) {
	...
	@Override
	public ICFIntTopDomainObj readTopDomain( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTopDomain( pkey, false ) );
	}

	@Override
	public ICFIntTopDomainObj readTopDomain( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntTopDomainObj readCachedTopDomain( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntTopDomainObj obj = null;
	...
	@Override
	public void deepDisposeTopDomain( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntTopDomainObj lockTopDomain( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntTopDomainObj> readAllTopDomain( boolean forceRead ) {
		...
		if( ( allTopDomain == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntTopDomainObj>();
			allTopDomain = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFIntTopDomainByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFIntTopDomainObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj>();
			ICFIntTopDomainObj obj;
	...
	public void deleteTopDomainByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> dict = indexByTenantIdx.get( key );
	...
	public void deleteTopDomainByTldIdx( ICFLibKeyHash256 TldId )
	{
		...
		if( indexByTldIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntTopDomainObj> dict = indexByTldIdx.get( key );
