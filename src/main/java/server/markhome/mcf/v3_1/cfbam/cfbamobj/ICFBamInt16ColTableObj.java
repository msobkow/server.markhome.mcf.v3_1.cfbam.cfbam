...
public interface ICFBamInt16ColTableObj
{
	 ...
	 */
	ICFBamInt16ColObj readInt16Col( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamInt16ColObj readCachedInt16Col( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeInt16Col( ICFBamInt16ColObj obj );

	void deepDisposeInt16Col( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamInt16ColObj lockInt16Col( $implCommaIJavaOptAtomType$ pkey );
