...
public interface ICFBamTweak
{
	...
	public static final String S_SCOPEID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	...
	public static final String S_DEFSCHEMATENANTID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
