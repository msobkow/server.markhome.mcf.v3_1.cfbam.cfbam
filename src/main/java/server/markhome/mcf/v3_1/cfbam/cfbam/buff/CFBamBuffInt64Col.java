	...
	implements ICFBamInt64Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt64Col rhs ) {
		...
		else if( obj instanceof ICFBamInt64ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt64Col ) {
			setInt64Col( (CFBamProtBuffInt64Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt64Col ) {
			setInt64Col( (CFBamPubBuffInt64Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
