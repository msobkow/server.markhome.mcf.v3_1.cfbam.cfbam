// Description: Java 25 interface for a DelDep record declementation
...
/**
 *	ICFBamDelDep persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDelDep
	extends ICFBamScope
{
