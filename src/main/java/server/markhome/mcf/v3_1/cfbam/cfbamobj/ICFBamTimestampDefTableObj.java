...
public interface ICFBamTimestampDefTableObj
{
	 ...
	 */
	ICFBamTimestampDefObj readTimestampDef( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTimestampDefObj readCachedTimestampDef( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTimestampDef( ICFBamTimestampDefObj obj );

	void deepDisposeTimestampDef( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTimestampDefObj lockTimestampDef( $implCommaIJavaOptAtomType$ pkey );
