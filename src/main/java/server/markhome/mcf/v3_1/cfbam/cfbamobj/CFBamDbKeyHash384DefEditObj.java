// Description: Java 25 edit object instance implementation for CFBam DbKeyHash384Def.
	...
	implements ICFBamDbKeyHash384DefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash384DefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash384Def().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash384Def().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setOptionalInitValue( String value ) {
		if( getDbKeyHash384DefRec().getOptionalInitValue() != value ) {
			getDbKeyHash384DefRec().setOptionalInitValue( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamDbKeyHash384Def origRec = getOrigAsDbKeyHash384Def().getDbKeyHash384DefRec();
		ICFBamDbKeyHash384Def myRec = getDbKeyHash384DefRec();
		origRec.set( myRec );
	}
