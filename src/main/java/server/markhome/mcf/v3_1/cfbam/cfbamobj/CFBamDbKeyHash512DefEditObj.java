// Description: Java 25 edit object instance implementation for CFBam DbKeyHash512Def.
	...
	implements ICFBamDbKeyHash512DefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash512DefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash512Def().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash512Def().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamDbKeyHash512Def origRec = getOrigAsDbKeyHash512Def().getDbKeyHash512DefRec();
		ICFBamDbKeyHash512Def myRec = getDbKeyHash512DefRec();
		origRec.set( myRec );
	}
