	...
	implements ICFBamBoolTypeTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamBoolTypeObj> members;
	private Map<ICFLibKeyHash256, ICFBamBoolTypeObj> allBoolType;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamBoolTypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexByContNextIdx;
	private Map< ICFBamBoolTypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "BoolType";
	public static String TABLE_DBNAME = "booltyp";

	public CFBamBoolTypeTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamBoolTypeObj>();
		allBoolType = null;
	...
	public ICFBamBoolTypeObj realiseBoolType( ICFBamBoolTypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolTypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamBoolTypeObj readBoolType( ICFLibKeyHash256 pkey ) {
		return( readBoolType( pkey, false ) );
	}

	@Override
	public ICFBamBoolTypeObj readBoolType( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamBoolTypeObj readCachedBoolType( ICFLibKeyHash256 pkey ) {
		ICFBamBoolTypeObj obj = null;
	...
	@Override
	public void deepDisposeBoolType( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamBoolTypeObj lockBoolType( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamBoolTypeObj> readAllBoolType( boolean forceRead ) {
		...
		if( ( allBoolType == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> map = new HashMap<ICFLibKeyHash256,ICFBamBoolTypeObj>();
			allBoolType = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamBoolTypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamBoolTypeObj>();
			ICFBamValueObj obj;
	...
	public void deleteBoolTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteBoolTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteBoolTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteBoolTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteBoolTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolTypeObj> dict = indexBySchemaIdx.get( key );
