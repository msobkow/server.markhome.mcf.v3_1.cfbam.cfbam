// Description: Java 25 edit object instance implementation for CFBam Int64Type.
	...
	implements ICFBamInt64TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt64TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt64Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt64Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsInt64Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getInt64TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getInt64TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamInt64Type origRec = getOrigAsInt64Type().getInt64TypeRec();
		ICFBamInt64Type myRec = getInt64TypeRec();
		origRec.set( myRec );
	}
