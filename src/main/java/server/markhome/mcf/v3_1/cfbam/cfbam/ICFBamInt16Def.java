// Description: Java 25 interface for a Int16Def record declementation
...
/**
 *	ICFBamInt16Def persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamInt16Def
	extends ICFBamAtom
{
