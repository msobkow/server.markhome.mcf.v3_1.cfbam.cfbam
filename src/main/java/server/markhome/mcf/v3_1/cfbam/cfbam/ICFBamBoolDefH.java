// Description: Java 25 interface for a BoolDef history object
...
/**
 *	ICFBamBoolDefH provides access to history records matching the CFBamBoolDef object change history.
 */
public interface ICFBamBoolDefH extends ICFBamAtomH
{
