// Description: Java 25 interface for a Chain history object
...
/**
 *	ICFBamChainH provides access to history records matching the CFBamChain object change history.
 */
public interface ICFBamChainH
{
