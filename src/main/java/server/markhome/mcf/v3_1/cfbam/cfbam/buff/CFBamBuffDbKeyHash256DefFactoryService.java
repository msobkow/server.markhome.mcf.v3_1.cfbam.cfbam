...
// Description: Java 25 Factory service implementation for DbKeyHash256Def buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash256Def buffers.
 */
@Service("cfbam31BuffDbKeyHash256DefFactoryService")
public class CFBamBuffDbKeyHash256DefFactoryService
	implements ICFBamDbKeyHash256DefFactory
{
	public CFBamBuffDbKeyHash256DefFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash256Def",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash256Def");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash256Def",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash256Def");
			}
		}
	}
