...
// Description: Java 25 Factory service implementation for UInt32Col buffers
...
/*
 *	Java 25 Factory service implementation for UInt32Col buffers.
 */
@Service("cfbam31BuffUInt32ColFactoryService")
public class CFBamBuffUInt32ColFactoryService
	implements ICFBamUInt32ColFactory
{
	public CFBamBuffUInt32ColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUInt32Col",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUInt32Col");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUInt32Col",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUInt32Col");
			}
		}
	}
