	...
	implements ICFBamDbKeyHash160DefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> allDbKeyHash160Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash160DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > > indexByContNextIdx;
	...
	public CFBamDbKeyHash160DefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj>();
	...
	public ICFBamDbKeyHash160DefObj realiseDbKeyHash160Def( ICFBamDbKeyHash160DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamDbKeyHash160DefObj readDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDbKeyHash160Def( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash160DefObj readDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash160DefObj readCachedDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDbKeyHash160DefObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDbKeyHash160DefObj lockDbKeyHash160Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDbKeyHash160DefObj> readAllDbKeyHash160Def( boolean forceRead ) {
		...
		if( ( allDbKeyHash160Def == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDbKeyHash160DefObj>();
	...
	@Override
	public ICFBamDbKeyHash160DefObj readDbKeyHash160DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDbKeyHash160DefObj readDbKeyHash160DefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamDbKeyHash160DefObj readDbKeyHash160DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readDbKeyHash160DefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamDbKeyHash160DefObj readCachedDbKeyHash160DefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDbKeyHash160DefObj obj = null;
	...
	@Override
	public ICFBamDbKeyHash160DefObj readCachedDbKeyHash160DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamDbKeyHash160DefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160DefObj> readCachedDbKeyHash160DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteDbKeyHash160DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDbKeyHash160DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteDbKeyHash160DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160DefObj> dict = indexByContNextIdx.get( key );
