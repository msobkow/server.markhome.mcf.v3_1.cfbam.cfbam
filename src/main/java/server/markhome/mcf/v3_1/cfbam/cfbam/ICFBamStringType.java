// Description: Java 25 interface for a StringType record declementation
...
/**
 *	ICFBamStringType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamStringType
	extends ICFBamStringDef
{
