	...
	implements ICFBamId16GenTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamId16GenObj> members;
	private Map<ICFLibKeyHash256, ICFBamId16GenObj> allId16Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamId16GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexByContNextIdx;
	private Map< ICFBamInt16TypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamId16GenObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "Id16Gen";
	public static String TABLE_DBNAME = "idg16";

	public CFBamId16GenTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamId16GenObj>();
		allId16Gen = null;
	...
	public ICFBamId16GenObj realiseId16Gen( ICFBamId16GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId16GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamId16GenObj readId16Gen( ICFLibKeyHash256 pkey ) {
		return( readId16Gen( pkey, false ) );
	}

	@Override
	public ICFBamId16GenObj readId16Gen( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamId16GenObj readCachedId16Gen( ICFLibKeyHash256 pkey ) {
		ICFBamId16GenObj obj = null;
	...
	@Override
	public void deepDisposeId16Gen( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamId16GenObj lockId16Gen( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamId16GenObj> readAllId16Gen( boolean forceRead ) {
		...
		if( ( allId16Gen == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> map = new HashMap<ICFLibKeyHash256,ICFBamId16GenObj>();
			allId16Gen = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamId16GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamId16GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamId16GenObj>();
			ICFBamValueObj obj;
	...
	public void deleteId16GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteId16GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteId16GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteId16GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteId16GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId16GenObj> dict = indexBySchemaIdx.get( key );
