	...
	implements ICFBamId16GenTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> allId16Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamId16GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexByContNextIdx;
	private Map< ICFBamInt16TypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "Id16Gen";
	public static String TABLE_DBNAME = "idg16";

	public CFBamId16GenTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamId16GenObj>();
		allId16Gen = null;
	...
	public ICFBamId16GenObj realiseId16Gen( ICFBamId16GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamId16GenObj readId16Gen( $implCommaIJavaOptAtomType$ pkey ) {
		return( readId16Gen( pkey, false ) );
	}

	@Override
	public ICFBamId16GenObj readId16Gen( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamId16GenObj readCachedId16Gen( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamId16GenObj obj = null;
	...
	@Override
	public void deepDisposeId16Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamId16GenObj lockId16Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamId16GenObj> readAllId16Gen( boolean forceRead ) {
		...
		if( ( allId16Gen == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamId16GenObj>();
			allId16Gen = map;
	...
	@Override
	public ICFBamId16GenObj readId16GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamId16GenObj readId16GenByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamId16GenObj readId16GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamId16GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamId16GenObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamId16GenObj> readId16GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public ICFBamId16GenObj readCachedId16GenByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamId16GenObj obj = null;
	...
	@Override
	public ICFBamId16GenObj readCachedId16GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamId16GenObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId16GenObj> readCachedId16GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deepDisposeId16GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeId16GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeId16GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeId16GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeId16GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeId16GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeId16GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeId16GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeId16GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deleteId16GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteId16GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteId16GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteId16GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteId16GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteId16GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteId16GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteId16GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteId16GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		ICFBamInt16TypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt16Type().newBySchemaIdxKey();
		key.setRequiredSchemaDefId( SchemaDefId );
		if( indexBySchemaIdx == null ) {
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId16GenObj> dict = indexBySchemaIdx.get( key );
