// Description: Java 25 interface for a Value history object
...
/**
 *	ICFBamValueH provides access to history records matching the CFBamValue object change history.
 */
public interface ICFBamValueH
{
