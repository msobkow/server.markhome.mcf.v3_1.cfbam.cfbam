	...
	implements ICFBamInt16DefTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamInt16DefObj> members;
	private Map<ICFLibKeyHash256, ICFBamInt16DefObj> allInt16Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamInt16DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamInt16DefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "Int16Def";
	public static String TABLE_DBNAME = "int16def";

	public CFBamInt16DefTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamInt16DefObj>();
		allInt16Def = null;
	...
	public ICFBamInt16DefObj realiseInt16Def( ICFBamInt16DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamInt16DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamInt16DefObj readInt16Def( ICFLibKeyHash256 pkey ) {
		return( readInt16Def( pkey, false ) );
	}

	@Override
	public ICFBamInt16DefObj readInt16Def( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamInt16DefObj readCachedInt16Def( ICFLibKeyHash256 pkey ) {
		ICFBamInt16DefObj obj = null;
	...
	@Override
	public void deepDisposeInt16Def( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamInt16DefObj lockInt16Def( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamInt16DefObj> readAllInt16Def( boolean forceRead ) {
		...
		if( ( allInt16Def == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> map = new HashMap<ICFLibKeyHash256,ICFBamInt16DefObj>();
			allInt16Def = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamInt16DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamInt16DefObj>();
			ICFBamValueObj obj;
	...
	public void deleteInt16DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteInt16DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteInt16DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteInt16DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamInt16DefObj> dict = indexByContNextIdx.get( key );
