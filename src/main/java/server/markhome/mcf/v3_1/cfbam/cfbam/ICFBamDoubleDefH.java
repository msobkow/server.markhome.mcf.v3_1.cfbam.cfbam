// Description: Java 25 interface for a DoubleDef history object
...
/**
 *	ICFBamDoubleDefH provides access to history records matching the CFBamDoubleDef object change history.
 */
public interface ICFBamDoubleDefH extends ICFBamAtomH
{
