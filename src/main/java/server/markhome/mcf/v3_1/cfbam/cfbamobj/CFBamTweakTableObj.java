	...
	implements ICFBamTweakTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> allTweak;
	private Map< ICFBamTweakByUNameIdxKey,
		ICFBamTweakObj > indexByUNameIdx;
	private Map< ICFBamTweakByValTentIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > > indexByValTentIdx;
	private Map< ICFBamTweakByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > > indexByScopeIdx;
	private Map< ICFBamTweakByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > > indexByDefSchemaIdx;
	...
	public CFBamTweakTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTweakObj>();
		allTweak = null;
	...
	public ICFBamTweakObj constructByClassCode( int backingClassCode ) {
		...
		else if( backingClassCode == ICFBamIndexTweak.CLASS_CODE ) {
	...
	public ICFBamTweakObj realiseTweak( ICFBamTweakObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByValTentIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > mapValTentIdx = indexByValTentIdx.get( keyValTentIdx );
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
	...
	@Override
	public ICFBamTweakObj readTweak( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTweak( pkey, false ) );
	}

	@Override
	public ICFBamTweakObj readTweak( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
		ICFBamTweakObj obj = null;
	...
	@Override
	public ICFBamTweakObj readCachedTweak( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTweakObj obj = null;
	...
	public void reallyDeepDisposeTweak( ICFBamTweakObj obj )
	{
		...
		members.remove( pkey );
		ICFBamTweakByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByUNameIdxKey();
		keyUNameIdx.setRequiredScopeId( existing.getRequiredScopeId() );
		keyUNameIdx.setRequiredName( existing.getRequiredName() );

		ICFBamTweakByValTentIdxKey keyValTentIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByValTentIdxKey();
		keyValTentIdx.setRequiredTenantId( existing.getRequiredTenantId() );

		ICFBamTweakByScopeIdxKey keyScopeIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByScopeIdxKey();
		keyScopeIdx.setRequiredScopeId( existing.getRequiredScopeId() );

		ICFBamTweakByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByDefSchemaIdxKey();
		keyDefSchemaIdx.setOptionalDefSchemaId( existing.getOptionalDefSchemaId() );

		ICFBamTweakByUDefIdxKey keyUDefIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByUDefIdxKey();
	...
	@Override
	public void deepDisposeTweak( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTweakObj lockTweak( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTweakObj> readAllTweak( boolean forceRead ) {
		...
		if( ( allTweak == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTweakObj>();
			allTweak = map;
	...
	@Override
	public ICFBamTweakObj readTweakByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamTweakObj readTweakByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamTweakObj readTweakByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamTweakObj> readTweakByValTentIdx( ICFLibKeyHash256 TenantId )
	{
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> dict;
		if( indexByValTentIdx == null ) {
			indexByValTentIdx = new HashMap< ICFBamTweakByValTentIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTweakObj > >();
		}
		if( ( ! forceRead ) && indexByValTentIdx.containsKey( key ) ) {
			dict = indexByValTentIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTweakObj>();
			ICFBamTweakObj obj;
	...
	@Override
	public List<ICFBamTweakObj> readTweakByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTweakObj> readTweakByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public ICFBamTweakObj readTweakByUDefIdx( ICFLibKeyHash256 TenantId,
	...
	@Override
	public ICFBamTweakObj readCachedTweakByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamTweakObj obj = null;
	...
	@Override
	public ICFBamTweakObj readCachedTweakByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamTweakObj obj = null;
		ICFBamTweakByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamTweakObj> readCachedTweakByValTentIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public List<ICFBamTweakObj> readCachedTweakByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTweakObj> readCachedTweakByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public ICFBamTweakObj readCachedTweakByUDefIdx( ICFLibKeyHash256 TenantId,
		ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 DefSchemaTenantId,
		ICFLibKeyHash256 DefSchemaId,
		String Name )
	...
	@Override
	public void deepDisposeTweakByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeTweakByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeTweakByValTentIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public void deepDisposeTweakByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeTweakByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeTweakByUDefIdx( ICFLibKeyHash256 TenantId,
		ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 DefSchemaTenantId,
		ICFLibKeyHash256 DefSchemaId,
		String Name )
	...
	@Override
	public void deleteTweakByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteTweakByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamTweakByUNameIdxKey,
	...
	@Override
	public void deleteTweakByValTentIdx( ICFLibKeyHash256 TenantId )
	{
		ICFBamTweakByValTentIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByValTentIdxKey();
		key.setRequiredTenantId( TenantId );
		if( indexByValTentIdx == null ) {
		...
		if( indexByValTentIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> dict = indexByValTentIdx.get( key );
	...
	@Override
	public void deleteTweakByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamTweakByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteTweakByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamTweakByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTweak().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTweakObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteTweakByUDefIdx( ICFLibKeyHash256 TenantId,
		ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 DefSchemaTenantId,
		ICFLibKeyHash256 DefSchemaId,
		String Name )
