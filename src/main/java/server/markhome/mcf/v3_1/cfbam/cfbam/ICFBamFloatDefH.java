// Description: Java 25 interface for a FloatDef history object
...
/**
 *	ICFBamFloatDefH provides access to history records matching the CFBamFloatDef object change history.
 */
public interface ICFBamFloatDefH extends ICFBamAtomH
{
