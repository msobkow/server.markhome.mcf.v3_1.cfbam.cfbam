	...
	implements ICFBamBlobCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamBlobCol rhs ) {
		...
		else if( obj instanceof ICFBamBlobColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffBlobCol ) {
			setBlobCol( (CFBamProtBuffBlobCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBlobCol ) {
			setBlobCol( (CFBamPubBuffBlobCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
