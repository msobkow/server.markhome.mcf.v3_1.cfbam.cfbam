	...
	implements ICFBamDbKeyHash128Gen
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash128Gen rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash128GenH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash128Gen ) {
			setDbKeyHash128Gen( (CFBamProtBuffDbKeyHash128Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash128Gen ) {
			setDbKeyHash128Gen( (CFBamPubBuffDbKeyHash128Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
