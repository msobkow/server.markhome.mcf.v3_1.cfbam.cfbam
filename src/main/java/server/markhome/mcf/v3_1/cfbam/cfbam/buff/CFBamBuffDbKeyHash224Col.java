	...
	implements ICFBamDbKeyHash224Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash224Col rhs ) {
		...
		else if( obj instanceof ICFBamDbKeyHash224ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash224Col ) {
			setDbKeyHash224Col( (CFBamProtBuffDbKeyHash224Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash224Col ) {
			setDbKeyHash224Col( (CFBamPubBuffDbKeyHash224Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
