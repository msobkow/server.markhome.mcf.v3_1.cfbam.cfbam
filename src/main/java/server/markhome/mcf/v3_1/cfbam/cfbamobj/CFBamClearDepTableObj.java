	...
	implements ICFBamClearDepTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> allClearDep;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > > indexByTenantIdx;
	private Map< ICFBamClearDepByClearDepIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > > indexByClearDepIdx;
	private Map< ICFBamClearDepByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > > indexByDefSchemaIdx;
	public static String TABLE_NAME = "ClearDep";
	public static String TABLE_DBNAME = "clr_dep";

	public CFBamClearDepTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamClearDepObj>();
		allClearDep = null;
	...
	public ICFBamClearDepObj realiseClearDep( ICFBamClearDepObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByClearDepIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > mapClearDepIdx = indexByClearDepIdx.get( keyClearDepIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
	...
	@Override
	public ICFBamClearDepObj readClearDep( $implCommaIJavaOptAtomType$ pkey ) {
		return( readClearDep( pkey, false ) );
	}

	@Override
	public ICFBamClearDepObj readClearDep( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamClearDepObj readCachedClearDep( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamClearDepObj obj = null;
	...
	public void reallyDeepDisposeClearDep( ICFBamClearDepObj obj )
	{
		...
		members.remove( pkey );
		ICFBamClearDepByClearDepIdxKey keyClearDepIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryClearDep().newByClearDepIdxKey();
		keyClearDepIdx.setRequiredRelationId( existing.getRequiredRelationId() );

		ICFBamClearDepByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryClearDep().newByDefSchemaIdxKey();
	...
	@Override
	public void deepDisposeClearDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamClearDepObj lockClearDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamClearDepObj> readAllClearDep( boolean forceRead ) {
		...
		if( ( allClearDep == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamClearDepObj>();
			allClearDep = map;
	...
	@Override
	public ICFBamClearDepObj readClearDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamClearDepObj readClearDepByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public List<ICFBamClearDepObj> readClearDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamClearDepObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamClearDepObj>();
			ICFBamScopeObj obj;
	...
	@Override
	public List<ICFBamClearDepObj> readClearDepByClearDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public List<ICFBamClearDepObj> readClearDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public ICFBamClearDepObj readCachedClearDepByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamClearDepObj obj = null;
	...
	@Override
	public List<ICFBamClearDepObj> readCachedClearDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public List<ICFBamClearDepObj> readCachedClearDepByClearDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public List<ICFBamClearDepObj> readCachedClearDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeClearDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeClearDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public void deepDisposeClearDepByClearDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public void deepDisposeClearDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deleteClearDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteClearDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		ICFBamScopeByTenantIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryScope().newByTenantIdxKey();
		key.setRequiredTenantId( TenantId );
		if( indexByTenantIdx == null ) {
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> dict = indexByTenantIdx.get( key );
	...
	@Override
	public void deleteClearDepByClearDepIdx( ICFLibKeyHash256 RelationId )
	{
		ICFBamClearDepByClearDepIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryClearDep().newByClearDepIdxKey();
		key.setRequiredRelationId( RelationId );
		if( indexByClearDepIdx == null ) {
		...
		if( indexByClearDepIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> dict = indexByClearDepIdx.get( key );
	...
	@Override
	public void deleteClearDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamClearDepByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryClearDep().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamClearDepObj> dict = indexByDefSchemaIdx.get( key );
