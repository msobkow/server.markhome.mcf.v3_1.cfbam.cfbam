...
public interface ICFBamNumberColTableObj
{
	 ...
	 */
	ICFBamNumberColObj readNumberCol( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamNumberColObj readCachedNumberCol( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeNumberCol( ICFBamNumberColObj obj );

	void deepDisposeNumberCol( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamNumberColObj lockNumberCol( $implCommaIJavaOptAtomType$ pkey );
