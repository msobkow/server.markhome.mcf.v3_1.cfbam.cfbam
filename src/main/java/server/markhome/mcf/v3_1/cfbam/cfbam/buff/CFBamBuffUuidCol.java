	...
	implements ICFBamUuidCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuidCol rhs ) {
		...
		else if( obj instanceof ICFBamUuidColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuidCol ) {
			setUuidCol( (CFBamProtBuffUuidCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuidCol ) {
			setUuidCol( (CFBamPubBuffUuidCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
