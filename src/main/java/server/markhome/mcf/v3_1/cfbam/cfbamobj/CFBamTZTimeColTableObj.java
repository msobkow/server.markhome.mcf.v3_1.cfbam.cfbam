	...
	implements ICFBamTZTimeColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> allTZTimeCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTZTimeColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByContNextIdx;
	private Map< ICFBamTZTimeColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > > indexByTableIdx;
	public static String TABLE_NAME = "TZTimeCol";
	public static String TABLE_DBNAME = "tmzcol";

	public CFBamTZTimeColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj>();
		allTZTimeCol = null;
	...
	public ICFBamTZTimeColObj realiseTZTimeCol( ICFBamTZTimeColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamTZTimeColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamTZTimeColObj readTZTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTZTimeCol( pkey, false ) );
	}

	@Override
	public ICFBamTZTimeColObj readTZTimeCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTZTimeColObj readCachedTZTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTZTimeColObj obj = null;
	...
	public void reallyDeepDisposeTZTimeCol( ICFBamTZTimeColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamTZTimeColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeTZTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTZTimeColObj lockTZTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTZTimeColObj> readAllTZTimeCol( boolean forceRead ) {
		...
		if( ( allTZTimeCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTZTimeColObj>();
			allTZTimeCol = map;
	...
	@Override
	public ICFBamTZTimeColObj readTZTimeColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamTZTimeColObj readTZTimeColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamTZTimeColObj readTZTimeColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTZTimeColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTZTimeColObj> readTZTimeColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamTZTimeColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
	...
	@Override
	public ICFBamTZTimeColObj readCachedTZTimeColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamTZTimeColObj obj = null;
	...
	@Override
	public ICFBamTZTimeColObj readCachedTZTimeColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamTZTimeColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTZTimeColObj> readCachedTZTimeColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeTZTimeColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeTZTimeColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTZTimeColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteTZTimeColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteTZTimeColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteTZTimeColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteTZTimeColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamTZTimeColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTZTimeCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeColObj> dict = indexByTableIdx.get( key );
