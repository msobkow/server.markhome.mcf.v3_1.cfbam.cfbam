	...
	implements ICFBamUuidColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> allUuidCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUuidColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByContNextIdx;
	private Map< ICFBamUuidColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > > indexByTableIdx;
	public static String TABLE_NAME = "UuidCol";
	public static String TABLE_DBNAME = "uuidcol";

	public CFBamUuidColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUuidColObj>();
		allUuidCol = null;
	...
	public ICFBamUuidColObj realiseUuidCol( ICFBamUuidColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamUuidColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamUuidColObj readUuidCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readUuidCol( pkey, false ) );
	}

	@Override
	public ICFBamUuidColObj readUuidCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUuidColObj readCachedUuidCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamUuidColObj obj = null;
	...
	public void reallyDeepDisposeUuidCol( ICFBamUuidColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamUuidColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeUuidCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamUuidColObj lockUuidCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamUuidColObj> readAllUuidCol( boolean forceRead ) {
		...
		if( ( allUuidCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamUuidColObj>();
			allUuidCol = map;
	...
	@Override
	public ICFBamUuidColObj readUuidColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamUuidColObj readUuidColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamUuidColObj readUuidColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamUuidColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUuidColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUuidColObj> readUuidColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamUuidColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
	...
	@Override
	public ICFBamUuidColObj readCachedUuidColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamUuidColObj obj = null;
	...
	@Override
	public ICFBamUuidColObj readCachedUuidColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamUuidColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUuidColObj> readCachedUuidColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeUuidColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeUuidColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeUuidColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeUuidColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeUuidColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUuidColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUuidColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUuidColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUuidColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteUuidColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteUuidColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteUuidColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteUuidColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteUuidColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteUuidColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteUuidColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteUuidColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteUuidColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamUuidColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUuidCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUuidColObj> dict = indexByTableIdx.get( key );
