// Description: Java 25 Table Object implementation for EnumType.
	...
	implements ICFBamEnumTypeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> allEnumType;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamEnumTypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexByContNextIdx;
	private Map< ICFBamEnumTypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "EnumType";
	public static String TABLE_DBNAME = "enumtyp";

	public CFBamEnumTypeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj>();
		allEnumType = null;
	...
	public int getClassCode() {
		return CFBamEnumTypeTableObj.getRuntimeClassCode();
	}	
	...
	static void setRuntimeClassCode(int argNewClassCode ) {
		if (argNewClassCode <= 0) {
			throw new CFLibArgumentUnderflowException(CFBamEnumTypeTableObj.class, "setRuntimeClassCode", 1, "argNewClassCode", argNewClassCode, 1);
		}
	...
	public ICFBamEnumTypeObj realiseEnumType( ICFBamEnumTypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	public ICFBamEnumTypeObj createEnumType( ICFBamEnumTypeObj Obj ) {
		ICFBamEnumTypeObj obj = Obj;
		ICFBamEnumType rec = obj.getEnumTypeRec();
		schema.getCFBamBackingStore().getTableEnumType().createEnumType(
			null,
			rec );
		obj.copyRecToPKey();
	...
	@Override
	public ICFBamEnumTypeObj readEnumType( $implCommaIJavaOptAtomType$ pkey ) {
		return( readEnumType( pkey, false ) );
	}

	@Override
	public ICFBamEnumTypeObj readEnumType( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
		ICFBamEnumTypeObj obj = null;
		if( ( ! forceRead ) && members.containsKey( pkey ) ) {
			obj = members.get( pkey );
		}
		else {
			ICFBamEnumType readRec = schema.getCFBamBackingStore().getTableEnumType().readDerivedByIdIdx( null,
						pkey );
			if( readRec != null ) {
				obj = (ICFBamEnumTypeObj)schema.getValueTableObj().constructByClassCode( readRec.getClassCode() );
	...
	@Override
	public ICFBamEnumTypeObj readCachedEnumType( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamEnumTypeObj obj = null;
	...
	public void reallyDeepDisposeEnumType( ICFBamEnumTypeObj obj )
	{
		...
		members.remove( pkey );
		ICFBamEnumTypeBySchemaIdxKey keySchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryEnumType().newBySchemaIdxKey();
	...
	@Override
	public void deepDisposeEnumType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamEnumTypeObj lockEnumType( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamEnumTypeObj locked = null;
		ICFBamEnumType lockRec = schema.getCFBamBackingStore().getTableEnumType().lockDerived( null, pkey );
		if( lockRec != null ) {
				locked = (ICFBamEnumTypeObj)schema.getValueTableObj().constructByClassCode( lockRec.getClassCode() );
	...
	public List<ICFBamEnumTypeObj> readAllEnumType( boolean forceRead ) {
		...
		if( ( allEnumType == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamEnumTypeObj>();
			allEnumType = map;
			...
			for( int idx = 0; idx < recList.length; idx ++ ) {
				rec = recList[ idx ];
				obj = (ICFBamEnumTypeObj)schema.getValueTableObj().constructByClassCode( rec.getClassCode() );
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamEnumTypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj>();
			ICFBamValueObj obj;
	...
	public void deepDisposeEnumTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByScopeIdx( ScopeId );
		if( arrayList != null )  {
	...
	public void deepDisposeEnumTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByDefSchemaIdx( DefSchemaId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeEnumTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByPrevIdx( PrevId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public void deepDisposeEnumTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByNextIdx( NextId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByContPrevIdx( ScopeId,
				PrevId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
		...
		ICFLibKeyHash256 NextId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeByContNextIdx( ScopeId,
				NextId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
	...
	public void deepDisposeEnumTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		ICFBamEnumTypeObj obj;
		List<ICFBamEnumTypeObj> arrayList = readCachedEnumTypeBySchemaIdx( SchemaDefId );
		if( arrayList != null )  {
			Iterator<ICFBamEnumTypeObj> arrayIter = arrayList.iterator();
			while( arrayIter.hasNext() ) {
				obj = arrayIter.next();
	...
	public ICFBamEnumTypeObj updateEnumType( ICFBamEnumTypeObj Obj ) {
		ICFBamEnumTypeObj obj = Obj;
		schema.getCFBamBackingStore().getTableEnumType().updateEnumType( null,
			Obj.getEnumTypeRec() );
		if( Obj.getClassCode() == ((ICFBamSchemaObj)getSchema()).getEnumTypeTableObj().getClassCode() ) {
			obj = (ICFBamEnumTypeObj)Obj.realise();
		}
		obj.endEdit();
		return( obj );
	...
	public void deleteEnumType( ICFBamEnumTypeObj Obj ) {
		...
		schema.getCFBamBackingStore().getTableEnumType().deleteEnumType( null,
			obj.getEnumTypeRec() );
		Obj.forget();
		if( prev != null ) {
			prev.read( true );
		...
		String Name )
	{
		...
		if( indexByUNameIdx.containsKey( key ) ) {
			obj = indexByUNameIdx.get( key );
			schema.getCFBamBackingStore().getTableEnumType().deleteEnumTypeByUNameIdx( null,
				ScopeId,
				Name );
			obj.forget();
		}
		...
		deepDisposeEnumTypeByUNameIdx( ScopeId,
				Name );
	}
	...
	public void deleteEnumTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByScopeIdx.get( key );
		...
		deepDisposeEnumTypeByScopeIdx( ScopeId );
	}
	...
	public void deleteEnumTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByDefSchemaIdx.get( key );
		...
		deepDisposeEnumTypeByDefSchemaIdx( DefSchemaId );
	}
	...
	public void deleteEnumTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByPrevIdx.get( key );
		...
		deepDisposeEnumTypeByPrevIdx( PrevId );
	}
	...
	public void deleteEnumTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByNextIdx.get( key );
		...
		deepDisposeEnumTypeByNextIdx( NextId );
	}
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByContPrevIdx.get( key );
		...
		deepDisposeEnumTypeByContPrevIdx( ScopeId,
				PrevId );
	}
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexByContNextIdx.get( key );
		...
		deepDisposeEnumTypeByContNextIdx( ScopeId,
				NextId );
	}
	...
	public void deleteEnumTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamEnumTypeObj> dict = indexBySchemaIdx.get( key );
		...
		deepDisposeEnumTypeBySchemaIdx( SchemaDefId );
	}
	...
	public ICFBamEnumTypeObj moveUpEnumType( ICFBamEnumTypeObj Obj ) {
		ICFBamEnumTypeObj obj = null;
		if( null != Obj.getEdit() ) {
			throw new CFLibCannotMoveEditedObjectException( getClass(),	"moveUpEnumType" );
		}
		ICFBamEnumType rec = schema.getCFBamBackingStore().getTableEnumType().moveRecUp( null,
			Obj.getRequiredId(),
	...
	public ICFBamEnumTypeObj moveDownEnumType( ICFBamEnumTypeObj Obj ) {
		ICFBamEnumTypeObj obj = null;
		if( null != Obj.getEdit() ) {
			throw new CFLibCannotMoveEditedObjectException( getClass(),	"moveDownEnumType" );
		}
		ICFBamEnumType rec = schema.getCFBamBackingStore().getTableEnumType().moveRecDown( null,
			Obj.getRequiredId(),
			Obj.getRec().getRequiredRevision() );
		if( rec != null ) {
			obj = schema.getEnumTypeTableObj().newInstance();
