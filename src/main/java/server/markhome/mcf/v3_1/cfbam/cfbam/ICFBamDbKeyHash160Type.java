// Description: Java 25 interface for a DbKeyHash160Type record implementation
...
/**
 *	ICFBamDbKeyHash160Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDbKeyHash160Type extends ICFBamDbKeyHash160Def
{
