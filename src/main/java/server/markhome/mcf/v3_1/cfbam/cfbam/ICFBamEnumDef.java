// Description: Java 25 interface for a EnumDef record declementation
...
/**
 *	ICFBamEnumDef persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamEnumDef
