...
// Description: Java 25 Factory service implementation for EnumType buffers
...
/*
 *	Java 25 Factory service implementation for EnumType buffers.
 */
@Service("cfbam31BuffEnumTypeFactoryService")
public class CFBamBuffEnumTypeFactoryService
	implements ICFBamEnumTypeFactory
{
	public CFBamBuffEnumTypeFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamEnumType",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamEnumType");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamEnumType",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamEnumType");
			}
		}
	}
