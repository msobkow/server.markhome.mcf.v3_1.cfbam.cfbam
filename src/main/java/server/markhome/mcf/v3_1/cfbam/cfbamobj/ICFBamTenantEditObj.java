// Description: Java 25 Instance Edit Object interface for CFBam Tenant.
...
public interface ICFBamTenantEditObj
	extends ICFBamTenantObj, ICFSecTenantEditObj, ICFIntTenantEditObj
{
	/*
	...
	/**
	 *	Get a list ICFBamSchemaDefObj instances referenced by the Schema key.
	 *
	 *	@return	The (potentially empty) list of ICFBamSchemaDefObj instances referenced by the Schema key.
	 */
