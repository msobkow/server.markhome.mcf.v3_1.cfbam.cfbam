	...
	implements ICFBamInt16Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt16Type rhs ) {
		...
		else if( obj instanceof ICFBamInt16TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt16Type ) {
			setInt16Type( (CFBamProtBuffInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt16Type ) {
			setInt16Type( (CFBamPubBuffInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
