// Description: Java 25 edit object instance implementation for CFBam Int32Col.
	...
	implements ICFBamInt32ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt32ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt32Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt32Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsInt32Col().getSchema()).getTableTableObj().readTableByIdIdx( getInt32ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getInt32ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamInt32Col origRec = getOrigAsInt32Col().getInt32ColRec();
		ICFBamInt32Col myRec = getInt32ColRec();
		origRec.set( myRec );
	}
