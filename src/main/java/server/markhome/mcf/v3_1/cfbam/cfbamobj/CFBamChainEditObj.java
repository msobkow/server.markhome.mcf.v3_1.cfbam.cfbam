// Description: Java 25 edit object instance implementation for CFBam Chain.
	...
	implements ICFBamChainEditObj
{
	...
	public CFBamChainEditObj( ICFBamChainObj argOrig ) {
		orig = argOrig;
		getRec();
		ICFBamChain origRec = orig.getRec();
		rec.set( origRec );
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getChainTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsChain().getSchema()).getTableTableObj().readTableByIdIdx( getChainRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getChainRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	}
	...
	public ICFBamSchemaDefObj getOptionalLookupDefSchema( boolean forceRead ) {
		if( forceRead || ( optionalLookupDefSchema == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsChain().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getChainRec().getOptionalDefSchemaId() );
	...
	public void setOptionalLookupDefSchema( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getChainRec().setOptionalLookupDefSchema(value.getSchemaDefRec());
		}
		else {
			optionalLookupDefSchema = null;
			getChainRec().setOptionalLookupDefSchema((ICFBamSchemaDef)null);
		}
		optionalLookupDefSchema = value;
	}
	...
	public ICFBamRelationObj getRequiredLookupPrevRel( boolean forceRead ) {
		if( forceRead || ( requiredLookupPrevRel == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamRelationObj obj = ((ICFBamSchemaObj)getOrigAsChain().getSchema()).getRelationTableObj().readRelationByIdIdx( getChainRec().getRequiredPrevRelationId() );
	...
	public void setRequiredLookupPrevRel( ICFBamRelationObj value ) {
		...
		if( value != null ) {
			...
			getChainRec().setRequiredLookupPrevRel(value.getRelationRec());
		}
		else {
			requiredLookupPrevRel = null;
			getChainRec().setRequiredLookupPrevRel((ICFBamRelation)null);
		}
		requiredLookupPrevRel = value;
	}
	...
	public ICFBamRelationObj getRequiredLookupNextRel( boolean forceRead ) {
		if( forceRead || ( requiredLookupNextRel == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamRelationObj obj = ((ICFBamSchemaObj)getOrigAsChain().getSchema()).getRelationTableObj().readRelationByIdIdx( getChainRec().getRequiredNextRelationId() );
	...
	public void setRequiredLookupNextRel( ICFBamRelationObj value ) {
		...
		if( value != null ) {
			...
			getChainRec().setRequiredLookupNextRel(value.getRelationRec());
		}
		else {
			requiredLookupNextRel = null;
			getChainRec().setRequiredLookupNextRel((ICFBamRelation)null);
		}
		requiredLookupNextRel = value;
	}
	...
	public void copyRecToOrig() {
		ICFBamChain origRec = getOrigAsChain().getChainRec();
		ICFBamChain myRec = getChainRec();
		origRec.set( myRec );
	}
