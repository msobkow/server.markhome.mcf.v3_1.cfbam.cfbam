	...
	implements ICFBamDbKeyHash256ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> allDbKeyHash256Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash256ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash256ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > > indexByTableIdx;
	...
	public CFBamDbKeyHash256ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj>();
	...
	public ICFBamDbKeyHash256ColObj realiseDbKeyHash256Col( ICFBamDbKeyHash256ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamDbKeyHash256ColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDbKeyHash256Col( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj readCachedDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDbKeyHash256ColObj obj = null;
	...
	public void reallyDeepDisposeDbKeyHash256Col( ICFBamDbKeyHash256ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamDbKeyHash256ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj lockDbKeyHash256Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDbKeyHash256ColObj> readAllDbKeyHash256Col( boolean forceRead ) {
		...
		if( ( allDbKeyHash256Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDbKeyHash256ColObj>();
	...
	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256ColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readDbKeyHash256ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamDbKeyHash256ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
	...
	@Override
	public ICFBamDbKeyHash256ColObj readCachedDbKeyHash256ColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDbKeyHash256ColObj obj = null;
	...
	@Override
	public ICFBamDbKeyHash256ColObj readCachedDbKeyHash256ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamDbKeyHash256ColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash256ColObj> readCachedDbKeyHash256ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash256ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteDbKeyHash256ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDbKeyHash256ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteDbKeyHash256ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash256ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamDbKeyHash256ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash256Col().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash256ColObj> dict = indexByTableIdx.get( key );
