	...
	implements ICFBamDbKeyHash256ColTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> members;
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> allDbKeyHash256Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash256ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash256ColByTableIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > > indexByTableIdx;
	...
	public CFBamDbKeyHash256ColTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj>();
	...
	public ICFBamDbKeyHash256ColObj realiseDbKeyHash256Col( ICFBamDbKeyHash256ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256Col( ICFLibKeyHash256 pkey ) {
		return( readDbKeyHash256Col( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash256ColObj readDbKeyHash256Col( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj readCachedDbKeyHash256Col( ICFLibKeyHash256 pkey ) {
		ICFBamDbKeyHash256ColObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash256Col( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamDbKeyHash256ColObj lockDbKeyHash256Col( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamDbKeyHash256ColObj> readAllDbKeyHash256Col( boolean forceRead ) {
		...
		if( ( allDbKeyHash256Col == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> map = new HashMap<ICFLibKeyHash256,ICFBamDbKeyHash256ColObj>();
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamDbKeyHash256ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj>();
			ICFBamValueObj obj;
	...
	public void deleteDbKeyHash256ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteDbKeyHash256ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteDbKeyHash256ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteDbKeyHash256ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteDbKeyHash256ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256ColObj> dict = indexByTableIdx.get( key );
