	...
	implements ICFBamUuid6Gen
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6Gen rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6GenH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuid6Gen ) {
			setUuid6Gen( (CFBamProtBuffUuid6Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Gen ) {
			setUuid6Gen( (CFBamPubBuffUuid6Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
