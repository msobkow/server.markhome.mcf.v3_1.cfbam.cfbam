...
public interface ICFBamTZDateTypeTableObj
{
	 ...
	 */
	ICFBamTZDateTypeObj readTZDateType( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTZDateTypeObj readCachedTZDateType( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTZDateType( ICFBamTZDateTypeObj obj );

	void deepDisposeTZDateType( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTZDateTypeObj lockTZDateType( $implCommaIJavaOptAtomType$ pkey );
