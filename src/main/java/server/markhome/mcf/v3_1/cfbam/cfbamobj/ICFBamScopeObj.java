// Description: Java 25 Object interface for CFBam Scope.
...
{
	/**
	 *	Initially, the class code for an object is ICFBamScope.CLASS_CODE, but the Obj layer relies on class code translation to map those
	...
	/**
	 *	Get the ICFBamScope instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamScope instance which currently backs this object.
	 */
	ICFBamScope getRec();
