	...
	implements ICFBamScopeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj> allScope;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj > > indexByTenantIdx;
	public static String TABLE_NAME = "Scope";
	public static String TABLE_DBNAME = "scopedef";

	public CFBamScopeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamScopeObj>();
		allScope = null;
	...
	public ICFBamScopeObj realiseScope( ICFBamScopeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
	...
	@Override
	public ICFBamScopeObj readScope( $implCommaIJavaOptAtomType$ pkey ) {
		return( readScope( pkey, false ) );
	}

	@Override
	public ICFBamScopeObj readScope( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
		ICFBamScopeObj obj = null;
	...
	@Override
	public ICFBamScopeObj readCachedScope( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamScopeObj obj = null;
	...
	public void reallyDeepDisposeScope( ICFBamScopeObj obj )
	{
		...
		members.remove( pkey );
		ICFBamScopeByTenantIdxKey keyTenantIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryScope().newByTenantIdxKey();
	...
	@Override
	public void deepDisposeScope( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamScopeObj lockScope( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamScopeObj> readAllScope( boolean forceRead ) {
		...
		if( ( allScope == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamScopeObj>();
			allScope = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamScopeObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamScopeObj>();
			ICFBamScopeObj obj;
	...
	public void deleteScopeByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamScopeObj> dict = indexByTenantIdx.get( key );
