	...
	implements ICFBamInt64ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> allInt64Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamInt64ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByContNextIdx;
	private Map< ICFBamInt64ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "Int64Col";
	public static String TABLE_DBNAME = "int64col";

	public CFBamInt64ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj>();
		allInt64Col = null;
	...
	public ICFBamInt64ColObj realiseInt64Col( ICFBamInt64ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamInt64ColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt64Col().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamInt64ColObj readInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readInt64Col( pkey, false ) );
	}

	@Override
	public ICFBamInt64ColObj readInt64Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamInt64ColObj readCachedInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamInt64ColObj obj = null;
	...
	public void reallyDeepDisposeInt64Col( ICFBamInt64ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamInt64ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt64Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamInt64ColObj lockInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamInt64ColObj> readAllInt64Col( boolean forceRead ) {
		...
		if( ( allInt64Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamInt64ColObj>();
			allInt64Col = map;
	...
	@Override
	public ICFBamInt64ColObj readInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamInt64ColObj readInt64ColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamInt64ColObj readInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamInt64ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt64ColObj> readInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamInt64ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt64Col().newByTableIdxKey();
	...
	@Override
	public ICFBamInt64ColObj readCachedInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamInt64ColObj obj = null;
	...
	@Override
	public ICFBamInt64ColObj readCachedInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamInt64ColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt64ColObj> readCachedInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamInt64ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt64Col().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt64ColObj> dict = indexByTableIdx.get( key );
