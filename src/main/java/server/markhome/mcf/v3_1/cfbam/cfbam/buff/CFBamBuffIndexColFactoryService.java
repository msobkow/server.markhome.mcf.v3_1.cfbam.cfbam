...
// Description: Java 25 Factory service implementation for IndexCol buffers
...
/*
 *	Java 25 Factory service implementation for IndexCol buffers.
 */
@Service("cfbam31BuffIndexColFactoryService")
public class CFBamBuffIndexColFactoryService
	implements ICFBamIndexColFactory
{
	public CFBamBuffIndexColFactoryService() {
	}
	...
	public CFBamBuffIndexCol ensureRec(ICFBamIndexCol rec) {
		if( rec == null ) {
			...
			switch (rec.getClassCode()) {
				case ICFBamIndexCol.CLASS_CODE: {
					CFBamBuffIndexCol mapped = new CFBamBuffIndexCol();
					mapped.set(rec);
					return(mapped); }
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamIndexCol",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamIndexCol");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamIndexCol",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamIndexCol");
			}
		}
	}
