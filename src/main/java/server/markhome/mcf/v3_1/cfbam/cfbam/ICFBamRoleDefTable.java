...
// Description: Java 25 DbIO interface for RoleDef.
...
/*
 *	CFBamRoleDefTable database interface for RoleDef has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamRoleDefTable
{
	 ...
	 */
	ICFBamRoleDef createRoleDef( ICFSecAuthorization Authorization,
		ICFBamRoleDef rec );
	 ...
	 */
	ICFBamRoleDef updateRoleDef( ICFSecAuthorization Authorization,
		ICFBamRoleDef rec );
	 ...
	 */
	void deleteRoleDef( ICFSecAuthorization Authorization,
		ICFBamRoleDef rec );
	/**
	 ...
	 */
	ICFBamRoleDef[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamRoleDef[] readAllRec( ICFSecAuthorization Authorization );
