// Description: Java 25 interface for a ClearSubDep1 record implementation
...
/**
 *	ICFBamClearSubDep1 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamClearSubDep1 extends ICFBamClearDep
{
	...
	public default void setRequiredContainerClearTopDep(ICFBamProtClearTopDep argObj) {
		if (argObj == null) {
			setRequiredContainerClearTopDep((CFLibDbKeyHash256)null);
		}
		else {
