	...
	implements ICFBamClearDep
{
	...
	public void setRequiredLookupRelation(CFLibDbKeyHash256 argRelationId) {
		...
		if (targetTable == null) {
			throw new CFLibNullArgumentException(getClass(), "setRequiredLookupRelation", 0, "ICFBamPubSchema.getBackingCFBam().getTableRelation()");
		}
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamClearDep rhs ) {
		...
		else if( obj instanceof ICFBamClearDepH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtScope src ) {
		if( src instanceof CFBamProtBuffClearDep ) {
			setClearDep( (CFBamProtBuffClearDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubScope src ) {
		if( src instanceof CFBamPubBuffClearDep ) {
			setClearDep( (CFBamPubBuffClearDep)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
