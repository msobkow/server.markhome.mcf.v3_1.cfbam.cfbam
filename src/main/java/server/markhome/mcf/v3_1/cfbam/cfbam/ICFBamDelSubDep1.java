// Description: Java 25 interface for a DelSubDep1 record implementation
...
/**
 *	ICFBamDelSubDep1 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDelSubDep1 extends ICFBamDelDep
{
	...
	public default void setRequiredContainerDelTopDep(ICFBamProtDelTopDep argObj) {
		if (argObj == null) {
			setRequiredContainerDelTopDep((CFLibDbKeyHash256)null);
		}
		else {
