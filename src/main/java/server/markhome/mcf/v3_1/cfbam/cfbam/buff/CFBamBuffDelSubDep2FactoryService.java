...
// Description: Java 25 Factory service implementation for DelSubDep2 buffers
...
/*
 *	Java 25 Factory service implementation for DelSubDep2 buffers.
 */
@Service("cfbam31BuffDelSubDep2FactoryService")
public class CFBamBuffDelSubDep2FactoryService
	implements ICFBamDelSubDep2Factory
{
	public CFBamBuffDelSubDep2FactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDelSubDep2",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDelSubDep2");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDelSubDep2",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDelSubDep2");
			}
		}
	}
