// Description: Java 25 interface for a Table history object
...
/**
 *	ICFBamTableH provides access to history records matching the CFBamTable object change history.
 */
public interface ICFBamTableH extends ICFBamScopeH
{
