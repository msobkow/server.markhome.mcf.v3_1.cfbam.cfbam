	...
	implements ICFBamTokenCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTokenCol rhs ) {
		...
		else if( obj instanceof ICFBamTokenColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTokenCol ) {
			setTokenCol( (CFBamProtBuffTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenCol ) {
			setTokenCol( (CFBamPubBuffTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
