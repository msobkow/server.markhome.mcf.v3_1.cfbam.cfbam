// Description: Java 25 edit object instance implementation for CFBam DbKeyHash224Def.
	...
	implements ICFBamDbKeyHash224DefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash224DefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash224Def().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash224Def().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setOptionalInitValue( String value ) {
		if( getDbKeyHash224DefRec().getOptionalInitValue() != value ) {
			getDbKeyHash224DefRec().setOptionalInitValue( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamDbKeyHash224Def origRec = getOrigAsDbKeyHash224Def().getDbKeyHash224DefRec();
		ICFBamDbKeyHash224Def myRec = getDbKeyHash224DefRec();
		origRec.set( myRec );
	}
