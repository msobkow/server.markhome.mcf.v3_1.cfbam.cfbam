// Description: Java 25 Object interface for CFBam NmTokensDef.
	...
	extends ICFBamAtomObj
{
	...
	/**
	 *	Get the ICFBamNmTokensDef instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamNmTokensDef instance which currently backs this object.
	 */
	ICFBamNmTokensDef getNmTokensDefRec();
