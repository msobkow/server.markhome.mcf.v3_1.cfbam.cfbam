...
public interface ICFBamTimestampTypeTableObj
{
	 ...
	 */
	ICFBamTimestampTypeObj readTimestampType( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTimestampTypeObj readCachedTimestampType( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTimestampType( ICFBamTimestampTypeObj obj );

	void deepDisposeTimestampType( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTimestampTypeObj lockTimestampType( $implCommaIJavaOptAtomType$ pkey );
