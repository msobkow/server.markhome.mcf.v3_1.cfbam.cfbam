...
public interface ICFBamDelDepTableObj
{
	 ...
	 */
	ICFBamDelDepObj readDelDep( ICFLibKeyHash256 pkey );
	...
	ICFBamDelDepObj readCachedDelDep( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamDelDepObj lockDelDep( ICFLibKeyHash256 pkey );
