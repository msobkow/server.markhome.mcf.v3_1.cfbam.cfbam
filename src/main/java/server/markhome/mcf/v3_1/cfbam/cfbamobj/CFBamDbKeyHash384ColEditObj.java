// Description: Java 25 edit object instance implementation for CFBam DbKeyHash384Col.
	...
	implements ICFBamDbKeyHash384ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash384ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash384Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash384Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsDbKeyHash384Col().getSchema()).getTableTableObj().readTableByIdIdx( getDbKeyHash384ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		if( rec == null ) {
			getDbKeyHash384ColRec();
		}
		if( value != null ) {
			requiredContainerTable = value;
			getDbKeyHash384ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamDbKeyHash384Col origRec = getOrigAsDbKeyHash384Col().getDbKeyHash384ColRec();
		ICFBamDbKeyHash384Col myRec = getDbKeyHash384ColRec();
		origRec.set( myRec );
	}
