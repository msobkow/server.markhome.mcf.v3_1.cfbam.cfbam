// Description: Java 25 edit object instance implementation for CFBam SecUserPWReset.
...
public class CFBamSecUserPWResetEditObj
	implements ICFBamSecUserPWResetEditObj
{
	...
	public CFBamSecUserPWResetEditObj( ICFSecSecUserPWResetObj argOrig ) {
		orig = argOrig;
		getRec();
	...
	public ICFSecSecUserPWResetObj realise() {
		...
		ICFSecSecUserPWResetObj retobj = getSchema().getSecUserPWResetTableObj().realiseSecUserPWReset( (ICFBamSecUserPWResetObj)this );
		return( retobj );
	}
	...
	public ICFSecSecUserPWResetObj create() {
		copyRecToOrig();
		ICFSecSecUserPWResetObj retobj = ((ICFBamSchemaObj)getOrigAsSecUserPWReset().getSchema()).getSecUserPWResetTableObj().createSecUserPWReset( getOrigAsSecUserPWReset() );
	...
	public ICFSecSecUserObj getRequiredContainerUser( boolean forceRead ) {
		if( forceRead || ( requiredContainerUser == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecSecUserObj obj = ((ICFBamSchemaObj)getOrigAsSecUserPWReset().getSchema()).getSecUserTableObj().readSecUserByIdIdx( getPKey() );
