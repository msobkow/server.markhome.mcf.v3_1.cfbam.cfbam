	...
	implements ICFBamInt32TypeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> allInt32Type;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamInt32TypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexByContNextIdx;
	private Map< ICFBamInt32TypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "Int32Type";
	public static String TABLE_DBNAME = "int32typ";

	public CFBamInt32TypeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj>();
		allInt32Type = null;
	...
	public ICFBamInt32TypeObj realiseInt32Type( ICFBamInt32TypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				ICFBamInt32TypeBySchemaIdxKey keySchemaIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Type().newBySchemaIdxKey();
				keySchemaIdx.setRequiredSchemaDefId( keepObj.getRequiredSchemaDefId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamInt32TypeObj readInt32Type( $implCommaIJavaOptAtomType$ pkey ) {
		return( readInt32Type( pkey, false ) );
	}

	@Override
	public ICFBamInt32TypeObj readInt32Type( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamInt32TypeObj readCachedInt32Type( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamInt32TypeObj obj = null;
	...
	public void reallyDeepDisposeInt32Type( ICFBamInt32TypeObj obj )
	{
		...
		members.remove( pkey );
		ICFBamInt32TypeBySchemaIdxKey keySchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Type().newBySchemaIdxKey();
	...
	@Override
	public void deepDisposeInt32Type( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamInt32TypeObj lockInt32Type( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamInt32TypeObj> readAllInt32Type( boolean forceRead ) {
		...
		if( ( allInt32Type == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamInt32TypeObj>();
			allInt32Type = map;
	...
	@Override
	public ICFBamInt32TypeObj readInt32TypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamInt32TypeObj readInt32TypeByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamInt32TypeObj readInt32TypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamInt32TypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt32TypeObj> readInt32TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamInt32TypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Type().newBySchemaIdxKey();
	...
	@Override
	public ICFBamInt32TypeObj readCachedInt32TypeByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamInt32TypeObj obj = null;
	...
	@Override
	public ICFBamInt32TypeObj readCachedInt32TypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamInt32TypeObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32TypeObj> readCachedInt32TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeInt32TypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeInt32TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32TypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deleteInt32TypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteInt32TypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteInt32TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteInt32TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteInt32TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteInt32TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteInt32TypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteInt32TypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteInt32TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		ICFBamInt32TypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt32Type().newBySchemaIdxKey();
		key.setRequiredSchemaDefId( SchemaDefId );
		if( indexBySchemaIdx == null ) {
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32TypeObj> dict = indexBySchemaIdx.get( key );
