...
public interface ICFBamTextDefTableObj
{
	 ...
	 */
	ICFBamTextDefObj readTextDef( ICFLibKeyHash256 pkey );
	...
	ICFBamTextDefObj readCachedTextDef( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamTextDefObj lockTextDef( ICFLibKeyHash256 pkey );
