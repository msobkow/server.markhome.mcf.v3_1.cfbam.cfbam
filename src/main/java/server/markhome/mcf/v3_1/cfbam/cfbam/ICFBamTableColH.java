// Description: Java 25 interface for a TableCol history object
...
/**
 *	ICFBamTableColH provides access to history records matching the CFBamTableCol object change history.
 */
public interface ICFBamTableColH extends ICFBamValueH
{
