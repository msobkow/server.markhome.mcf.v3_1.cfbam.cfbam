// Description: Java 25 interface for a NumberDef history object
...
/**
 *	ICFBamNumberDefH provides access to history records matching the CFBamNumberDef object change history.
 */
public interface ICFBamNumberDefH extends ICFBamAtomH
{
