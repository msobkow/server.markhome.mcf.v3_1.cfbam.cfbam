// Description: Java 25 edit object instance implementation for CFBam DateType.
	...
	implements ICFBamDateTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDateTypeTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsDateType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getDateTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getDateTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamDateType origRec = getOrigAsDateType().getDateTypeRec();
		ICFBamDateType myRec = getDateTypeRec();
		origRec.set( myRec );
	}
