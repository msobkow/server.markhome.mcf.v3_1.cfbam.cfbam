// Description: Java 25 edit object instance implementation for CFBam UInt16Col.
	...
	implements ICFBamUInt16ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt16ColTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsUInt16Col().getSchema()).getTableTableObj().readTableByIdIdx( getUInt16ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getUInt16ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt16Col origRec = getOrigAsUInt16Col().getUInt16ColRec();
		ICFBamUInt16Col myRec = getUInt16ColRec();
		origRec.set( myRec );
	}
