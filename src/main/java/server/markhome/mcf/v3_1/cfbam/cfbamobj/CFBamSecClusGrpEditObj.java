// Description: Java 25 edit object instance implementation for CFBam SecClusGrp.
...
public class CFBamSecClusGrpEditObj
	implements ICFBamSecClusGrpEditObj
{
	...
	public ICFSecSecClusGrpObj realise() {
		...
		ICFSecSecClusGrpObj retobj = getSchema().getSecClusGrpTableObj().realiseSecClusGrp( (ICFBamSecClusGrpObj)this );
		return( retobj );
	}
	...
	public ICFSecSecClusGrpObj create() {
		copyRecToOrig();
		ICFSecSecClusGrpObj retobj = ((ICFBamSchemaObj)getOrigAsSecClusGrp().getSchema()).getSecClusGrpTableObj().createSecClusGrp( getOrigAsSecClusGrp() );
	...
	public ICFSecClusterObj getRequiredOwnerCluster( boolean forceRead ) {
		if( forceRead || ( requiredOwnerCluster == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecClusterObj obj = ((ICFBamSchemaObj)getOrigAsSecClusGrp().getSchema()).getClusterTableObj().readClusterByIdIdx( getSecClusGrpRec().getRequiredClusterId() );
