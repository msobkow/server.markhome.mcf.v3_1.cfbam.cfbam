// Description: Java 25 edit object instance implementation for CFBam DbKeyHash512Gen.
	...
	implements ICFBamDbKeyHash512GenEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash512GenTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash512Gen().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash512Gen().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setRequiredSlice( short value ) {
		if( getDbKeyHash512GenRec().getRequiredSlice() != value ) {
			getDbKeyHash512GenRec().setRequiredSlice( value );
		}
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( getDbKeyHash512GenRec().getRequiredBlockSize() != value ) {
			getDbKeyHash512GenRec().setRequiredBlockSize( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamDbKeyHash512Gen origRec = getOrigAsDbKeyHash512Gen().getDbKeyHash512GenRec();
		ICFBamDbKeyHash512Gen myRec = getDbKeyHash512GenRec();
		origRec.set( myRec );
	}
