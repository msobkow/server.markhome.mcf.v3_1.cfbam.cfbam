// Description: Java 25 Instance Edit Object interface for CFBam MinorVersion.
...
public interface ICFBamMinorVersionEditObj
	extends ICFBamMinorVersionObj, ICFIntMinorVersionEditObj
{
	/*
	...
	/**
	 *	Get a list ICFBamSchemaDefObj instances referenced by the SchemaDef key.
	 *
	 *	@return	The (potentially empty) list of ICFBamSchemaDefObj instances referenced by the SchemaDef key.
	 */
