	...
	implements ICFBamNmTokensDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> allNmTokensDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamNmTokensDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "NmTokensDef";
	public static String TABLE_DBNAME = "nmtknsdef";

	public CFBamNmTokensDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj>();
		allNmTokensDef = null;
	...
	public ICFBamNmTokensDefObj realiseNmTokensDef( ICFBamNmTokensDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamNmTokensDefObj readNmTokensDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readNmTokensDef( pkey, false ) );
	}

	@Override
	public ICFBamNmTokensDefObj readNmTokensDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamNmTokensDefObj readCachedNmTokensDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamNmTokensDefObj obj = null;
	...
	@Override
	public void deepDisposeNmTokensDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamNmTokensDefObj lockNmTokensDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamNmTokensDefObj> readAllNmTokensDef( boolean forceRead ) {
		...
		if( ( allNmTokensDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamNmTokensDefObj>();
			allNmTokensDef = map;
	...
	@Override
	public ICFBamNmTokensDefObj readNmTokensDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamNmTokensDefObj readNmTokensDefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamNmTokensDefObj readNmTokensDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokensDefObj> readNmTokensDefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamNmTokensDefObj readCachedNmTokensDefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamNmTokensDefObj obj = null;
	...
	@Override
	public ICFBamNmTokensDefObj readCachedNmTokensDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamNmTokensDefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensDefObj> readCachedNmTokensDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokensDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteNmTokensDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteNmTokensDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteNmTokensDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteNmTokensDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteNmTokensDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokensDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteNmTokensDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokensDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensDefObj> dict = indexByContNextIdx.get( key );
