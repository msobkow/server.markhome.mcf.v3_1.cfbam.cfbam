// Description: Java 25 interface for a TableCol record implementation
...
/**
 *	ICFBamTableCol persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamTableCol extends ICFBamValue
{
