	...
	implements ICFBamTZTimeType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimeType rhs ) {
		...
		else if( obj instanceof ICFBamTZTimeTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZTimeType ) {
			setTZTimeType( (CFBamProtBuffTZTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimeType ) {
			setTZTimeType( (CFBamPubBuffTZTimeType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
