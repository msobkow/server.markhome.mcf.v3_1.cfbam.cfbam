	...
	implements ICFBamDbKeyHash160GenTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> allDbKeyHash160Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash160GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash160TypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > > indexBySchemaIdx;
	...
	public CFBamDbKeyHash160GenTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj>();
	...
	public ICFBamDbKeyHash160GenObj realiseDbKeyHash160Gen( ICFBamDbKeyHash160GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160Gen( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDbKeyHash160Gen( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160Gen( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash160GenObj readCachedDbKeyHash160Gen( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDbKeyHash160GenObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash160Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDbKeyHash160GenObj lockDbKeyHash160Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDbKeyHash160GenObj> readAllDbKeyHash160Gen( boolean forceRead ) {
		...
		if( ( allDbKeyHash160Gen == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDbKeyHash160GenObj>();
	...
	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160GenByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readDbKeyHash160GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public ICFBamDbKeyHash160GenObj readCachedDbKeyHash160GenByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDbKeyHash160GenObj obj = null;
	...
	@Override
	public ICFBamDbKeyHash160GenObj readCachedDbKeyHash160GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamDbKeyHash160GenObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash160GenObj> readCachedDbKeyHash160GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash160GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deleteDbKeyHash160GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDbKeyHash160GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteDbKeyHash160GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash160GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		ICFBamDbKeyHash160TypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash160Type().newBySchemaIdxKey();
		key.setRequiredSchemaDefId( SchemaDefId );
		if( indexBySchemaIdx == null ) {
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash160GenObj> dict = indexBySchemaIdx.get( key );
