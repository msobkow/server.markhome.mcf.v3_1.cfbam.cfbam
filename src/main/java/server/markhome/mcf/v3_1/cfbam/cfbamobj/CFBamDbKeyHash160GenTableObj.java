	...
	implements ICFBamDbKeyHash160GenTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> members;
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> allDbKeyHash160Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash160GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash160TypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > > indexBySchemaIdx;
	...
	public CFBamDbKeyHash160GenTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj>();
	...
	public ICFBamDbKeyHash160GenObj realiseDbKeyHash160Gen( ICFBamDbKeyHash160GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160Gen( ICFLibKeyHash256 pkey ) {
		return( readDbKeyHash160Gen( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash160GenObj readDbKeyHash160Gen( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash160GenObj readCachedDbKeyHash160Gen( ICFLibKeyHash256 pkey ) {
		ICFBamDbKeyHash160GenObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash160Gen( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamDbKeyHash160GenObj lockDbKeyHash160Gen( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamDbKeyHash160GenObj> readAllDbKeyHash160Gen( boolean forceRead ) {
		...
		if( ( allDbKeyHash160Gen == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> map = new HashMap<ICFLibKeyHash256,ICFBamDbKeyHash160GenObj>();
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamDbKeyHash160GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj>();
			ICFBamValueObj obj;
	...
	public void deleteDbKeyHash160GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteDbKeyHash160GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteDbKeyHash160GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteDbKeyHash160GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteDbKeyHash160GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash160GenObj> dict = indexBySchemaIdx.get( key );
