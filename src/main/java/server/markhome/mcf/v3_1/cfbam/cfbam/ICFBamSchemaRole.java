// Description: Java 25 interface for a SchemaRole record declementation
...
/**
 *	ICFBamSchemaRole persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamSchemaRole
	extends ICFBamRoleDef
{
