	...
	implements ICFBamFloatType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamFloatType rhs ) {
		...
		else if( obj instanceof ICFBamFloatTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffFloatType ) {
			setFloatType( (CFBamProtBuffFloatType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffFloatType ) {
			setFloatType( (CFBamPubBuffFloatType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
