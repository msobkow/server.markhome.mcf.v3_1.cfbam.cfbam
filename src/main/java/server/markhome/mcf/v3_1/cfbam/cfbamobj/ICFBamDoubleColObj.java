// Description: Java 25 Object interface for CFBam DoubleCol.
	...
	extends ICFBamDoubleDefObj
{
	...
	/**
	 *	Get the ICFBamDoubleCol instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamDoubleCol instance which currently backs this object.
	 */
	ICFBamDoubleCol getDoubleColRec();
