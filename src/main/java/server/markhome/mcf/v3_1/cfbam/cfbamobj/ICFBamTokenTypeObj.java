// Description: Java 25 Object interface for CFBam TokenType.
	...
	extends ICFBamTokenDefObj
{
	...
	/**
	 *	Get the ICFBamTokenType instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamTokenType instance which currently backs this object.
	 */
	ICFBamTokenType getTokenTypeRec();
