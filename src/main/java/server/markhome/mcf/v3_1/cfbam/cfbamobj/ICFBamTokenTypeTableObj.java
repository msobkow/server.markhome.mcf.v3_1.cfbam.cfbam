...
public interface ICFBamTokenTypeTableObj
{
	 ...
	 */
	ICFBamTokenTypeObj readTokenType( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTokenTypeObj readCachedTokenType( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTokenType( ICFBamTokenTypeObj obj );

	void deepDisposeTokenType( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTokenTypeObj lockTokenType( $implCommaIJavaOptAtomType$ pkey );
