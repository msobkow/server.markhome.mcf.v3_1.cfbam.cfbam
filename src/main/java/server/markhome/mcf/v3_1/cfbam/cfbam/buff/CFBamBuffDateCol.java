	...
	implements ICFBamDateCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDateCol rhs ) {
		...
		else if( obj instanceof ICFBamDateColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDateCol ) {
			setDateCol( (CFBamProtBuffDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDateCol ) {
			setDateCol( (CFBamPubBuffDateCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
