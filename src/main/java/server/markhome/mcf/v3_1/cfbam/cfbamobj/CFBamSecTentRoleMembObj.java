...
public class CFBamSecTentRoleMembObj
	implements ICFBamSecTentRoleMembObj
{
	...
	public CFBamSecTentRoleMembObj() {
		isNew = true;
		requiredContainerRole = null;
		requiredParentUser = null;
	}

	public CFBamSecTentRoleMembObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
		requiredContainerRole = null;
	...
	public ICFSecSecTentRoleMembObj realise() {
		ICFSecSecTentRoleMembObj retobj = ((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj().realiseSecTentRoleMemb(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj().reallyDeepDisposeSecTentRoleMemb( (ICFSecSecTentRoleMembObj)this );
	}

	@Override
	public ICFSecSecTentRoleMembObj read() {
		ICFSecSecTentRoleMembObj retobj = ((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj().readSecTentRoleMembByIdIdx( getPKey().getRequiredSecTentRoleId(),
	...
	public ICFSecSecTentRoleMembTableObj getSecTentRoleMembTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj() );
	}
	...
	public ICFSecSecTentRoleMemb getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecTentRoleMemb().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
	...
	public ICFSecSecTentRoleMembEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj().lockSecTentRoleMemb( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecTentRoleMembTableObj().newEditInstance( lockobj );
	...
	public ICFSecSecTentRoleObj getRequiredContainerRole( boolean forceRead ) {
		if( ( requiredContainerRole == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerRole = ((ICFBamSchemaObj)getSchema()).getSecTentRoleTableObj().readSecTentRoleByIdIdx( getPKey().getRequiredSecTentRoleId(), forceRead );
			}
		}
