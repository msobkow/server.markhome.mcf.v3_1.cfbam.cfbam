	...
	implements ICFBamServiceTypeObj
{
	...
	public ICFSecServiceTypeObj realise() {
		ICFSecServiceTypeObj retobj = ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().realiseServiceType(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().reallyDeepDisposeServiceType( (ICFSecServiceTypeObj)this );
	}

	@Override
	public ICFSecServiceTypeObj read() {
		ICFSecServiceTypeObj retobj = ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().readServiceTypeByIdIdx( getPKey(), false );
		return( (ICFSecServiceTypeObj)retobj );
	}

	@Override
	public ICFSecServiceTypeObj read( boolean forceRead ) {
		ICFSecServiceTypeObj retobj = ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().readServiceTypeByIdIdx( getPKey(), forceRead );
		return( (ICFSecServiceTypeObj)retobj );
	}

	@Override
	public ICFSecServiceTypeTableObj getServiceTypeTable() {
		return( ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj() );
	}
	...
	public ICFSecServiceType getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableServiceType().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public ICFSecServiceTypeEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().lockServiceType( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getServiceTypeTableObj().newEditInstance( lockobj );
	...
	public List<ICFSecServiceObj> getOptionalChildrenDeployed() {
		...
		retval = ((ICFBamSchemaObj)getSchema()).getServiceTableObj().readServiceByTypeIdx( getPKey(),
			false );
		return( retval );
	}
