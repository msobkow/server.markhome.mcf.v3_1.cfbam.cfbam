...
// Description: Java 25 Factory service implementation for Int32Type buffers
...
/*
 *	Java 25 Factory service implementation for Int32Type buffers.
 */
@Service("cfbam31BuffInt32TypeFactoryService")
public class CFBamBuffInt32TypeFactoryService
	implements ICFBamInt32TypeFactory
{
	public CFBamBuffInt32TypeFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamInt32Type",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamInt32Type");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamInt32Type",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamInt32Type");
			}
		}
	}
