// Description: Java 25 interface for a Tweak history object
...
/**
 *	ICFBamTweakH provides access to history records matching the CFBamTweak object change history.
 */
public interface ICFBamTweakH
{
