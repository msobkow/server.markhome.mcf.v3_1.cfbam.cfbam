...
public interface ICFBamIndexCol
{
	...
	public static final String S_INDEXID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	...
	public static final String S_COLUMNID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
