...
// Description: Java 25 Factory service implementation for ClearDep buffers
...
/*
 *	Java 25 Factory service implementation for ClearDep buffers.
 */
@Service("cfbam31BuffClearDepFactoryService")
public class CFBamBuffClearDepFactoryService
	implements ICFBamClearDepFactory
{
	public CFBamBuffClearDepFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearDep",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearDep");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearDep",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearDep");
			}
		}
	}
