...
public class CFBamSecClusGrpMembObj
	implements ICFBamSecClusGrpMembObj
{
	...
	public ICFSecSecClusGrpMembObj realise() {
		ICFSecSecClusGrpMembObj retobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj().realiseSecClusGrpMemb(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj().reallyDeepDisposeSecClusGrpMemb( (ICFSecSecClusGrpMembObj)this );
	}

	@Override
	public ICFSecSecClusGrpMembObj read() {
		ICFSecSecClusGrpMembObj retobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj().readSecClusGrpMembByIdIdx( getPKey().getRequiredSecClusGrpId(),
	...
	public ICFSecSecClusGrpMembTableObj getSecClusGrpMembTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj() );
	}
	...
	public ICFSecSecClusGrpMemb getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecClusGrpMemb().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
	...
	public ICFSecSecClusGrpMembEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj().lockSecClusGrpMemb( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecClusGrpMembTableObj().newEditInstance( lockobj );
