	...
	implements ICFBamTimestampDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimestampDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTimestampDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimestampDef ) {
			setTimestampDef( (CFBamProtBuffTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampDef ) {
			setTimestampDef( (CFBamPubBuffTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
