	...
	implements ICFBamDelDepTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> allDelDep;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > > indexByTenantIdx;
	private Map< ICFBamDelDepByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > > indexByDefSchemaIdx;
	private Map< ICFBamDelDepByDelDepIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > > indexByDelDepIdx;
	public static String TABLE_NAME = "DelDep";
	public static String TABLE_DBNAME = "del_dep";

	public CFBamDelDepTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDelDepObj>();
		allDelDep = null;
	...
	public ICFBamDelDepObj realiseDelDep( ICFBamDelDepObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByDelDepIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj > mapDelDepIdx = indexByDelDepIdx.get( keyDelDepIdx );
	...
	@Override
	public ICFBamDelDepObj readDelDep( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDelDep( pkey, false ) );
	}

	@Override
	public ICFBamDelDepObj readDelDep( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDelDepObj readCachedDelDep( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDelDepObj obj = null;
	...
	public void reallyDeepDisposeDelDep( ICFBamDelDepObj obj )
	{
		...
		members.remove( pkey );
		ICFBamDelDepByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDelDep().newByDefSchemaIdxKey();
		keyDefSchemaIdx.setOptionalDefSchemaId( existing.getOptionalDefSchemaId() );

		ICFBamDelDepByDelDepIdxKey keyDelDepIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDelDep().newByDelDepIdxKey();
	...
	@Override
	public void deepDisposeDelDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDelDepObj lockDelDep( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDelDepObj> readAllDelDep( boolean forceRead ) {
		...
		if( ( allDelDep == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDelDepObj>();
			allDelDep = map;
	...
	@Override
	public ICFBamDelDepObj readDelDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDelDepObj readDelDepByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public List<ICFBamDelDepObj> readDelDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDelDepObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDelDepObj>();
			ICFBamScopeObj obj;
	...
	@Override
	public List<ICFBamDelDepObj> readDelDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDelDepObj> readDelDepByDelDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public ICFBamDelDepObj readCachedDelDepByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDelDepObj obj = null;
	...
	@Override
	public List<ICFBamDelDepObj> readCachedDelDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public List<ICFBamDelDepObj> readCachedDelDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDelDepObj> readCachedDelDepByDelDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public void deepDisposeDelDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDelDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
	...
	@Override
	public void deepDisposeDelDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDelDepByDelDepIdx( ICFLibKeyHash256 RelationId )
	{
	...
	@Override
	public void deleteDelDepByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDelDepByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		ICFBamScopeByTenantIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryScope().newByTenantIdxKey();
		key.setRequiredTenantId( TenantId );
		if( indexByTenantIdx == null ) {
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> dict = indexByTenantIdx.get( key );
	...
	@Override
	public void deleteDelDepByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamDelDepByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDelDep().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDelDepByDelDepIdx( ICFLibKeyHash256 RelationId )
	{
		ICFBamDelDepByDelDepIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDelDep().newByDelDepIdxKey();
		key.setRequiredRelationId( RelationId );
		if( indexByDelDepIdx == null ) {
		...
		if( indexByDelDepIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDelDepObj> dict = indexByDelDepIdx.get( key );
