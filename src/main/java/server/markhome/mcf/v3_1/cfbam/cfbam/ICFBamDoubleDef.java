// Description: Java 25 interface for a DoubleDef record implementation
...
/**
 *	ICFBamDoubleDef persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDoubleDef extends ICFBamAtom
{
