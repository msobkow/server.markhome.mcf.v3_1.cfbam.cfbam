...
public interface ICFBamFloatColTableObj
{
	 ...
	 */
	ICFBamFloatColObj readFloatCol( ICFLibKeyHash256 pkey );
	...
	ICFBamFloatColObj readCachedFloatCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamFloatColObj lockFloatCol( ICFLibKeyHash256 pkey );
