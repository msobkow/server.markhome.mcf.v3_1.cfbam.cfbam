// Description: Java 25 edit object instance implementation for CFBam Int16Type.
	...
	implements ICFBamInt16TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt16TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt16Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt16Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsInt16Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getInt16TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getInt16TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamInt16Type origRec = getOrigAsInt16Type().getInt16TypeRec();
		ICFBamInt16Type myRec = getInt16TypeRec();
		origRec.set( myRec );
	}
