// Description: Java 25 interface for a DelTopDep record implementation
...
/**
 *	ICFBamDelTopDep persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDelTopDep extends ICFBamDelDep
{
	...
	public default void setOptionalLookupPrev(ICFBamProtDelTopDep argObj) {
		if (argObj == null) {
	...
	public default void setOptionalLookupNext(ICFBamProtDelTopDep argObj) {
		if (argObj == null) {
