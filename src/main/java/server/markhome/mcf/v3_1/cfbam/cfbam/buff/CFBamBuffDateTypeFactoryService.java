...
// Description: Java 25 Factory service implementation for DateType buffers
...
/*
 *	Java 25 Factory service implementation for DateType buffers.
 */
@Service("cfbam31BuffDateTypeFactoryService")
public class CFBamBuffDateTypeFactoryService
	implements ICFBamDateTypeFactory
{
	public CFBamBuffDateTypeFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDateType",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDateType");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDateType",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDateType");
			}
		}
	}
