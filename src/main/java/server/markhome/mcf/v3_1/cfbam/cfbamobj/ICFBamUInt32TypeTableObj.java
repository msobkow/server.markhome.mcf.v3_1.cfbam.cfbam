...
public interface ICFBamUInt32TypeTableObj
{
	 ...
	 */
	ICFBamUInt32TypeObj readUInt32Type( ICFLibKeyHash256 pkey );
	...
	ICFBamUInt32TypeObj readCachedUInt32Type( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamUInt32TypeObj lockUInt32Type( ICFLibKeyHash256 pkey );
