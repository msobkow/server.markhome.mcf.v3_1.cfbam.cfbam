	...
	implements ICFBamId16Gen
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamId16Gen rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamId16GenH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffId16Gen ) {
			setId16Gen( (CFBamProtBuffId16Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffId16Gen ) {
			setId16Gen( (CFBamPubBuffId16Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
