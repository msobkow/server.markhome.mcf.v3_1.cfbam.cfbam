...
public class CFBamSecClusGrpIncObj
	implements ICFBamSecClusGrpIncObj
{
	...
	public CFBamSecClusGrpIncObj() {
		isNew = true;
	}

	public CFBamSecClusGrpIncObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
	}
	...
	public ICFSecSecClusGrpIncObj realise() {
		ICFSecSecClusGrpIncObj retobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj().realiseSecClusGrpInc(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj().reallyDeepDisposeSecClusGrpInc( (ICFSecSecClusGrpIncObj)this );
	}

	@Override
	public ICFSecSecClusGrpIncObj read() {
		ICFSecSecClusGrpIncObj retobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj().readSecClusGrpIncByIdIdx( getPKey().getRequiredSecClusGrpId(),
	...
	public ICFSecSecClusGrpIncTableObj getSecClusGrpIncTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj() );
	}
	...
	public ICFSecSecClusGrpInc getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecClusGrpInc().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
	...
	public ICFSecSecClusGrpIncEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj().lockSecClusGrpInc( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecClusGrpIncTableObj().newEditInstance( lockobj );
