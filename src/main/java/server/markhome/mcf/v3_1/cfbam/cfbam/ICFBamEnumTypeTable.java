...
// Description: Java 25 DbIO interface for EnumType.
...
public interface ICFBamEnumTypeTable
{
	 ...
	 */
	ICFBamEnumType createEnumType( ICFSecAuthorization Authorization,
		ICFBamEnumType rec );
	 ...
	 */
	ICFBamEnumType updateEnumType( ICFSecAuthorization Authorization,
		ICFBamEnumType rec );
	 ...
	 */
	void deleteEnumType( ICFSecAuthorization Authorization,
		ICFBamEnumType rec );
	/**
	 ...
	 */
	ICFBamEnumType[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamEnumType[] readAllRec( ICFSecAuthorization Authorization );
