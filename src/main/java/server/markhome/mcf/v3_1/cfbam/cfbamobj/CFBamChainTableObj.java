	...
	implements ICFBamChainTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> allChain;
	private Map< ICFBamChainByChainTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > > indexByChainTableIdx;
	private Map< ICFBamChainByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > > indexByDefSchemaIdx;
	private Map< ICFBamChainByUNameIdxKey,
		ICFBamChainObj > indexByUNameIdx;
	private Map< ICFBamChainByPrevRelIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > > indexByPrevRelIdx;
	private Map< ICFBamChainByNextRelIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > > indexByNextRelIdx;
	public static String TABLE_NAME = "Chain";
	public static String TABLE_DBNAME = "chain_def";

	public CFBamChainTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamChainObj>();
		allChain = null;
	...
	public ICFBamChainObj realiseChain( ICFBamChainObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByChainTableIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > mapChainTableIdx = indexByChainTableIdx.get( keyChainTableIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByUNameIdx != null ) {
				ICFBamChainByUNameIdxKey keyUNameIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByUNameIdxKey();
			...
			if( indexByPrevRelIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > mapPrevRelIdx = indexByPrevRelIdx.get( keyPrevRelIdx );
			...
			if( indexByNextRelIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamChainObj > mapNextRelIdx = indexByNextRelIdx.get( keyNextRelIdx );
	...
	@Override
	public ICFBamChainObj readChain( $implCommaIJavaOptAtomType$ pkey ) {
		return( readChain( pkey, false ) );
	}

	@Override
	public ICFBamChainObj readChain( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamChainObj readCachedChain( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamChainObj obj = null;
	...
	public void reallyDeepDisposeChain( ICFBamChainObj obj )
	{
		...
		members.remove( pkey );
		ICFBamChainByChainTableIdxKey keyChainTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByChainTableIdxKey();
		keyChainTableIdx.setRequiredTableId( existing.getRequiredTableId() );

		ICFBamChainByDefSchemaIdxKey keyDefSchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByDefSchemaIdxKey();
		keyDefSchemaIdx.setOptionalDefSchemaId( existing.getOptionalDefSchemaId() );

		ICFBamChainByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByUNameIdxKey();
		keyUNameIdx.setRequiredTableId( existing.getRequiredTableId() );
		keyUNameIdx.setRequiredName( existing.getRequiredName() );

		ICFBamChainByPrevRelIdxKey keyPrevRelIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByPrevRelIdxKey();
		keyPrevRelIdx.setRequiredPrevRelationId( existing.getRequiredPrevRelationId() );

		ICFBamChainByNextRelIdxKey keyNextRelIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByNextRelIdxKey();
	...
	@Override
	public void deepDisposeChain( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamChainObj lockChain( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamChainObj> readAllChain( boolean forceRead ) {
		...
		if( ( allChain == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamChainObj>();
			allChain = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> dict;
		if( indexByChainTableIdx == null ) {
			indexByChainTableIdx = new HashMap< ICFBamChainByChainTableIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamChainObj > >();
		}
		if( ( ! forceRead ) && indexByChainTableIdx.containsKey( key ) ) {
			dict = indexByChainTableIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamChainObj>();
			ICFBamChainObj obj;
		...
		String Name, boolean forceRead )
	{
		...
		ICFBamChainByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryChain().newByUNameIdxKey();
		key.setRequiredTableId( TableId );
	...
	public void deleteChainByChainTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByChainTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> dict = indexByChainTableIdx.get( key );
	...
	public void deleteChainByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteChainByPrevRelIdx( ICFLibKeyHash256 PrevRelationId )
	{
		...
		if( indexByPrevRelIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> dict = indexByPrevRelIdx.get( key );
	...
	public void deleteChainByNextRelIdx( ICFLibKeyHash256 NextRelationId )
	{
		...
		if( indexByNextRelIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamChainObj> dict = indexByNextRelIdx.get( key );
