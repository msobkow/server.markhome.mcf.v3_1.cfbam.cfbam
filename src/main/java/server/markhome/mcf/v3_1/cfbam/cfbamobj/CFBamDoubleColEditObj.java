// Description: Java 25 edit object instance implementation for CFBam DoubleCol.
	...
	implements ICFBamDoubleColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDoubleColTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsDoubleCol().getSchema()).getTableTableObj().readTableByIdIdx( getDoubleColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getDoubleColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamDoubleCol origRec = getOrigAsDoubleCol().getDoubleColRec();
		ICFBamDoubleCol myRec = getDoubleColRec();
		origRec.set( myRec );
	}
