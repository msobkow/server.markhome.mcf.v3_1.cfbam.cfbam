...
public interface ICFBamUuidDefTableObj
{
	 ...
	 */
	ICFBamUuidDefObj readUuidDef( ICFLibKeyHash256 pkey );
	...
	ICFBamUuidDefObj readCachedUuidDef( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamUuidDefObj lockUuidDef( ICFLibKeyHash256 pkey );
