	...
	implements ICFBamEnumType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamEnumType rhs ) {
		...
		else if( obj instanceof ICFBamEnumTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffEnumType ) {
			setEnumType( (CFBamProtBuffEnumType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffEnumType ) {
			setEnumType( (CFBamPubBuffEnumType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
