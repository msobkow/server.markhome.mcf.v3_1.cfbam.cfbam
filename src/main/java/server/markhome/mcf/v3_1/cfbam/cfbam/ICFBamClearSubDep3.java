// Description: Java 25 interface for a ClearSubDep3 record implementation
...
/**
 *	ICFBamClearSubDep3 persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamClearSubDep3 extends ICFBamClearDep
{
	...
	public default void setRequiredContainerClearSubDep2(ICFBamProtClearSubDep2 argObj) {
		if (argObj == null) {
			setRequiredContainerClearSubDep2((ICFBamClearSubDep2)null);
		}
		else {
			setRequiredContainerClearSubDep2(argObj.getRequiredClearSubDep2Id());
		}
	}
