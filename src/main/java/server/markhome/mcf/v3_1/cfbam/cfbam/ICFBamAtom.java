// Description: Java 25 interface for a Atom record declementation
...
/**
 *	ICFBamAtom persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamAtom
	extends ICFBamValue
{
