	...
	implements ICFBamTZTimestampDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimestampDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZTimestampDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZTimestampDef ) {
			setTZTimestampDef( (CFBamProtBuffTZTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZTimestampDef ) {
			setTZTimestampDef( (CFBamPubBuffTZTimestampDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
