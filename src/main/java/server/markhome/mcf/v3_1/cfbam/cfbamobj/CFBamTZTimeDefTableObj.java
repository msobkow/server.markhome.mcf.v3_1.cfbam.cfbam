	...
	implements ICFBamTZTimeDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> allTZTimeDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTZTimeDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "TZTimeDef";
	public static String TABLE_DBNAME = "tmzdef";

	public CFBamTZTimeDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj>();
		allTZTimeDef = null;
	...
	public ICFBamTZTimeDefObj realiseTZTimeDef( ICFBamTZTimeDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamTZTimeDefObj readTZTimeDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTZTimeDef( pkey, false ) );
	}

	@Override
	public ICFBamTZTimeDefObj readTZTimeDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTZTimeDefObj readCachedTZTimeDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTZTimeDefObj obj = null;
	...
	@Override
	public void deepDisposeTZTimeDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTZTimeDefObj lockTZTimeDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTZTimeDefObj> readAllTZTimeDef( boolean forceRead ) {
		...
		if( ( allTZTimeDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTZTimeDefObj>();
			allTZTimeDef = map;
	...
	@Override
	public ICFBamTZTimeDefObj readTZTimeDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamTZTimeDefObj readTZTimeDefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamTZTimeDefObj readTZTimeDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTZTimeDefObj> readTZTimeDefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamTZTimeDefObj readCachedTZTimeDefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamTZTimeDefObj obj = null;
	...
	@Override
	public ICFBamTZTimeDefObj readCachedTZTimeDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamTZTimeDefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTZTimeDefObj> readCachedTZTimeDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTZTimeDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteTZTimeDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteTZTimeDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteTZTimeDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteTZTimeDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteTZTimeDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteTZTimeDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteTZTimeDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteTZTimeDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTZTimeDefObj> dict = indexByContNextIdx.get( key );
