// Description: Java 25 edit object instance implementation for CFBam Int16Col.
	...
	implements ICFBamInt16ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt16ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt16Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt16Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsInt16Col().getSchema()).getTableTableObj().readTableByIdIdx( getInt16ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getInt16ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamInt16Col origRec = getOrigAsInt16Col().getInt16ColRec();
		ICFBamInt16Col myRec = getInt16ColRec();
		origRec.set( myRec );
	}
