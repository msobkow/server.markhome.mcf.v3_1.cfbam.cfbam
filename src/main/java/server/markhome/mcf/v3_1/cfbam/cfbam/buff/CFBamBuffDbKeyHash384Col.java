	...
	implements ICFBamDbKeyHash384Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384Col rhs ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash384Col ) {
			setDbKeyHash384Col( (CFBamProtBuffDbKeyHash384Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Col ) {
			setDbKeyHash384Col( (CFBamPubBuffDbKeyHash384Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
