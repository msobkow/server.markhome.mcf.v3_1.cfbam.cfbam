// Description: Java 25 edit object instance implementation for CFBam HostNode.
	...
	implements ICFBamHostNodeEditObj
{
	...
	public ICFSecClusterObj getRequiredContainerCluster( boolean forceRead ) {
		if( forceRead || ( requiredContainerCluster == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecClusterObj obj = ((ICFBamSchemaObj)getOrigAsHostNode().getSchema()).getClusterTableObj().readClusterByIdIdx( getHostNodeRec().getRequiredClusterId() );
