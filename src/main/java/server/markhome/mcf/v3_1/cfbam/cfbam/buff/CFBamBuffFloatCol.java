	...
	implements ICFBamFloatCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamFloatCol rhs ) {
		...
		else if( obj instanceof ICFBamFloatColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffFloatCol ) {
			setFloatCol( (CFBamProtBuffFloatCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffFloatCol ) {
			setFloatCol( (CFBamPubBuffFloatCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
