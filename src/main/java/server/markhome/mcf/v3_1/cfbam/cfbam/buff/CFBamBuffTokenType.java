	...
	implements ICFBamTokenType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTokenType rhs ) {
		...
		else if( obj instanceof ICFBamTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTokenType ) {
			setTokenType( (CFBamProtBuffTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTokenType ) {
			setTokenType( (CFBamPubBuffTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
