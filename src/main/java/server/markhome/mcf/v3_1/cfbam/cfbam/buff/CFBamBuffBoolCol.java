	...
	implements ICFBamBoolCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamBoolCol rhs ) {
		...
		else if( obj instanceof ICFBamBoolColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffBoolCol ) {
			setBoolCol( (CFBamProtBuffBoolCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffBoolCol ) {
			setBoolCol( (CFBamPubBuffBoolCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
