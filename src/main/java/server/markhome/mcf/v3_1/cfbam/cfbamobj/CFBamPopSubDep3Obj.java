// Description: Java 25 base object instance implementation for PopSubDep3
	...
	implements ICFBamPopSubDep3Obj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)schema).getPopSubDep3TableObj().getClassCode() );
	}
	...
	public ICFBamScopeObj realise() {
		ICFBamPopSubDep3Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().realisePopSubDep3(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().reallyDeepDisposePopSubDep3( (ICFBamPopSubDep3Obj)this );
	}

	@Override
	public ICFBamScopeObj read() {
		ICFBamPopSubDep3Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().readPopSubDep3ByIdIdx( getPKey(), false );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamScopeObj read( boolean forceRead ) {
		ICFBamPopSubDep3Obj retobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().readPopSubDep3ByIdIdx( getPKey(), forceRead );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamPopSubDep3TableObj getPopSubDep3Table() {
		return( ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj() );
	}
	...
	public ICFBamScope getRec() {
		if( rec == null ) {
			if( isNew ) {
				rec = getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep3().newRec();
			}
			else {
				// Read the data rec via the backing store
				rec = getSchema().getCFBamBackingStore().getTablePopSubDep3().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public void setRec( ICFBamScope value ) {
		if( ! ( ( value == null ) || ! ( value instanceof ICFBamPopSubDep3 ) ) ) {
	...
	public ICFBamScopeEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().lockPopSubDep3( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getPopSubDep3TableObj().newEditInstance( lockobj );
	...
	public ICFBamPopSubDep2Obj getRequiredContainerPopSubDep2( boolean forceRead ) {
		if( ( requiredContainerPopSubDep2 == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerPopSubDep2 = ((ICFBamSchemaObj)getSchema()).getPopSubDep2TableObj().readPopSubDep2ByIdIdx( getPopSubDep3Rec().getRequiredPopSubDep2Id(), forceRead );
			}
		}
