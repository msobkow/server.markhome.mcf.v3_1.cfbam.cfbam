...
public class CFBamSecUserEMConfObj
	implements ICFBamSecUserEMConfObj
{
	...
	public CFBamSecUserEMConfObj() {
		isNew = true;
		requiredContainerUser = null;
	}

	public CFBamSecUserEMConfObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
		requiredContainerUser = null;
	...
	public ICFSecSecUserEMConfObj realise() {
		ICFSecSecUserEMConfObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().realiseSecUserEMConf(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().reallyDeepDisposeSecUserEMConf( (ICFSecSecUserEMConfObj)this );
	}

	@Override
	public ICFSecSecUserEMConfObj read() {
		ICFSecSecUserEMConfObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().readSecUserEMConfByIdIdx( getPKey(), false );
		return( (ICFSecSecUserEMConfObj)retobj );
	}

	@Override
	public ICFSecSecUserEMConfObj read( boolean forceRead ) {
		ICFSecSecUserEMConfObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().readSecUserEMConfByIdIdx( getPKey(), forceRead );
		return( (ICFSecSecUserEMConfObj)retobj );
	}

	@Override
	public ICFSecSecUserEMConfTableObj getSecUserEMConfTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj() );
	}
	...
	public ICFSecSecUserEMConf getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecUserEMConf().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public ICFSecSecUserEMConfEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().lockSecUserEMConf( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecUserEMConfTableObj().newEditInstance( lockobj );
