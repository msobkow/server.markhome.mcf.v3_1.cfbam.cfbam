...
// Description: Java 25 Factory service implementation for RelationCol buffers
...
/*
 *	Java 25 Factory service implementation for RelationCol buffers.
 */
@Service("cfbam31BuffRelationColFactoryService")
public class CFBamBuffRelationColFactoryService
	implements ICFBamRelationColFactory
{
	public CFBamBuffRelationColFactoryService() {
	}
	...
	public CFBamBuffRelationCol ensureRec(ICFBamRelationCol rec) {
		if( rec == null ) {
			...
			switch (rec.getClassCode()) {
				case ICFBamRelationCol.CLASS_CODE: {
					CFBamBuffRelationCol mapped = new CFBamBuffRelationCol();
					mapped.set(rec);
					return(mapped); }
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamRelationCol",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamRelationCol");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamRelationCol",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamRelationCol");
			}
		}
	}
