	...
	implements ICFBamTimestampType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimestampType rhs ) {
		...
		else if( obj instanceof ICFBamTimestampTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimestampType ) {
			setTimestampType( (CFBamProtBuffTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimestampType ) {
			setTimestampType( (CFBamPubBuffTimestampType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
