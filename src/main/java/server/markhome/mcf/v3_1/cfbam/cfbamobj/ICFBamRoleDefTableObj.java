...
public interface ICFBamRoleDefTableObj
{
	 ...
	 */
	ICFBamRoleDefObj readRoleDef( ICFLibKeyHash256 pkey );
	...
	ICFBamRoleDefObj readCachedRoleDef( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamRoleDefObj lockRoleDef( ICFLibKeyHash256 pkey );
