// Description: Java 25 base object instance implementation for RoleDef
	...
	implements ICFBamRoleDefObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)schema).getRoleDefTableObj().getClassCode() );
	}
	...
	public ICFBamRoleDefObj realise() {
		ICFBamRoleDefObj retobj = ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().realiseRoleDef(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().reallyDeepDisposeRoleDef( (ICFBamRoleDefObj)this );
	}

	@Override
	public ICFBamRoleDefObj read() {
		ICFBamRoleDefObj retobj = ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().readRoleDefByIdIdx( getPKey(), false );
		return( (ICFBamRoleDefObj)retobj );
	}

	@Override
	public ICFBamRoleDefObj read( boolean forceRead ) {
		ICFBamRoleDefObj retobj = ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().readRoleDefByIdIdx( getPKey(), forceRead );
		return( (ICFBamRoleDefObj)retobj );
	}

	@Override
	public ICFBamRoleDefTableObj getRoleDefTable() {
		return( ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj() );
	}
	...
	public ICFBamRoleDef getRec() {
		if( rec == null ) {
			if( isNew ) {
				rec = getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryRoleDef().newRec();
			}
			else {
				// Read the data rec via the backing store
				rec = getSchema().getCFBamBackingStore().getTableRoleDef().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public void setRec( ICFBamRoleDef value ) {
		if( ! ( ( value == null ) || ! ( value instanceof ICFBamRoleDef ) ) ) {
	...
	public ICFBamRoleDefEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().lockRoleDef( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getRoleDefTableObj().newEditInstance( lockobj );
	...
	public ICFBamScopeObj getRequiredContainerScopeDef( boolean forceRead ) {
		if( ( requiredContainerScopeDef == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				requiredContainerScopeDef = ((ICFBamSchemaObj)getSchema()).getScopeTableObj().readScopeByIdIdx( getRoleDefRec().getRequiredScopeId(), forceRead );
			}
		}
	...
	public ICFBamSchemaDefObj getOptionalLookupDefSchema( boolean forceRead ) {
		if( ( optionalLookupDefSchema == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				optionalLookupDefSchema = ((ICFBamSchemaObj)getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getRoleDefRec().getOptionalDefSchemaId(), forceRead );
			}
		}
