...
public interface ICFBamBlobColTableObj
{
	 ...
	 */
	ICFBamBlobColObj readBlobCol( ICFLibKeyHash256 pkey );
	...
	ICFBamBlobColObj readCachedBlobCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamBlobColObj lockBlobCol( ICFLibKeyHash256 pkey );
