	...
	implements ICFBamDbKeyHash224DefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> allDbKeyHash224Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash224DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > > indexByContNextIdx;
	...
	public CFBamDbKeyHash224DefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj>();
	...
	public ICFBamDbKeyHash224DefObj realiseDbKeyHash224Def( ICFBamDbKeyHash224DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224Def( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDbKeyHash224Def( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224Def( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash224DefObj readCachedDbKeyHash224Def( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDbKeyHash224DefObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash224Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDbKeyHash224DefObj lockDbKeyHash224Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDbKeyHash224DefObj> readAllDbKeyHash224Def( boolean forceRead ) {
		...
		if( ( allDbKeyHash224Def == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDbKeyHash224DefObj>();
	...
	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224DefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readDbKeyHash224DefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamDbKeyHash224DefObj readCachedDbKeyHash224DefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDbKeyHash224DefObj obj = null;
	...
	@Override
	public ICFBamDbKeyHash224DefObj readCachedDbKeyHash224DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamDbKeyHash224DefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDbKeyHash224DefObj> readCachedDbKeyHash224DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDbKeyHash224DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteDbKeyHash224DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDbKeyHash224DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteDbKeyHash224DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash224DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash224DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash224DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash224DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteDbKeyHash224DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDbKeyHash224DefObj> dict = indexByContNextIdx.get( key );
