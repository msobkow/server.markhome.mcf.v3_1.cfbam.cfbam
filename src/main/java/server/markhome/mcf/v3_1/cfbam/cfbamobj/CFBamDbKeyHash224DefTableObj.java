	...
	implements ICFBamDbKeyHash224DefTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> members;
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> allDbKeyHash224Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash224DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > > indexByContNextIdx;
	...
	public CFBamDbKeyHash224DefTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj>();
	...
	public ICFBamDbKeyHash224DefObj realiseDbKeyHash224Def( ICFBamDbKeyHash224DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224Def( ICFLibKeyHash256 pkey ) {
		return( readDbKeyHash224Def( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash224DefObj readDbKeyHash224Def( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash224DefObj readCachedDbKeyHash224Def( ICFLibKeyHash256 pkey ) {
		ICFBamDbKeyHash224DefObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash224Def( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamDbKeyHash224DefObj lockDbKeyHash224Def( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamDbKeyHash224DefObj> readAllDbKeyHash224Def( boolean forceRead ) {
		...
		if( ( allDbKeyHash224Def == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> map = new HashMap<ICFLibKeyHash256,ICFBamDbKeyHash224DefObj>();
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamDbKeyHash224DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj>();
			ICFBamValueObj obj;
	...
	public void deleteDbKeyHash224DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteDbKeyHash224DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteDbKeyHash224DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteDbKeyHash224DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash224DefObj> dict = indexByContNextIdx.get( key );
