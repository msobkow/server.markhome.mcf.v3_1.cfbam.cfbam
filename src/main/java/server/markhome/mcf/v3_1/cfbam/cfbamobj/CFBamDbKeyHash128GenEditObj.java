// Description: Java 25 edit object instance implementation for CFBam DbKeyHash128Gen.
	...
	implements ICFBamDbKeyHash128GenEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash128GenTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash128Gen().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash128Gen().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setRequiredSlice( short value ) {
		if( getDbKeyHash128GenRec().getRequiredSlice() != value ) {
			getDbKeyHash128GenRec().setRequiredSlice( value );
		}
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( getDbKeyHash128GenRec().getRequiredBlockSize() != value ) {
			getDbKeyHash128GenRec().setRequiredBlockSize( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamDbKeyHash128Gen origRec = getOrigAsDbKeyHash128Gen().getDbKeyHash128GenRec();
		ICFBamDbKeyHash128Gen myRec = getDbKeyHash128GenRec();
		origRec.set( myRec );
	}
