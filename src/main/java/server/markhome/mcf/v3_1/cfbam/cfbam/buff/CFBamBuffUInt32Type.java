	...
	implements ICFBamUInt32Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt32Type rhs ) {
		...
		else if( obj instanceof ICFBamUInt32TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt32Type ) {
			setUInt32Type( (CFBamProtBuffUInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt32Type ) {
			setUInt32Type( (CFBamPubBuffUInt32Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
