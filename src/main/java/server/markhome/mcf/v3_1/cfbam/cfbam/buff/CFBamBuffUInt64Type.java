	...
	implements ICFBamUInt64Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt64Type rhs ) {
		...
		else if( obj instanceof ICFBamUInt64TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt64Type ) {
			setUInt64Type( (CFBamProtBuffUInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt64Type ) {
			setUInt64Type( (CFBamPubBuffUInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
