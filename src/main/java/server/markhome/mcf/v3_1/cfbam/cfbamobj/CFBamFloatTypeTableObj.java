	...
	implements ICFBamFloatTypeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> allFloatType;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamFloatTypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexByContNextIdx;
	private Map< ICFBamFloatTypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "FloatType";
	public static String TABLE_DBNAME = "flttyp";

	public CFBamFloatTypeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj>();
		allFloatType = null;
	...
	public ICFBamFloatTypeObj realiseFloatType( ICFBamFloatTypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamFloatTypeObj readFloatType( $implCommaIJavaOptAtomType$ pkey ) {
		return( readFloatType( pkey, false ) );
	}

	@Override
	public ICFBamFloatTypeObj readFloatType( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamFloatTypeObj readCachedFloatType( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamFloatTypeObj obj = null;
	...
	public void reallyDeepDisposeFloatType( ICFBamFloatTypeObj obj )
	{
		...
		members.remove( pkey );
		ICFBamFloatTypeBySchemaIdxKey keySchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryFloatType().newBySchemaIdxKey();
	...
	@Override
	public void deepDisposeFloatType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamFloatTypeObj lockFloatType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamFloatTypeObj> readAllFloatType( boolean forceRead ) {
		...
		if( ( allFloatType == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamFloatTypeObj>();
			allFloatType = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamFloatTypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj>();
			ICFBamValueObj obj;
	...
	public void deleteFloatTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteFloatTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteFloatTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteFloatTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteFloatTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamFloatTypeObj> dict = indexBySchemaIdx.get( key );
