// Description: Java 25 Object interface for CFBam ServerListFunc.
	...
	extends ICFBamServerMethodObj
{
	...
	/**
	 *	Get the ICFBamServerListFunc instance which currently backs this instance.
	 *	<p>
	 *	This value <i>will</i> change for read-only instances, so you should
	 *	not hold on to the value as a reference anywhere outside the current call stack.
	 *
	 *	@return	ICFBamServerListFunc instance which currently backs this object.
	 */
	ICFBamServerListFunc getServerListFuncRec();
