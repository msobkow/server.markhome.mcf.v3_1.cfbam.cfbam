	...
	implements ICFBamId64Gen
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamId64Gen rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamId64GenH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffId64Gen ) {
			setId64Gen( (CFBamProtBuffId64Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffId64Gen ) {
			setId64Gen( (CFBamPubBuffId64Gen)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
