...
public interface ICFBamInt32ColTableObj
{
	 ...
	 */
	ICFBamInt32ColObj readInt32Col( ICFLibKeyHash256 pkey );
	...
	ICFBamInt32ColObj readCachedInt32Col( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamInt32ColObj lockInt32Col( ICFLibKeyHash256 pkey );
