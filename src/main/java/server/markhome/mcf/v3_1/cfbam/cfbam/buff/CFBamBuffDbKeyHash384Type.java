	...
	implements ICFBamDbKeyHash384Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384Type rhs ) {
		...
		else if( obj instanceof ICFBamDbKeyHash384TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDbKeyHash384Type ) {
			setDbKeyHash384Type( (CFBamProtBuffDbKeyHash384Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDbKeyHash384Type ) {
			setDbKeyHash384Type( (CFBamPubBuffDbKeyHash384Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
