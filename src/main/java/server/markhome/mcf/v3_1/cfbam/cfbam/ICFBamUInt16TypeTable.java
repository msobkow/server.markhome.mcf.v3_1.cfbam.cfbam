...
// Description: Java 25 DbIO interface for UInt16Type.
...
/*
 *	CFBamUInt16TypeTable database interface for UInt16Type has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamUInt16TypeTable
{
	 ...
	 */
	ICFBamUInt16Type createUInt16Type( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamUInt16Type updateUInt16Type( ICFSecAuthorization Authorization,
		ICFBamUInt16Type rec );
	 ...
	 */
	void deleteUInt16Type( ICFSecAuthorization Authorization,
		ICFBamUInt16Type rec );
	/**
	 ...
	 */
	ICFBamUInt16Type[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamUInt16Type[] readAllRec( ICFSecAuthorization Authorization );
