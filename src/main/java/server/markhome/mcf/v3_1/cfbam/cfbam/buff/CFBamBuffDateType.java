	...
	implements ICFBamDateType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamDateType rhs ) {
		...
		else if( obj instanceof ICFBamDateTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffDateType ) {
			setDateType( (CFBamProtBuffDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffDateType ) {
			setDateType( (CFBamPubBuffDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
