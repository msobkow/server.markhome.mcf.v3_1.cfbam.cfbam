...
public interface ICFBamUInt32ColTableObj
{
	 ...
	 */
	ICFBamUInt32ColObj readUInt32Col( CFLibDbKeyHash256 pkey );
	...
	ICFBamUInt32ColObj readCachedUInt32Col( CFLibDbKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamUInt32ColObj lockUInt32Col( CFLibDbKeyHash256 pkey );
	 ...
	 */
	ICFBamUInt32ColObj readUInt32ColByIdIdx( CFLibDbKeyHash256 Id );
	 ...
	 *		null if no such instance exists.
	 */
	ICFBamUInt32ColObj readUInt32ColByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );
	 ...
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByScopeIdx( CFLibDbKeyHash256 ScopeId );
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByPrevIdx( CFLibDbKeyHash256 PrevId );
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByNextIdx( CFLibDbKeyHash256 NextId );
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByContPrevIdx( CFLibDbKeyHash256 ScopeId,
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByContNextIdx( CFLibDbKeyHash256 ScopeId,
	 ...
	 *		which may be an empty set.
	 */
	List<ICFBamUInt32ColObj> readUInt32ColByTableIdx( CFLibDbKeyHash256 TableId );
	...
	ICFBamUInt32ColObj readCachedUInt32ColByIdIdx( CFLibDbKeyHash256 Id );

	ICFBamUInt32ColObj readCachedUInt32ColByUNameIdx( CFLibDbKeyHash256 ScopeId,
		String Name );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByScopeIdx( CFLibDbKeyHash256 ScopeId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByDefSchemaIdx( CFLibDbKeyHash256 DefSchemaId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByPrevIdx( CFLibDbKeyHash256 PrevId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByNextIdx( CFLibDbKeyHash256 NextId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByContPrevIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByContNextIdx( CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );

	List<ICFBamUInt32ColObj> readCachedUInt32ColByTableIdx( CFLibDbKeyHash256 TableId );
