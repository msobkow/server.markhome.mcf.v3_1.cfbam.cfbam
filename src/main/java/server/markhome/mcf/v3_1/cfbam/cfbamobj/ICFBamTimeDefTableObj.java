...
public interface ICFBamTimeDefTableObj
{
	 ...
	 */
	ICFBamTimeDefObj readTimeDef( ICFLibKeyHash256 pkey );
	...
	ICFBamTimeDefObj readCachedTimeDef( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamTimeDefObj lockTimeDef( ICFLibKeyHash256 pkey );
