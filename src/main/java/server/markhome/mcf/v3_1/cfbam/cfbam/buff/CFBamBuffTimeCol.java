	...
	implements ICFBamTimeCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimeCol rhs ) {
		...
		else if( obj instanceof ICFBamTimeColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimeCol ) {
			setTimeCol( (CFBamProtBuffTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeCol ) {
			setTimeCol( (CFBamPubBuffTimeCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
