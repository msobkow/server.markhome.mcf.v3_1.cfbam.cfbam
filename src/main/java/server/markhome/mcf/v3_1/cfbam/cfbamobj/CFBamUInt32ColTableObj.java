	...
	implements ICFBamUInt32ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> allUInt32Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUInt32ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByContNextIdx;
	private Map< ICFBamUInt32ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "UInt32Col";
	public static String TABLE_DBNAME = "uint32col";

	public CFBamUInt32ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj>();
		allUInt32Col = null;
	...
	public ICFBamUInt32ColObj realiseUInt32Col( ICFBamUInt32ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamUInt32ColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamUInt32ColObj readUInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readUInt32Col( pkey, false ) );
	}

	@Override
	public ICFBamUInt32ColObj readUInt32Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUInt32ColObj readCachedUInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamUInt32ColObj obj = null;
	...
	public void reallyDeepDisposeUInt32Col( ICFBamUInt32ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamUInt32ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeUInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamUInt32ColObj lockUInt32Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamUInt32ColObj> readAllUInt32Col( boolean forceRead ) {
		...
		if( ( allUInt32Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamUInt32ColObj>();
			allUInt32Col = map;
	...
	@Override
	public ICFBamUInt32ColObj readUInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamUInt32ColObj readUInt32ColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamUInt32ColObj readUInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamUInt32ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUInt32ColObj> readUInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamUInt32ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
	...
	@Override
	public ICFBamUInt32ColObj readCachedUInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamUInt32ColObj obj = null;
	...
	@Override
	public ICFBamUInt32ColObj readCachedUInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamUInt32ColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt32ColObj> readCachedUInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeUInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeUInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteUInt32ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteUInt32ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteUInt32ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteUInt32ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamUInt32ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt32Col().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt32ColObj> dict = indexByTableIdx.get( key );
