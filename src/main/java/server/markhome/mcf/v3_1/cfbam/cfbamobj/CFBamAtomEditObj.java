// Description: Java 25 edit object instance implementation for CFBam Atom.
	...
	implements ICFBamAtomEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getAtomTableObj().getClassCode() );
	}
	...
	public void copyRecToOrig() {
		ICFBamAtom origRec = getOrigAsAtom().getAtomRec();
		ICFBamAtom myRec = getAtomRec();
		origRec.set( myRec );
	}
