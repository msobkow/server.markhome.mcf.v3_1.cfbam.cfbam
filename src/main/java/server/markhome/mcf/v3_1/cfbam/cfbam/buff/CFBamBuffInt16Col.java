	...
	implements ICFBamInt16Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt16Col rhs ) {
		...
		else if( obj instanceof ICFBamInt16ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt16Col ) {
			setInt16Col( (CFBamProtBuffInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt16Col ) {
			setInt16Col( (CFBamPubBuffInt16Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
