	...
	implements ICFBamTimeDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTimeDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTimeDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTimeDef ) {
			setTimeDef( (CFBamProtBuffTimeDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTimeDef ) {
			setTimeDef( (CFBamPubBuffTimeDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
