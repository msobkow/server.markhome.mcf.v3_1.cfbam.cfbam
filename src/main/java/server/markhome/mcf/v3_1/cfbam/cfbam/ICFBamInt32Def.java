// Description: Java 25 interface for a Int32Def record implementation
...
/**
 *	ICFBamInt32Def persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamInt32Def extends ICFBamAtom
{
