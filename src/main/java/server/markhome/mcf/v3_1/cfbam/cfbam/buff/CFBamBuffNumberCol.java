	...
	implements ICFBamNumberCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNumberCol rhs ) {
		...
		else if( obj instanceof ICFBamNumberColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNumberCol ) {
			setNumberCol( (CFBamProtBuffNumberCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNumberCol ) {
			setNumberCol( (CFBamPubBuffNumberCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
