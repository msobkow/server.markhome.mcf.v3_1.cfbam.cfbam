	...
	implements ICFBamTimeTypeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> allTimeType;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTimeTypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexByContNextIdx;
	private Map< ICFBamTimeTypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "TimeType";
	public static String TABLE_DBNAME = "tmtyp";

	public CFBamTimeTypeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj>();
		allTimeType = null;
	...
	public ICFBamTimeTypeObj realiseTimeType( ICFBamTimeTypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				ICFBamTimeTypeBySchemaIdxKey keySchemaIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
				keySchemaIdx.setRequiredSchemaDefId( keepObj.getRequiredSchemaDefId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamTimeTypeObj readTimeType( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTimeType( pkey, false ) );
	}

	@Override
	public ICFBamTimeTypeObj readTimeType( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTimeTypeObj readCachedTimeType( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTimeTypeObj obj = null;
	...
	public void reallyDeepDisposeTimeType( ICFBamTimeTypeObj obj )
	{
		...
		members.remove( pkey );
		ICFBamTimeTypeBySchemaIdxKey keySchemaIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
	...
	@Override
	public void deepDisposeTimeType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTimeTypeObj lockTimeType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTimeTypeObj> readAllTimeType( boolean forceRead ) {
		...
		if( ( allTimeType == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTimeTypeObj>();
			allTimeType = map;
	...
	@Override
	public ICFBamTimeTypeObj readTimeTypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamTimeTypeObj readTimeTypeByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamTimeTypeObj readTimeTypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTimeTypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTimeTypeObj> readTimeTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamTimeTypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
	...
	@Override
	public ICFBamTimeTypeObj readCachedTimeTypeByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamTimeTypeObj obj = null;
	...
	@Override
	public ICFBamTimeTypeObj readCachedTimeTypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamTimeTypeObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTimeTypeObj> readCachedTimeTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeTimeTypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeTimeTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTimeTypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTimeTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deleteTimeTypeByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteTimeTypeByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteTimeTypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteTimeTypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteTimeTypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteTimeTypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteTimeTypeByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteTimeTypeByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteTimeTypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		ICFBamTimeTypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTimeType().newBySchemaIdxKey();
		key.setRequiredSchemaDefId( SchemaDefId );
		if( indexBySchemaIdx == null ) {
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeTypeObj> dict = indexBySchemaIdx.get( key );
