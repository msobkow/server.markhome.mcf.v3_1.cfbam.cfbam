	...
	implements ICFBamUuid6Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6Type rhs ) {
		...
		else if( obj instanceof ICFBamUuid6TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuid6Type ) {
			setUuid6Type( (CFBamProtBuffUuid6Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Type ) {
			setUuid6Type( (CFBamPubBuffUuid6Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
