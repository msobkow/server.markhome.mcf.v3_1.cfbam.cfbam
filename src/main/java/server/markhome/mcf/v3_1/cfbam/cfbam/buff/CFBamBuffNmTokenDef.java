	...
	implements ICFBamNmTokenDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNmTokenDef ) {
			setNmTokenDef( (CFBamProtBuffNmTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenDef ) {
			setNmTokenDef( (CFBamPubBuffNmTokenDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
