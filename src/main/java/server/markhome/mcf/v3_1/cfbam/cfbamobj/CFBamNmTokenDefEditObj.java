// Description: Java 25 edit object instance implementation for CFBam NmTokenDef.
	...
	implements ICFBamNmTokenDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getNmTokenDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsNmTokenDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryNmTokenDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setRequiredMaxLen( int value ) {
		if( getNmTokenDefRec().getRequiredMaxLen() != value ) {
			getNmTokenDefRec().setRequiredMaxLen( value );
		}
	}
	...
	public void setOptionalInitValue( String value ) {
		if( getNmTokenDefRec().getOptionalInitValue() != value ) {
			getNmTokenDefRec().setOptionalInitValue( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamNmTokenDef origRec = getOrigAsNmTokenDef().getNmTokenDefRec();
		ICFBamNmTokenDef myRec = getNmTokenDefRec();
		origRec.set( myRec );
	}
