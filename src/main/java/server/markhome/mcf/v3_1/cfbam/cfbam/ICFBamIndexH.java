// Description: Java 25 interface for a Index history object
...
/**
 *	ICFBamIndexH provides access to history records matching the CFBamIndex object change history.
 */
public interface ICFBamIndexH extends ICFBamScopeH
{
