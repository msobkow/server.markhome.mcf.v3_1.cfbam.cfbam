...
// Description: Java 25 Factory service implementation for DoubleCol buffers
...
/*
 *	Java 25 Factory service implementation for DoubleCol buffers.
 */
@Service("cfbam31BuffDoubleColFactoryService")
public class CFBamBuffDoubleColFactoryService
	implements ICFBamDoubleColFactory
{
	public CFBamBuffDoubleColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDoubleCol",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDoubleCol");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDoubleCol",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDoubleCol");
			}
		}
	}
