	...
	implements ICFBamNmTokenDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> allNmTokenDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamNmTokenDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "NmTokenDef";
	public static String TABLE_DBNAME = "nmtkndef";

	public CFBamNmTokenDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj>();
		allNmTokenDef = null;
	...
	public ICFBamNmTokenDefObj realiseNmTokenDef( ICFBamNmTokenDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamNmTokenDefObj readNmTokenDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readNmTokenDef( pkey, false ) );
	}

	@Override
	public ICFBamNmTokenDefObj readNmTokenDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamNmTokenDefObj readCachedNmTokenDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamNmTokenDefObj obj = null;
	...
	@Override
	public void deepDisposeNmTokenDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamNmTokenDefObj lockNmTokenDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamNmTokenDefObj> readAllNmTokenDef( boolean forceRead ) {
		...
		if( ( allNmTokenDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamNmTokenDefObj>();
			allNmTokenDef = map;
	...
	@Override
	public ICFBamNmTokenDefObj readNmTokenDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamNmTokenDefObj readNmTokenDefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamNmTokenDefObj readNmTokenDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokenDefObj> readNmTokenDefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamNmTokenDefObj readCachedNmTokenDefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamNmTokenDefObj obj = null;
	...
	@Override
	public ICFBamNmTokenDefObj readCachedNmTokenDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamNmTokenDefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokenDefObj> readCachedNmTokenDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokenDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteNmTokenDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteNmTokenDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteNmTokenDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteNmTokenDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteNmTokenDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokenDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteNmTokenDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokenDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokenDefObj> dict = indexByContNextIdx.get( key );
