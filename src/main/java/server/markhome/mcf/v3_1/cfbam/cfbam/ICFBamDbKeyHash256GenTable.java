...
// Description: Java 25 DbIO interface for DbKeyHash256Gen.
...
/*
 *	CFBamDbKeyHash256GenTable database interface for DbKeyHash256Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDbKeyHash256GenTable
{
	 ...
	 */
	ICFBamDbKeyHash256Gen createDbKeyHash256Gen( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamDbKeyHash256Gen updateDbKeyHash256Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Gen rec );
	 ...
	 */
	void deleteDbKeyHash256Gen( ICFSecAuthorization Authorization,
		ICFBamDbKeyHash256Gen rec );
	/**
	 ...
	 */
	ICFBamDbKeyHash256Gen[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamDbKeyHash256Gen[] readAllRec( ICFSecAuthorization Authorization );
