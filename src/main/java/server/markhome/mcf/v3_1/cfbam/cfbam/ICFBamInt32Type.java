// Description: Java 25 interface for a Int32Type record implementation
...
/**
 *	ICFBamInt32Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamInt32Type extends ICFBamInt32Def
{
