// Description: Java 25 edit object instance implementation for CFBam UInt64Type.
	...
	implements ICFBamUInt64TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt64TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsUInt64Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryUInt64Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsUInt64Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getUInt64TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getUInt64TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt64Type origRec = getOrigAsUInt64Type().getUInt64TypeRec();
		ICFBamUInt64Type myRec = getUInt64TypeRec();
		origRec.set( myRec );
	}
