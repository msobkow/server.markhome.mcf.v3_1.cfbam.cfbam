	...
	implements ICFBamId64GenTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamId64GenObj> members;
	private Map<ICFLibKeyHash256, ICFBamId64GenObj> allId64Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamId64GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexByContNextIdx;
	private Map< ICFBamInt64TypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamId64GenObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "Id64Gen";
	public static String TABLE_DBNAME = "idg64";

	public CFBamId64GenTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamId64GenObj>();
		allId64Gen = null;
	...
	public ICFBamId64GenObj realiseId64Gen( ICFBamId64GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamId64GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamId64GenObj readId64Gen( ICFLibKeyHash256 pkey ) {
		return( readId64Gen( pkey, false ) );
	}

	@Override
	public ICFBamId64GenObj readId64Gen( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamId64GenObj readCachedId64Gen( ICFLibKeyHash256 pkey ) {
		ICFBamId64GenObj obj = null;
	...
	@Override
	public void deepDisposeId64Gen( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamId64GenObj lockId64Gen( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamId64GenObj> readAllId64Gen( boolean forceRead ) {
		...
		if( ( allId64Gen == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> map = new HashMap<ICFLibKeyHash256,ICFBamId64GenObj>();
			allId64Gen = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamId64GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamId64GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamId64GenObj>();
			ICFBamValueObj obj;
	...
	public void deleteId64GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteId64GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteId64GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteId64GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteId64GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamId64GenObj> dict = indexBySchemaIdx.get( key );
