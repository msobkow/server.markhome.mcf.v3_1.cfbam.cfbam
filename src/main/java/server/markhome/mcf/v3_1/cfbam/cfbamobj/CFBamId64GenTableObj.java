	...
	implements ICFBamId64GenTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> allId64Gen;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamId64GenObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexByContNextIdx;
	private Map< ICFBamInt64TypeBySchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > > indexBySchemaIdx;
	public static String TABLE_NAME = "Id64Gen";
	public static String TABLE_DBNAME = "idg64";

	public CFBamId64GenTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamId64GenObj>();
		allId64Gen = null;
	...
	public ICFBamId64GenObj realiseId64Gen( ICFBamId64GenObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamId64GenObj readId64Gen( $implCommaIJavaOptAtomType$ pkey ) {
		return( readId64Gen( pkey, false ) );
	}

	@Override
	public ICFBamId64GenObj readId64Gen( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamId64GenObj readCachedId64Gen( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamId64GenObj obj = null;
	...
	@Override
	public void deepDisposeId64Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamId64GenObj lockId64Gen( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamId64GenObj> readAllId64Gen( boolean forceRead ) {
		...
		if( ( allId64Gen == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamId64GenObj>();
			allId64Gen = map;
	...
	@Override
	public ICFBamId64GenObj readId64GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamId64GenObj readId64GenByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamId64GenObj readId64GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamId64GenObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamId64GenObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamId64GenObj> readId64GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public ICFBamId64GenObj readCachedId64GenByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamId64GenObj obj = null;
	...
	@Override
	public ICFBamId64GenObj readCachedId64GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamId64GenObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamId64GenObj> readCachedId64GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deepDisposeId64GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeId64GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeId64GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeId64GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeId64GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeId64GenByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeId64GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeId64GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeId64GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
	...
	@Override
	public void deleteId64GenByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteId64GenByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteId64GenByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteId64GenByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteId64GenByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteId64GenByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteId64GenByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteId64GenByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteId64GenBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		ICFBamInt64TypeBySchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryInt64Type().newBySchemaIdxKey();
		key.setRequiredSchemaDefId( SchemaDefId );
		if( indexBySchemaIdx == null ) {
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamId64GenObj> dict = indexBySchemaIdx.get( key );
