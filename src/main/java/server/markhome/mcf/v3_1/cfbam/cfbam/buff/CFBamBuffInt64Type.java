	...
	implements ICFBamInt64Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamInt64Type rhs ) {
		...
		else if( obj instanceof ICFBamInt64TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffInt64Type ) {
			setInt64Type( (CFBamProtBuffInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffInt64Type ) {
			setInt64Type( (CFBamPubBuffInt64Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
