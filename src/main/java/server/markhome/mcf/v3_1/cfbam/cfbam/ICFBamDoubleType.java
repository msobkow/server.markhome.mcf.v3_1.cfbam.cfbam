// Description: Java 25 interface for a DoubleType record implementation
...
/**
 *	ICFBamDoubleType persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDoubleType extends ICFBamDoubleDef
{
