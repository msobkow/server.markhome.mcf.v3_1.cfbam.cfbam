...
// Description: Java 25 Factory service implementation for UuidCol buffers
...
/*
 *	Java 25 Factory service implementation for UuidCol buffers.
 */
@Service("cfbam31BuffUuidColFactoryService")
public class CFBamBuffUuidColFactoryService
	implements ICFBamUuidColFactory
{
	public CFBamBuffUuidColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUuidCol",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUuidCol");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUuidCol",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUuidCol");
			}
		}
	}
