...
// Description: Java 25 Factory service implementation for ClearTopDep buffers
...
/*
 *	Java 25 Factory service implementation for ClearTopDep buffers.
 */
@Service("cfbam31BuffClearTopDepFactoryService")
public class CFBamBuffClearTopDepFactoryService
	implements ICFBamClearTopDepFactory
{
	public CFBamBuffClearTopDepFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearTopDep",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamClearTopDep");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearTopDep",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamClearTopDep");
			}
		}
	}
