	...
	implements ICFBamTZDateDef
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZDateDef rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamTZDateDefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZDateDef ) {
			setTZDateDef( (CFBamProtBuffTZDateDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZDateDef ) {
			setTZDateDef( (CFBamPubBuffTZDateDef)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
