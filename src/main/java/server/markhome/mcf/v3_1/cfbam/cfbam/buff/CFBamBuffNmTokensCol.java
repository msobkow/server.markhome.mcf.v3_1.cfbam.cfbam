	...
	implements ICFBamNmTokensCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokensCol rhs ) {
		...
		else if( obj instanceof ICFBamNmTokensColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNmTokensCol ) {
			setNmTokensCol( (CFBamProtBuffNmTokensCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokensCol ) {
			setNmTokensCol( (CFBamPubBuffNmTokensCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
