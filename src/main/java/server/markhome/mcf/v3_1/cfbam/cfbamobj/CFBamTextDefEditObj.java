// Description: Java 25 edit object instance implementation for CFBam TextDef.
	...
	implements ICFBamTextDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTextDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsTextDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryTextDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamTextDef origRec = getOrigAsTextDef().getTextDefRec();
		ICFBamTextDef myRec = getTextDefRec();
		origRec.set( myRec );
	}
