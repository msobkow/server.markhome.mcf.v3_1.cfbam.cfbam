// Description: Java 25 interface for a DbKeyHash256Type record implementation
...
/**
 *	ICFBamDbKeyHash256Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDbKeyHash256Type extends ICFBamDbKeyHash256Def
{
