// Description: Java 25 interface for a Int16Type record implementation
...
/**
 *	ICFBamInt16Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamInt16Type extends ICFBamInt16Def
{
