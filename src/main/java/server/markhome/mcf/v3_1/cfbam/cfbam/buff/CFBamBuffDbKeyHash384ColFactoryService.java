...
// Description: Java 25 Factory service implementation for DbKeyHash384Col buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash384Col buffers.
 */
@Service("cfbam31BuffDbKeyHash384ColFactoryService")
public class CFBamBuffDbKeyHash384ColFactoryService
	implements ICFBamDbKeyHash384ColFactory
{
	public CFBamBuffDbKeyHash384ColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Col",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Col");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Col",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash384Col");
			}
		}
	}
