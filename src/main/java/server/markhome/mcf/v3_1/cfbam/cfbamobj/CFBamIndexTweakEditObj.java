// Description: Java 25 edit object instance implementation for CFBam IndexTweak.
	...
	implements ICFBamIndexTweakEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getIndexTweakTableObj().getClassCode() );
	}
	...
	public ICFBamIndexObj getRequiredContainerIndexDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerIndexDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamIndexObj obj = ((ICFBamSchemaObj)getOrigAsIndexTweak().getSchema()).getIndexTableObj().readIndexByIdIdx( getIndexTweakRec().getRequiredIndexId() );
	...
	public void setRequiredContainerIndexDef( ICFBamIndexObj value ) {
		...
		if( value != null ) {
			...
			getIndexTweakRec().setRequiredContainerIndexDef(value.getIndexRec());
		}
		requiredContainerIndexDef = value;
	...
	public void copyRecToOrig() {
		ICFBamIndexTweak origRec = getOrigAsIndexTweak().getIndexTweakRec();
		ICFBamIndexTweak myRec = getIndexTweakRec();
		origRec.set( myRec );
	}
