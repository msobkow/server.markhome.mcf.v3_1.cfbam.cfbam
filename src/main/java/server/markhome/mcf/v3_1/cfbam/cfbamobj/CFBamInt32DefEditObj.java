// Description: Java 25 edit object instance implementation for CFBam Int32Def.
	...
	implements ICFBamInt32DefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getInt32DefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsInt32Def().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryInt32Def().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamInt32Def origRec = getOrigAsInt32Def().getInt32DefRec();
		ICFBamInt32Def myRec = getInt32DefRec();
		origRec.set( myRec );
	}
