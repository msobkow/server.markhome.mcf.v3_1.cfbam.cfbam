...
// Description: Java 25 Factory service implementation for DateCol buffers
...
/*
 *	Java 25 Factory service implementation for DateCol buffers.
 */
@Service("cfbam31BuffDateColFactoryService")
public class CFBamBuffDateColFactoryService
	implements ICFBamDateColFactory
{
	public CFBamBuffDateColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDateCol",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDateCol");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDateCol",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDateCol");
			}
		}
	}
