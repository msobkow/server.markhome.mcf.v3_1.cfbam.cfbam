...
public interface ICFBamBoolColTableObj
{
	 ...
	 */
	ICFBamBoolColObj readBoolCol( ICFLibKeyHash256 pkey );
	...
	ICFBamBoolColObj readCachedBoolCol( ICFLibKeyHash256 pkey );
	 ...
	 *	Internal use only.
	 */
	ICFBamBoolColObj lockBoolCol( ICFLibKeyHash256 pkey );
