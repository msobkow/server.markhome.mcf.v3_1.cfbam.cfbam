	...
	implements ICFBamUInt32Col
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt32Col rhs ) {
		...
		else if( obj instanceof ICFBamUInt32ColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt32Col ) {
			setUInt32Col( (CFBamProtBuffUInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt32Col ) {
			setUInt32Col( (CFBamPubBuffUInt32Col)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
