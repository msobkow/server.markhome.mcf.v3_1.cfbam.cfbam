	...
	implements ICFBamTZDateType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamTZDateType rhs ) {
		...
		else if( obj instanceof ICFBamTZDateTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffTZDateType ) {
			setTZDateType( (CFBamProtBuffTZDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffTZDateType ) {
			setTZDateType( (CFBamPubBuffTZDateType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
