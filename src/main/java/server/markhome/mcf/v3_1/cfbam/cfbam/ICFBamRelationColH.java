// Description: Java 25 interface for a RelationCol history object
...
/**
 *	ICFBamRelationColH provides access to history records matching the CFBamRelationCol object change history.
 */
public interface ICFBamRelationColH
{
