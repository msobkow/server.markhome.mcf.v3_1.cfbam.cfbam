// Description: Java 25 base object instance implementation for ServerMethod
	...
	implements ICFBamServerMethodObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)schema).getServerMethodTableObj().getClassCode() );
	}
	...
	public ICFBamScopeObj realise() {
		ICFBamServerMethodObj retobj = ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().realiseServerMethod(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().reallyDeepDisposeServerMethod( (ICFBamServerMethodObj)this );
	}

	@Override
	public ICFBamScopeObj read() {
		ICFBamServerMethodObj retobj = ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().readServerMethodByIdIdx( getPKey(), false );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamScopeObj read( boolean forceRead ) {
		ICFBamServerMethodObj retobj = ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().readServerMethodByIdIdx( getPKey(), forceRead );
		return( (ICFBamScopeObj)retobj );
	}

	@Override
	public ICFBamServerMethodTableObj getServerMethodTable() {
		return( ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj() );
	}
	...
	public ICFBamScope getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFBamBackingStore().getTableServerMethod().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public void setRec( ICFBamScope value ) {
		if( ! ( ( value == null ) || ! ( value instanceof ICFBamServerMethod ) ) ) {
			throw new CFLibUnsupportedClassException( getClass(),
				"setRec",
				"value",
				value,
				"CFBamServerMethodRec" );
		}
		rec = value;
		copyRecToPKey();
	...
	public ICFBamScopeEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().lockServerMethod( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getServerMethodTableObj().newEditInstance( lockobj );
	...
	public ICFBamSchemaDefObj getOptionalLookupDefSchema( boolean forceRead ) {
		if( ( optionalLookupDefSchema == null ) || forceRead ) {
			...
			if( ! anyMissing ) {
				optionalLookupDefSchema = ((ICFBamSchemaObj)getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getServerMethodRec().getOptionalDefSchemaId(), forceRead );
			}
		}
	...
	public ICFBamTableObj getRequiredContainerForTable( boolean forceRead ) {
		if( ( requiredContainerForTable == null ) || forceRead ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				requiredContainerForTable = ((ICFBamSchemaObj)getSchema()).getTableTableObj().readTableByIdIdx( getServerMethodRec().getRequiredTableId(), forceRead );
			}
		}
