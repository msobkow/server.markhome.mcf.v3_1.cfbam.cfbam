...
// Description: Java 25 Factory service implementation for DelSubDep3 buffers
...
/*
 *	Java 25 Factory service implementation for DelSubDep3 buffers.
 */
@Service("cfbam31BuffDelSubDep3FactoryService")
public class CFBamBuffDelSubDep3FactoryService
	implements ICFBamDelSubDep3Factory
{
	public CFBamBuffDelSubDep3FactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDelSubDep3",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDelSubDep3");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDelSubDep3",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDelSubDep3");
			}
		}
	}
