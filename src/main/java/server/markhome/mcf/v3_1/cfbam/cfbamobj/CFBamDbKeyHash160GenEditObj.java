// Description: Java 25 edit object instance implementation for CFBam DbKeyHash160Gen.
	...
	implements ICFBamDbKeyHash160GenEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash160GenTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash160Gen().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash160Gen().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void setRequiredSlice( short value ) {
		if( getDbKeyHash160GenRec().getRequiredSlice() != value ) {
			getDbKeyHash160GenRec().setRequiredSlice( value );
		}
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( getDbKeyHash160GenRec().getRequiredBlockSize() != value ) {
			getDbKeyHash160GenRec().setRequiredBlockSize( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamDbKeyHash160Gen origRec = getOrigAsDbKeyHash160Gen().getDbKeyHash160GenRec();
		ICFBamDbKeyHash160Gen myRec = getDbKeyHash160GenRec();
		origRec.set( myRec );
	}
