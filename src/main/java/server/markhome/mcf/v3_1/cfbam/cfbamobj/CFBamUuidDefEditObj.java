// Description: Java 25 edit object instance implementation for CFBam UuidDef.
	...
	implements ICFBamUuidDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUuidDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsUuidDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryUuidDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamUuidDef origRec = getOrigAsUuidDef().getUuidDefRec();
		ICFBamUuidDef myRec = getUuidDefRec();
		origRec.set( myRec );
	}
