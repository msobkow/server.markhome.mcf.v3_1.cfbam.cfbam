	...
	implements ICFBamUuid6Def
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6Def rhs ) {
	...
	public int compareTo( Object obj ) {
		...
		else if( obj instanceof ICFBamUuid6DefH rhs ) {
			cmp = super.compareTo( rhs );
			if( cmp != 0 ) {
				return( cmp );
			}
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUuid6Def ) {
			setUuid6Def( (CFBamProtBuffUuid6Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUuid6Def ) {
			setUuid6Def( (CFBamPubBuffUuid6Def)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
