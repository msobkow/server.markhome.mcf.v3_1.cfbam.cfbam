	...
	implements ICFBamDoubleColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> allDoubleCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDoubleColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByContNextIdx;
	private Map< ICFBamDoubleColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > > indexByTableIdx;
	public static String TABLE_NAME = "DoubleCol";
	public static String TABLE_DBNAME = "dblcol";

	public CFBamDoubleColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj>();
		allDoubleCol = null;
	...
	public ICFBamDoubleColObj realiseDoubleCol( ICFBamDoubleColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamDoubleColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamDoubleColObj readDoubleCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readDoubleCol( pkey, false ) );
	}

	@Override
	public ICFBamDoubleColObj readDoubleCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDoubleColObj readCachedDoubleCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamDoubleColObj obj = null;
	...
	public void reallyDeepDisposeDoubleCol( ICFBamDoubleColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamDoubleColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeDoubleCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamDoubleColObj lockDoubleCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamDoubleColObj> readAllDoubleCol( boolean forceRead ) {
		...
		if( ( allDoubleCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamDoubleColObj>();
			allDoubleCol = map;
	...
	@Override
	public ICFBamDoubleColObj readDoubleColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamDoubleColObj readDoubleColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamDoubleColObj readDoubleColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamDoubleColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamDoubleColObj> readDoubleColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamDoubleColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
	...
	@Override
	public ICFBamDoubleColObj readCachedDoubleColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamDoubleColObj obj = null;
	...
	@Override
	public ICFBamDoubleColObj readCachedDoubleColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamDoubleColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamDoubleColObj> readCachedDoubleColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeDoubleColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeDoubleColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeDoubleColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeDoubleColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeDoubleColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDoubleColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDoubleColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeDoubleColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeDoubleColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteDoubleColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteDoubleColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteDoubleColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteDoubleColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteDoubleColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteDoubleColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteDoubleColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteDoubleColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteDoubleColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamDoubleColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryDoubleCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamDoubleColObj> dict = indexByTableIdx.get( key );
