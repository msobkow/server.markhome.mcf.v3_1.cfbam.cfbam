// Description: Java 25 edit object instance implementation for CFBam TZTimestampDef.
	...
	implements ICFBamTZTimestampDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTZTimestampDefTableObj().getClassCode() );
	}
	...
	public void setOptionalDummy( String value ) {
		if( getTZTimestampDefRec().getOptionalDummy() != value ) {
			getTZTimestampDefRec().setOptionalDummy( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamTZTimestampDef origRec = getOrigAsTZTimestampDef().getTZTimestampDefRec();
		ICFBamTZTimestampDef myRec = getTZTimestampDefRec();
		origRec.set( myRec );
	}
