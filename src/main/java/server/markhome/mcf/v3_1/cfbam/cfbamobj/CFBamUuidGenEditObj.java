// Description: Java 25 edit object instance implementation for CFBam UuidGen.
	...
	implements ICFBamUuidGenEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUuidGenTableObj().getClassCode() );
	}
	...
	public void setRequiredSlice( short value ) {
		if( getUuidGenRec().getRequiredSlice() != value ) {
			getUuidGenRec().setRequiredSlice( value );
		}
	}
	...
	public void setRequiredBlockSize( int value ) {
		if( getUuidGenRec().getRequiredBlockSize() != value ) {
			getUuidGenRec().setRequiredBlockSize( value );
		}
	}

	@Override
	public void copyRecToOrig() {
		ICFBamUuidGen origRec = getOrigAsUuidGen().getUuidGenRec();
		ICFBamUuidGen myRec = getUuidGenRec();
		origRec.set( myRec );
	}
