// Description: Java 25 edit object instance implementation for CFBam SysCluster.
	...
	implements ICFBamSysClusterEditObj
{
	...
	public ICFSecClusterObj getRequiredContainerCluster( boolean forceRead ) {
		if( forceRead || ( requiredContainerCluster == null ) ) {
			...
			if( ! anyMissing ) {
				ICFSecClusterObj obj = ((ICFBamSchemaObj)getOrigAsSysCluster().getSchema()).getClusterTableObj().readClusterByIdIdx( getSysClusterRec().getRequiredClusterId() );
