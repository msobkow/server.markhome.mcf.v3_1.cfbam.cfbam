...
public interface ICFBamTweakTableObj
{
	 ...
	 */
	ICFBamTweakObj readTweak( $implCommaIJavaOptAtomType$ pkey );
	...
	ICFBamTweakObj readCachedTweak( $implCommaIJavaOptAtomType$ pkey );

	public void reallyDeepDisposeTweak( ICFBamTweakObj obj );

	void deepDisposeTweak( $implCommaIJavaOptAtomType$ pkey );

	/**
	 *	Internal use only.
	 */
	ICFBamTweakObj lockTweak( $implCommaIJavaOptAtomType$ pkey );
