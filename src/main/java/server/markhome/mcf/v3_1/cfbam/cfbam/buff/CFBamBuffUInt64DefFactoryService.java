...
// Description: Java 25 Factory service implementation for UInt64Def buffers
...
/*
 *	Java 25 Factory service implementation for UInt64Def buffers.
 */
@Service("cfbam31BuffUInt64DefFactoryService")
public class CFBamBuffUInt64DefFactoryService
	implements ICFBamUInt64DefFactory
{
	public CFBamBuffUInt64DefFactoryService() {
	}
