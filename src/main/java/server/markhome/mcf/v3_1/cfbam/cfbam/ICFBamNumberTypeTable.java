...
// Description: Java 25 DbIO interface for NumberType.
...
/*
 *	CFBamNumberTypeTable database interface for NumberType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamNumberTypeTable
{
	 ...
	 */
	ICFBamNumberType createNumberType( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamNumberType updateNumberType( ICFSecAuthorization Authorization,
		ICFBamNumberType rec );
	 ...
	 */
	void deleteNumberType( ICFSecAuthorization Authorization,
		ICFBamNumberType rec );
	/**
	 ...
	 */
	void deleteNumberTypeBySchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteNumberTypeByIdIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteNumberTypeByUNameIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@param	ScopeId	The NumberType key attribute of the instance generating the id.
	 */
	void deleteNumberTypeByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId );
	 ...
	 */
	void deleteNumberTypeByDefSchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteNumberTypeByPrevIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	void deleteNumberTypeByNextIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@param	PrevId	The NumberType key attribute of the instance generating the id.
	 */
	void deleteNumberTypeByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId,
		CFLibDbKeyHash256 argPrevId );
	 ...
	 *	@param	NextId	The NumberType key attribute of the instance generating the id.
	 */
	void deleteNumberTypeByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 argScopeId,
		CFLibDbKeyHash256 argNextId );
	 ...
	 */
	ICFBamNumberType readDerived( ICFSecAuthorization Authorization,
	 ...
	 *		no such existing key value.
	 */
	ICFBamNumberType lockDerived( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 */
	ICFBamNumberType[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 *		no such existing key value.
	 */
	ICFBamNumberType readDerivedByIdIdx( ICFSecAuthorization Authorization,
	 ...
	 *		no such existing key value.
	 */
	ICFBamNumberType readDerivedByUNameIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamNumberType[] readDerivedByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedByDefSchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedByPrevIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedByNextIdx( ICFSecAuthorization Authorization,
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@return An array of derived instances for the specified key, potentially with 0 elements in the set.
	 */
	ICFBamNumberType[] readDerivedBySchemaIdx( ICFSecAuthorization Authorization,
	 ...
	 */
	ICFBamNumberType readRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType lockRec( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PKey );
	 ...
	 */
	ICFBamNumberType[] readAllRec( ICFSecAuthorization Authorization );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType readRecByIdIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType readRecByUNameIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		String Name );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByScopeIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByDefSchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 DefSchemaId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByContPrevIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 PrevId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecByContNextIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 ScopeId,
		CFLibDbKeyHash256 NextId );
	 ...
	 *	@throws	CFLibNotSupportedException thrown by client-side implementations.
	 */
	ICFBamNumberType[] readRecBySchemaIdx( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 SchemaDefId );
	 ...
	 */
	ICFBamNumberType moveRecUp( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
	 ...
	 *	@return	The refreshed record after it has been moved
	 */
	ICFBamNumberType moveRecDown( ICFSecAuthorization Authorization,
		CFLibDbKeyHash256 Id,
		int revision );
}
