...
/*
 *	CFBamDbKeyHash128TypeTable database interface for DbKeyHash128Type has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
