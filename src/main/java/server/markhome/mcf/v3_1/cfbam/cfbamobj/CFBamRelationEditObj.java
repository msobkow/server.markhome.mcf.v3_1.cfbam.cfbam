// Description: Java 25 edit object instance implementation for CFBam Relation.
	...
	implements ICFBamRelationEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getRelationTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getOptionalLookupDefSchema( boolean forceRead ) {
		if( forceRead || ( optionalLookupDefSchema == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getRelationRec().getOptionalDefSchemaId() );
	...
	public void setOptionalLookupDefSchema( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setOptionalLookupDefSchema(value.getSchemaDefRec());
		}
		else {
			optionalLookupDefSchema = null;
			getRelationRec().setOptionalLookupDefSchema((ICFBamSchemaDef)null);
		}
		optionalLookupDefSchema = value;
	}
	...
	public ICFBamTableObj getRequiredContainerFromTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerFromTable == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getTableTableObj().readTableByIdIdx( getRelationRec().getRequiredTableId() );
	...
	public void setRequiredContainerFromTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setRequiredContainerFromTable(value.getTableRec());
		}
		requiredContainerFromTable = value;
	}
	...
	public ICFBamIndexObj getRequiredLookupFromIndex( boolean forceRead ) {
		if( forceRead || ( requiredLookupFromIndex == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamIndexObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getIndexTableObj().readIndexByIdIdx( getRelationRec().getRequiredFromIndexId() );
	...
	public void setRequiredLookupFromIndex( ICFBamIndexObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setRequiredLookupFromIndex(value.getIndexRec());
		}
		else {
			requiredLookupFromIndex = null;
			getRelationRec().setRequiredLookupFromIndex((ICFBamIndex)null);
		}
		requiredLookupFromIndex = value;
	}
	...
	public ICFBamTableObj getRequiredLookupToTable( boolean forceRead ) {
		if( forceRead || ( requiredLookupToTable == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getTableTableObj().readTableByIdIdx( getRelationRec().getRequiredToTableId() );
	...
	public void setRequiredLookupToTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setRequiredLookupToTable(value.getTableRec());
		}
		else {
			requiredLookupToTable = null;
			getRelationRec().setRequiredLookupToTable((ICFBamTable)null);
		}
		requiredLookupToTable = value;
	}
	...
	public ICFBamIndexObj getRequiredLookupToIndex( boolean forceRead ) {
		if( forceRead || ( requiredLookupToIndex == null ) ) {
			boolean anyMissing = false;
			if( ! anyMissing ) {
				ICFBamIndexObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getIndexTableObj().readIndexByIdIdx( getRelationRec().getRequiredToIndexId() );
	...
	public void setRequiredLookupToIndex( ICFBamIndexObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setRequiredLookupToIndex(value.getIndexRec());
		}
		else {
			requiredLookupToIndex = null;
			getRelationRec().setRequiredLookupToIndex((ICFBamIndex)null);
		}
		requiredLookupToIndex = value;
	}
	...
	public ICFBamRelationObj getOptionalLookupNarrowed( boolean forceRead ) {
		if( forceRead || ( optionalLookupNarrowed == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamRelationObj obj = ((ICFBamSchemaObj)getOrigAsRelation().getSchema()).getRelationTableObj().readRelationByIdIdx( getRelationRec().getOptionalNarrowedId() );
	...
	public void setOptionalLookupNarrowed( ICFBamRelationObj value ) {
		...
		if( value != null ) {
			...
			getRelationRec().setOptionalLookupNarrowed(value.getRelationRec());
		}
		else {
			optionalLookupNarrowed = null;
			getRelationRec().setOptionalLookupNarrowed((ICFBamRelation)null);
		}
		optionalLookupNarrowed = value;
	}
	...
	public void copyRecToOrig() {
		ICFBamRelation origRec = getOrigAsRelation().getRelationRec();
		ICFBamRelation myRec = getRelationRec();
		origRec.set( myRec );
	}
