	...
	implements ICFBamMimeTypeTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntMimeTypeObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntMimeTypeObj> allMimeType;
	...
	public CFBamMimeTypeTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntMimeTypeObj>();
		allMimeType = null;
	...
	public static int getBackingClassCode() {
		return( CFIntMimeTypeTableObj.getBackingClassCode() );
	}
	...
	@Override
	public ICFIntMimeTypeObj readMimeType( $implCommaIJavaOptAtomType$ pkey ) {
		return( readMimeType( pkey, false ) );
	}

	@Override
	public ICFIntMimeTypeObj readMimeType( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntMimeTypeObj readCachedMimeType( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntMimeTypeObj obj = null;
	...
	@Override
	public void deepDisposeMimeType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntMimeTypeObj lockMimeType( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntMimeTypeObj> readAllMimeType( boolean forceRead ) {
		...
		if( ( allMimeType == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntMimeTypeObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntMimeTypeObj>();
			allMimeType = map;
