	...
	implements ICFBamInt32DefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> allInt32Def;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamInt32DefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "Int32Def";
	public static String TABLE_DBNAME = "int32def";

	public CFBamInt32DefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj>();
		allInt32Def = null;
	...
	public ICFBamInt32DefObj realiseInt32Def( ICFBamInt32DefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamInt32DefObj readInt32Def( $implCommaIJavaOptAtomType$ pkey ) {
		return( readInt32Def( pkey, false ) );
	}

	@Override
	public ICFBamInt32DefObj readInt32Def( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamInt32DefObj readCachedInt32Def( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamInt32DefObj obj = null;
	...
	@Override
	public void deepDisposeInt32Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamInt32DefObj lockInt32Def( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamInt32DefObj> readAllInt32Def( boolean forceRead ) {
		...
		if( ( allInt32Def == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamInt32DefObj>();
			allInt32Def = map;
	...
	@Override
	public ICFBamInt32DefObj readInt32DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamInt32DefObj readInt32DefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamInt32DefObj readInt32DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamInt32DefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamInt32DefObj> readInt32DefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamInt32DefObj readCachedInt32DefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamInt32DefObj obj = null;
	...
	@Override
	public ICFBamInt32DefObj readCachedInt32DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamInt32DefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamInt32DefObj> readCachedInt32DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeInt32DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeInt32DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeInt32DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeInt32DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32DefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeInt32DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeInt32DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteInt32DefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteInt32DefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteInt32DefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteInt32DefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteInt32DefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteInt32DefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteInt32DefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteInt32DefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamInt32DefObj> dict = indexByContNextIdx.get( key );
