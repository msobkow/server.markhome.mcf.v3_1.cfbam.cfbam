// Description: Java 25 edit object instance implementation for CFBam FloatCol.
	...
	implements ICFBamFloatColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getFloatColTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsFloatCol().getSchema()).getTableTableObj().readTableByIdIdx( getFloatColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getFloatColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamFloatCol origRec = getOrigAsFloatCol().getFloatColRec();
		ICFBamFloatCol myRec = getFloatColRec();
		origRec.set( myRec );
	}
