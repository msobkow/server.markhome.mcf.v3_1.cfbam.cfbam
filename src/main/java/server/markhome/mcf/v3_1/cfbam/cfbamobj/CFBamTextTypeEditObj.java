// Description: Java 25 edit object instance implementation for CFBam TextType.
	...
	implements ICFBamTextTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTextTypeTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsTextType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getTextTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getTextTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamTextType origRec = getOrigAsTextType().getTextTypeRec();
		ICFBamTextType myRec = getTextTypeRec();
		origRec.set( myRec );
	}
