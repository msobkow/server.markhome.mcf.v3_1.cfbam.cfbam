	...
	implements ICFBamUInt64ColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> allUInt64Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUInt64ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByContNextIdx;
	private Map< ICFBamUInt64ColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "UInt64Col";
	public static String TABLE_DBNAME = "uint64col";

	public CFBamUInt64ColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj>();
		allUInt64Col = null;
	...
	public ICFBamUInt64ColObj realiseUInt64Col( ICFBamUInt64ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamUInt64ColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt64Col().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamUInt64ColObj readUInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
		return( readUInt64Col( pkey, false ) );
	}

	@Override
	public ICFBamUInt64ColObj readUInt64Col( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUInt64ColObj readCachedUInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamUInt64ColObj obj = null;
	...
	public void reallyDeepDisposeUInt64Col( ICFBamUInt64ColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamUInt64ColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt64Col().newByTableIdxKey();
	...
	@Override
	public void deepDisposeUInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamUInt64ColObj lockUInt64Col( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamUInt64ColObj> readAllUInt64Col( boolean forceRead ) {
		...
		if( ( allUInt64Col == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamUInt64ColObj>();
			allUInt64Col = map;
	...
	@Override
	public ICFBamUInt64ColObj readUInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamUInt64ColObj readUInt64ColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamUInt64ColObj readUInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamUInt64ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamUInt64ColObj> readUInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamUInt64ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt64Col().newByTableIdxKey();
	...
	@Override
	public ICFBamUInt64ColObj readCachedUInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamUInt64ColObj obj = null;
	...
	@Override
	public ICFBamUInt64ColObj readCachedUInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamUInt64ColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamUInt64ColObj> readCachedUInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeUInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeUInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeUInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteUInt64ColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteUInt64ColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteUInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteUInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamUInt64ColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryUInt64Col().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamUInt64ColObj> dict = indexByTableIdx.get( key );
