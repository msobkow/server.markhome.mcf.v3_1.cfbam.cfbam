	...
	implements ICFBamUInt64ColTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamUInt64ColObj> members;
	private Map<ICFLibKeyHash256, ICFBamUInt64ColObj> allUInt64Col;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamUInt64ColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByContNextIdx;
	private Map< ICFBamUInt64ColByTableIdxKey,
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj > > indexByTableIdx;
	public static String TABLE_NAME = "UInt64Col";
	public static String TABLE_DBNAME = "uint64col";

	public CFBamUInt64ColTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamUInt64ColObj>();
		allUInt64Col = null;
	...
	public ICFBamUInt64ColObj realiseUInt64Col( ICFBamUInt64ColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamUInt64ColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamUInt64ColObj readUInt64Col( ICFLibKeyHash256 pkey ) {
		return( readUInt64Col( pkey, false ) );
	}

	@Override
	public ICFBamUInt64ColObj readUInt64Col( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamUInt64ColObj readCachedUInt64Col( ICFLibKeyHash256 pkey ) {
		ICFBamUInt64ColObj obj = null;
	...
	@Override
	public void deepDisposeUInt64Col( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamUInt64ColObj lockUInt64Col( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamUInt64ColObj> readAllUInt64Col( boolean forceRead ) {
		...
		if( ( allUInt64Col == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> map = new HashMap<ICFLibKeyHash256,ICFBamUInt64ColObj>();
			allUInt64Col = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamUInt64ColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamUInt64ColObj>();
			ICFBamValueObj obj;
	...
	public void deleteUInt64ColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteUInt64ColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteUInt64ColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteUInt64ColByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteUInt64ColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamUInt64ColObj> dict = indexByTableIdx.get( key );
