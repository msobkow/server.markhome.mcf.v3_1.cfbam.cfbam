...
public class CFBamSecUserPWResetObj
	implements ICFBamSecUserPWResetObj
{
	...
	public CFBamSecUserPWResetObj() {
		isNew = true;
		requiredContainerUser = null;
	}

	public CFBamSecUserPWResetObj( ICFSecSchemaObj argSchema ) {
		schema = argSchema;
		isNew = true;
		edit = null;
		requiredContainerUser = null;
	...
	public ICFSecSecUserPWResetObj realise() {
		ICFSecSecUserPWResetObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().realiseSecUserPWReset(
	...
	@Override
	public void forget() {
		((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().reallyDeepDisposeSecUserPWReset( (ICFSecSecUserPWResetObj)this );
	}

	@Override
	public ICFSecSecUserPWResetObj read() {
		ICFSecSecUserPWResetObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().readSecUserPWResetByIdIdx( getPKey(), false );
		return( (ICFSecSecUserPWResetObj)retobj );
	}

	@Override
	public ICFSecSecUserPWResetObj read( boolean forceRead ) {
		ICFSecSecUserPWResetObj retobj = ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().readSecUserPWResetByIdIdx( getPKey(), forceRead );
		return( (ICFSecSecUserPWResetObj)retobj );
	}

	@Override
	public ICFSecSecUserPWResetTableObj getSecUserPWResetTable() {
		return( ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj() );
	}
	...
	public ICFSecSecUserPWReset getRec() {
		if( rec == null ) {
			if( isNew ) {
				...
				rec = getSchema().getCFSecBackingStore().getTableSecUserPWReset().readDerivedByIdIdx( ((ICFBamSchemaObj)getSchema()).getAuthorization(),
						getPKey() );
				if( rec != null ) {
					copyRecToPKey();
				}
	...
	public ICFSecSecUserPWResetEditObj beginEdit() {
		...
		if( getIsNew() ) {
			...
			lockobj = ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().lockSecUserPWReset( getPKey() );
		}
		edit = ((ICFBamSchemaObj)getSchema()).getSecUserPWResetTableObj().newEditInstance( lockobj );
