...
// Description: Java 25 Factory service implementation for DbKeyHash128Col buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash128Col buffers.
 */
@Service("cfbam31BuffDbKeyHash128ColFactoryService")
public class CFBamBuffDbKeyHash128ColFactoryService
	implements ICFBamDbKeyHash128ColFactory
{
	public CFBamBuffDbKeyHash128ColFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash128Col",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamDbKeyHash128Col");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash128Col",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamDbKeyHash128Col");
			}
		}
	}
