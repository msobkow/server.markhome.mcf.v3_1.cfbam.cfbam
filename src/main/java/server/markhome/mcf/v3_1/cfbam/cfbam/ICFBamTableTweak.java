// Description: Java 25 interface for a TableTweak record implementation
...
/**
 *	ICFBamTableTweak persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamTableTweak extends ICFBamTweak
{
