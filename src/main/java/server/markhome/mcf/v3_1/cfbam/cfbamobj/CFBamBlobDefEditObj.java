// Description: Java 25 edit object instance implementation for CFBam BlobDef.
	...
	implements ICFBamBlobDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getBlobDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsBlobDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryBlobDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamBlobDef origRec = getOrigAsBlobDef().getBlobDefRec();
		ICFBamBlobDef myRec = getBlobDefRec();
		origRec.set( myRec );
	}
