	...
	implements ICFBamTimeColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> allTimeCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTimeColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByContNextIdx;
	private Map< ICFBamTimeColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > > indexByTableIdx;
	public static String TABLE_NAME = "TimeCol";
	public static String TABLE_DBNAME = "tmcol";

	public CFBamTimeColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimeColObj>();
		allTimeCol = null;
	...
	public ICFBamTimeColObj realiseTimeCol( ICFBamTimeColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamTimeColObj readTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTimeCol( pkey, false ) );
	}

	@Override
	public ICFBamTimeColObj readTimeCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTimeColObj readCachedTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTimeColObj obj = null;
	...
	public void reallyDeepDisposeTimeCol( ICFBamTimeColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamTimeColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryTimeCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTimeColObj lockTimeCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTimeColObj> readAllTimeCol( boolean forceRead ) {
		...
		if( ( allTimeCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTimeColObj>();
			allTimeCol = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTimeColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimeColObj>();
			ICFBamValueObj obj;
	...
	public void deleteTimeColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteTimeColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteTimeColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteTimeColByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteTimeColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimeColObj> dict = indexByTableIdx.get( key );
