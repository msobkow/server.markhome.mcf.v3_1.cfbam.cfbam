// Description: Java 25 interface for a SchemaRef history object
...
/**
 *	ICFBamSchemaRefH provides access to history records matching the CFBamSchemaRef object change history.
 */
public interface ICFBamSchemaRefH extends ICFBamScopeH
{
