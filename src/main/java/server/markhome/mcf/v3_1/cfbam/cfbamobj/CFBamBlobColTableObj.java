	...
	implements ICFBamBlobColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> allBlobCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamBlobColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByContNextIdx;
	private Map< ICFBamBlobColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > > indexByTableIdx;
	public static String TABLE_NAME = "BlobCol";
	public static String TABLE_DBNAME = "blbcol";

	public CFBamBlobColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamBlobColObj>();
		allBlobCol = null;
	...
	public ICFBamBlobColObj realiseBlobCol( ICFBamBlobColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamBlobColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamBlobColObj readBlobCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readBlobCol( pkey, false ) );
	}

	@Override
	public ICFBamBlobColObj readBlobCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamBlobColObj readCachedBlobCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamBlobColObj obj = null;
	...
	public void reallyDeepDisposeBlobCol( ICFBamBlobColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamBlobColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeBlobCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamBlobColObj lockBlobCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamBlobColObj> readAllBlobCol( boolean forceRead ) {
		...
		if( ( allBlobCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamBlobColObj>();
			allBlobCol = map;
	...
	@Override
	public ICFBamBlobColObj readBlobColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamBlobColObj readBlobColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamBlobColObj readBlobColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamBlobColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamBlobColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamBlobColObj> readBlobColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamBlobColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
	...
	@Override
	public ICFBamBlobColObj readCachedBlobColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamBlobColObj obj = null;
	...
	@Override
	public ICFBamBlobColObj readCachedBlobColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamBlobColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBlobColObj> readCachedBlobColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeBlobColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeBlobColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeBlobColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeBlobColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeBlobColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeBlobColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeBlobColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeBlobColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeBlobColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteBlobColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteBlobColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteBlobColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteBlobColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteBlobColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteBlobColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteBlobColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteBlobColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteBlobColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamBlobColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBlobCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBlobColObj> dict = indexByTableIdx.get( key );
