// Description: Java 25 edit object instance implementation for CFBam TextCol.
	...
	implements ICFBamTextColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getTextColTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsTextCol().getSchema()).getTableTableObj().readTableByIdIdx( getTextColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getTextColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamTextCol origRec = getOrigAsTextCol().getTextColRec();
		ICFBamTextCol myRec = getTextColRec();
		origRec.set( myRec );
	}
