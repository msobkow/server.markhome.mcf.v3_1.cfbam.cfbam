// Description: Java 25 interface for a Int64Type record implementation
...
/**
 *	ICFBamInt64Type persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamInt64Type extends ICFBamInt64Def
{
