// Description: Java 25 interface for a ClearTopDep record implementation
...
/**
 *	ICFBamClearTopDep persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamClearTopDep extends ICFBamClearDep
{
