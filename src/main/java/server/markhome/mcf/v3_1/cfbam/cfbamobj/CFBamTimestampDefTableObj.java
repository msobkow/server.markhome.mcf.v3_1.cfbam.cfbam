	...
	implements ICFBamTimestampDefTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamTimestampDefObj> members;
	private Map<ICFLibKeyHash256, ICFBamTimestampDefObj> allTimestampDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTimestampDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "TimestampDef";
	public static String TABLE_DBNAME = "tsdef";

	public CFBamTimestampDefTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamTimestampDefObj>();
	...
	public ICFBamTimestampDefObj realiseTimestampDef( ICFBamTimestampDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamTimestampDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamTimestampDefObj readTimestampDef( ICFLibKeyHash256 pkey ) {
		return( readTimestampDef( pkey, false ) );
	}

	@Override
	public ICFBamTimestampDefObj readTimestampDef( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTimestampDefObj readCachedTimestampDef( ICFLibKeyHash256 pkey ) {
		ICFBamTimestampDefObj obj = null;
	...
	@Override
	public void deepDisposeTimestampDef( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamTimestampDefObj lockTimestampDef( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamTimestampDefObj> readAllTimestampDef( boolean forceRead ) {
		...
		if( ( allTimestampDef == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> map = new HashMap<ICFLibKeyHash256,ICFBamTimestampDefObj>();
			allTimestampDef = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamTimestampDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamTimestampDefObj>();
			ICFBamValueObj obj;
	...
	public void deleteTimestampDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteTimestampDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteTimestampDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteTimestampDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamTimestampDefObj> dict = indexByContNextIdx.get( key );
