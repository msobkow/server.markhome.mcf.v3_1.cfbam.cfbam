	...
	implements ICFBamTimestampDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> allTimestampDef;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamTimestampDefObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > > indexByContNextIdx;
	public static String TABLE_NAME = "TimestampDef";
	public static String TABLE_DBNAME = "tsdef";

	public CFBamTimestampDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj>();
	...
	public ICFBamTimestampDefObj realiseTimestampDef( ICFBamTimestampDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
	...
	@Override
	public ICFBamTimestampDefObj readTimestampDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readTimestampDef( pkey, false ) );
	}

	@Override
	public ICFBamTimestampDefObj readTimestampDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamTimestampDefObj readCachedTimestampDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamTimestampDefObj obj = null;
	...
	@Override
	public void deepDisposeTimestampDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamTimestampDefObj lockTimestampDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamTimestampDefObj> readAllTimestampDef( boolean forceRead ) {
		...
		if( ( allTimestampDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamTimestampDefObj>();
			allTimestampDef = map;
	...
	@Override
	public ICFBamTimestampDefObj readTimestampDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamTimestampDefObj readTimestampDefByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamTimestampDefObj readTimestampDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamTimestampDefObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamTimestampDefObj> readTimestampDefByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public ICFBamTimestampDefObj readCachedTimestampDefByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamTimestampDefObj obj = null;
	...
	@Override
	public ICFBamTimestampDefObj readCachedTimestampDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamTimestampDefObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamTimestampDefObj> readCachedTimestampDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeTimestampDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeTimestampDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeTimestampDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deleteTimestampDefByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteTimestampDefByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteTimestampDefByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteTimestampDefByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteTimestampDefByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteTimestampDefByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteTimestampDefByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteTimestampDefByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamTimestampDefObj> dict = indexByContNextIdx.get( key );
