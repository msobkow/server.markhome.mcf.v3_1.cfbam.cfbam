	...
	implements ICFBamLicenseTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> allLicense;
	private Map< ICFIntLicenseByLicnTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj > > indexByLicnTenantIdx;
	private Map< ICFIntLicenseByDomainIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj > > indexByDomainIdx;
	...
	public CFBamLicenseTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntLicenseObj>();
		allLicense = null;
	...
	public static int getBackingClassCode() {
		return( CFIntLicenseTableObj.getBackingClassCode() );
	}
	...
	public ICFIntLicenseObj realiseLicense( ICFIntLicenseObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByLicnTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj > mapLicnTenantIdx = indexByLicnTenantIdx.get( keyLicnTenantIdx );
			...
			if( indexByDomainIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj > mapDomainIdx = indexByDomainIdx.get( keyDomainIdx );
	...
	@Override
	public ICFIntLicenseObj readLicense( $implCommaIJavaOptAtomType$ pkey ) {
		return( readLicense( pkey, false ) );
	}

	@Override
	public ICFIntLicenseObj readLicense( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntLicenseObj readCachedLicense( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntLicenseObj obj = null;
	...
	@Override
	public void deepDisposeLicense( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntLicenseObj lockLicense( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntLicenseObj> readAllLicense( boolean forceRead ) {
		...
		if( ( allLicense == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntLicenseObj>();
			allLicense = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> dict;
		if( indexByLicnTenantIdx == null ) {
			indexByLicnTenantIdx = new HashMap< ICFIntLicenseByLicnTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFIntLicenseObj > >();
		}
		if( ( ! forceRead ) && indexByLicnTenantIdx.containsKey( key ) ) {
			dict = indexByLicnTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFIntLicenseObj>();
			ICFIntLicenseObj obj;
	...
	public void deleteLicenseByLicnTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByLicnTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> dict = indexByLicnTenantIdx.get( key );
	...
	public void deleteLicenseByDomainIdx( ICFLibKeyHash256 TopDomainId )
	{
		...
		if( indexByDomainIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntLicenseObj> dict = indexByDomainIdx.get( key );
