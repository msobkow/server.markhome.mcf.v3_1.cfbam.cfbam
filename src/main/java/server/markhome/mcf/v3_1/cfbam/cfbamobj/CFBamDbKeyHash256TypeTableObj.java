	...
	implements ICFBamDbKeyHash256TypeTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> members;
	private Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> allDbKeyHash256Type;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamDbKeyHash256TypeObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexByContNextIdx;
	private Map< ICFBamDbKeyHash256TypeBySchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > > indexBySchemaIdx;
	...
	public CFBamDbKeyHash256TypeTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj>();
	...
	public ICFBamDbKeyHash256TypeObj realiseDbKeyHash256Type( ICFBamDbKeyHash256TypeObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexBySchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > mapSchemaIdx = indexBySchemaIdx.get( keySchemaIdx );
	...
	@Override
	public ICFBamDbKeyHash256TypeObj readDbKeyHash256Type( ICFLibKeyHash256 pkey ) {
		return( readDbKeyHash256Type( pkey, false ) );
	}

	@Override
	public ICFBamDbKeyHash256TypeObj readDbKeyHash256Type( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamDbKeyHash256TypeObj readCachedDbKeyHash256Type( ICFLibKeyHash256 pkey ) {
		ICFBamDbKeyHash256TypeObj obj = null;
	...
	@Override
	public void deepDisposeDbKeyHash256Type( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamDbKeyHash256TypeObj lockDbKeyHash256Type( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamDbKeyHash256TypeObj> readAllDbKeyHash256Type( boolean forceRead ) {
		...
		if( ( allDbKeyHash256Type == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> map = new HashMap<ICFLibKeyHash256,ICFBamDbKeyHash256TypeObj>();
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj>();
			ICFBamValueObj obj;
	...
	public void deleteDbKeyHash256TypeByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteDbKeyHash256TypeByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteDbKeyHash256TypeByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteDbKeyHash256TypeByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteDbKeyHash256TypeBySchemaIdx( ICFLibKeyHash256 SchemaDefId )
	{
		...
		if( indexBySchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamDbKeyHash256TypeObj> dict = indexBySchemaIdx.get( key );
