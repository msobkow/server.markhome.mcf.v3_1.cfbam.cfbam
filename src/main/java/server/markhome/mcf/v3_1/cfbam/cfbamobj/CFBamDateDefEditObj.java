// Description: Java 25 edit object instance implementation for CFBam DateDef.
	...
	implements ICFBamDateDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDateDefTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDateDef().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDateDef().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public void copyRecToOrig() {
		ICFBamDateDef origRec = getOrigAsDateDef().getDateDefRec();
		ICFBamDateDef myRec = getDateDefRec();
		origRec.set( myRec );
	}
