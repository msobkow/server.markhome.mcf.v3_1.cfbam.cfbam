	...
	implements ICFBamNmTokensColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> allNmTokensCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamNmTokensColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByContNextIdx;
	private Map< ICFBamNmTokensColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > > indexByTableIdx;
	public static String TABLE_NAME = "NmTokensCol";
	public static String TABLE_DBNAME = "nmtknscol";

	public CFBamNmTokensColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj>();
		allNmTokensCol = null;
	...
	public ICFBamNmTokensColObj realiseNmTokensCol( ICFBamNmTokensColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamNmTokensColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamNmTokensColObj readNmTokensCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readNmTokensCol( pkey, false ) );
	}

	@Override
	public ICFBamNmTokensColObj readNmTokensCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamNmTokensColObj readCachedNmTokensCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamNmTokensColObj obj = null;
	...
	public void reallyDeepDisposeNmTokensCol( ICFBamNmTokensColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamNmTokensColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeNmTokensCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamNmTokensColObj lockNmTokensCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamNmTokensColObj> readAllNmTokensCol( boolean forceRead ) {
		...
		if( ( allNmTokensCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamNmTokensColObj>();
			allNmTokensCol = map;
	...
	@Override
	public ICFBamNmTokensColObj readNmTokensColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamNmTokensColObj readNmTokensColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamNmTokensColObj readNmTokensColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamNmTokensColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamNmTokensColObj> readNmTokensColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamNmTokensColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
	...
	@Override
	public ICFBamNmTokensColObj readCachedNmTokensColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamNmTokensColObj obj = null;
	...
	@Override
	public ICFBamNmTokensColObj readCachedNmTokensColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamNmTokensColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamNmTokensColObj> readCachedNmTokensColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeNmTokensColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeNmTokensColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeNmTokensColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteNmTokensColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteNmTokensColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteNmTokensColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteNmTokensColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamNmTokensColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryNmTokensCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamNmTokensColObj> dict = indexByTableIdx.get( key );
