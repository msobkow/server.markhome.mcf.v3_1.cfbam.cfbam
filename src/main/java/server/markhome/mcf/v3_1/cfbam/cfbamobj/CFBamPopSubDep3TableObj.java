	...
	implements ICFBamPopSubDep3TableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> allPopSubDep3;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > > indexByTenantIdx;
	private Map< ICFBamPopDepByRelationIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > > indexByRelationIdx;
	private Map< ICFBamPopDepByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > > indexByDefSchemaIdx;
	private Map< ICFBamPopSubDep3ByPopSubDep2IdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > > indexByPopSubDep2Idx;
	...
	public CFBamPopSubDep3TableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj>();
		allPopSubDep3 = null;
	...
	public ICFBamPopSubDep3Obj realisePopSubDep3( ICFBamPopSubDep3Obj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByRelationIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > mapRelationIdx = indexByRelationIdx.get( keyRelationIdx );
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPopSubDep2Idx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > mapPopSubDep2Idx = indexByPopSubDep2Idx.get( keyPopSubDep2Idx );
			...
			if( indexByUNameIdx != null ) {
				ICFBamPopSubDep3ByUNameIdxKey keyUNameIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep3().newByUNameIdxKey();
	...
	@Override
	public ICFBamPopSubDep3Obj readPopSubDep3( $implCommaIJavaOptAtomType$ pkey ) {
		return( readPopSubDep3( pkey, false ) );
	}

	@Override
	public ICFBamPopSubDep3Obj readPopSubDep3( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamPopSubDep3Obj readCachedPopSubDep3( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamPopSubDep3Obj obj = null;
	...
	public void reallyDeepDisposePopSubDep3( ICFBamPopSubDep3Obj obj )
	{
		...
		members.remove( pkey );
		ICFBamPopSubDep3ByPopSubDep2IdxKey keyPopSubDep2Idx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep3().newByPopSubDep2IdxKey();
		keyPopSubDep2Idx.setRequiredPopSubDep2Id( existing.getRequiredPopSubDep2Id() );

		ICFBamPopSubDep3ByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep3().newByUNameIdxKey();
	...
	@Override
	public void deepDisposePopSubDep3( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamPopSubDep3Obj lockPopSubDep3( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamPopSubDep3Obj> readAllPopSubDep3( boolean forceRead ) {
		...
		if( ( allPopSubDep3 == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamPopSubDep3Obj>();
			allPopSubDep3 = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj>();
			ICFBamScopeObj obj;
		...
		String Name, boolean forceRead )
	{
		...
		ICFBamPopSubDep3ByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryPopSubDep3().newByUNameIdxKey();
		key.setRequiredPopSubDep2Id( PopSubDep2Id );
	...
	public void deletePopSubDep3ByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> dict = indexByTenantIdx.get( key );
	...
	public void deletePopSubDep3ByRelationIdx( ICFLibKeyHash256 RelationId )
	{
		...
		if( indexByRelationIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> dict = indexByRelationIdx.get( key );
	...
	public void deletePopSubDep3ByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deletePopSubDep3ByPopSubDep2Idx( ICFLibKeyHash256 PopSubDep2Id )
	{
		...
		if( indexByPopSubDep2Idx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamPopSubDep3Obj> dict = indexByPopSubDep2Idx.get( key );
