// Description: Java 25 edit object instance implementation for CFBam BoolType.
	...
	implements ICFBamBoolTypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getBoolTypeTableObj().getClassCode() );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsBoolType().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getBoolTypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		...
		if( value != null ) {
			...
			getBoolTypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamBoolType origRec = getOrigAsBoolType().getBoolTypeRec();
		ICFBamBoolType myRec = getBoolTypeRec();
		origRec.set( myRec );
	}
