...
// Description: Java 25 Factory service implementation for Index buffers
...
/*
 *	Java 25 Factory service implementation for Index buffers.
 */
@Service("cfbam31BuffIndexFactoryService")
public class CFBamBuffIndexFactoryService
	implements ICFBamIndexFactory
{
	public CFBamBuffIndexFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamIndex",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamIndex");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamIndex",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamIndex");
			}
		}
	}
