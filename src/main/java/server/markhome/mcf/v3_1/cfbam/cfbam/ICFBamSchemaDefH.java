// Description: Java 25 interface for a SchemaDef history object
...
/**
 *	ICFBamSchemaDefH provides access to history records matching the CFBamSchemaDef object change history.
 */
public interface ICFBamSchemaDefH extends ICFBamScopeH
{
