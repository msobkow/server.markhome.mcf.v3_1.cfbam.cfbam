...
// Description: Java 25 Factory service implementation for Id64Gen buffers
...
/*
 *	Java 25 Factory service implementation for Id64Gen buffers.
 */
@Service("cfbam31BuffId64GenFactoryService")
public class CFBamBuffId64GenFactoryService
	implements ICFBamId64GenFactory
{
	public CFBamBuffId64GenFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamId64Gen",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamId64Gen");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamId64Gen",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamId64Gen");
			}
		}
	}
