...
/*
 *	CFBamDbKeyHash512GenTable database interface for DbKeyHash512Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
