	...
	implements ICFBamBoolColTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> allBoolCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamBoolColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByContNextIdx;
	private Map< ICFBamBoolColByTableIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > > indexByTableIdx;
	public static String TABLE_NAME = "BoolCol";
	public static String TABLE_DBNAME = "boolcol";

	public CFBamBoolColTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamBoolColObj>();
		allBoolCol = null;
	...
	public ICFBamBoolColObj realiseBoolCol( ICFBamBoolColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				ICFBamBoolColByTableIdxKey keyTableIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
				keyTableIdx.setRequiredTableId( keepObj.getRequiredTableId() );
				Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamBoolColObj readBoolCol( $implCommaIJavaOptAtomType$ pkey ) {
		return( readBoolCol( pkey, false ) );
	}

	@Override
	public ICFBamBoolColObj readBoolCol( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamBoolColObj readCachedBoolCol( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamBoolColObj obj = null;
	...
	public void reallyDeepDisposeBoolCol( ICFBamBoolColObj obj )
	{
		...
		members.remove( pkey );
		ICFBamBoolColByTableIdxKey keyTableIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
	...
	@Override
	public void deepDisposeBoolCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamBoolColObj lockBoolCol( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamBoolColObj> readAllBoolCol( boolean forceRead ) {
		...
		if( ( allBoolCol == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamBoolColObj>();
			allBoolCol = map;
	...
	@Override
	public ICFBamBoolColObj readBoolColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public ICFBamBoolColObj readBoolColByIdIdx( ICFLibKeyHash256 Id, boolean forceRead )
	{
	...
	@Override
	public ICFBamBoolColObj readBoolColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamBoolColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamBoolColObj>();
			ICFBamValueObj obj;
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByContPrevIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByContNextIdx( ICFLibKeyHash256 ScopeId,
	...
	@Override
	public List<ICFBamBoolColObj> readBoolColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		boolean forceRead )
	{
		...
		ICFBamBoolColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
	...
	@Override
	public ICFBamBoolColObj readCachedBoolColByIdIdx( ICFLibKeyHash256 Id )
	{
		ICFBamBoolColObj obj = null;
	...
	@Override
	public ICFBamBoolColObj readCachedBoolColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		ICFBamBoolColObj obj = null;
		ICFBamValueByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByUNameIdxKey();
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public List<ICFBamBoolColObj> readCachedBoolColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deepDisposeBoolColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deepDisposeBoolColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
	...
	@Override
	public void deepDisposeBoolColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
	...
	@Override
	public void deepDisposeBoolColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
	...
	@Override
	public void deepDisposeBoolColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeBoolColByNextIdx( ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeBoolColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
	...
	@Override
	public void deepDisposeBoolColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
	...
	@Override
	public void deepDisposeBoolColByTableIdx( ICFLibKeyHash256 TableId )
	{
	...
	@Override
	public void deleteBoolColByIdIdx( ICFLibKeyHash256 Id )
	{
	...
	@Override
	public void deleteBoolColByUNameIdx( ICFLibKeyHash256 ScopeId,
		String Name )
	{
		if( indexByUNameIdx == null ) {
			indexByUNameIdx = new HashMap< ICFBamValueByUNameIdxKey,
	...
	@Override
	public void deleteBoolColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		ICFBamValueByScopeIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByScopeIdxKey();
		key.setRequiredScopeId( ScopeId );
		if( indexByScopeIdx == null ) {
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByScopeIdx.get( key );
	...
	@Override
	public void deleteBoolColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		ICFBamValueByDefSchemaIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByDefSchemaIdxKey();
		key.setOptionalDefSchemaId( DefSchemaId );
		if( indexByDefSchemaIdx == null ) {
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByDefSchemaIdx.get( key );
	...
	@Override
	public void deleteBoolColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByPrevIdxKey();
		key.setOptionalPrevId( PrevId );
		if( indexByPrevIdx == null ) {
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByPrevIdx.get( key );
	...
	@Override
	public void deleteBoolColByNextIdx( ICFLibKeyHash256 NextId )
	{
		ICFBamValueByNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByNextIdxKey();
		key.setOptionalNextId( NextId );
		if( indexByNextIdx == null ) {
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByNextIdx.get( key );
	...
	@Override
	public void deleteBoolColByContPrevIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 PrevId )
	{
		ICFBamValueByContPrevIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContPrevIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByContPrevIdx.get( key );
	...
	@Override
	public void deleteBoolColByContNextIdx( ICFLibKeyHash256 ScopeId,
		ICFLibKeyHash256 NextId )
	{
		ICFBamValueByContNextIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryValue().newByContNextIdxKey();
		key.setRequiredScopeId( ScopeId );
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByContNextIdx.get( key );
	...
	@Override
	public void deleteBoolColByTableIdx( ICFLibKeyHash256 TableId )
	{
		ICFBamBoolColByTableIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactoryBoolCol().newByTableIdxKey();
		key.setRequiredTableId( TableId );
		if( indexByTableIdx == null ) {
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamBoolColObj> dict = indexByTableIdx.get( key );
