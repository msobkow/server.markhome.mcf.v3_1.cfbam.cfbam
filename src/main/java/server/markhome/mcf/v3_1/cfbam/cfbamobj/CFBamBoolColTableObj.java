	...
	implements ICFBamBoolColTableObj
{
	...
	private Map<ICFLibKeyHash256, ICFBamBoolColObj> members;
	private Map<ICFLibKeyHash256, ICFBamBoolColObj> allBoolCol;
	private Map< ICFBamValueByUNameIdxKey,
		ICFBamBoolColObj > indexByUNameIdx;
	private Map< ICFBamValueByScopeIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByScopeIdx;
	private Map< ICFBamValueByDefSchemaIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByDefSchemaIdx;
	private Map< ICFBamValueByPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByPrevIdx;
	private Map< ICFBamValueByNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByNextIdx;
	private Map< ICFBamValueByContPrevIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByContPrevIdx;
	private Map< ICFBamValueByContNextIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByContNextIdx;
	private Map< ICFBamBoolColByTableIdxKey,
		Map<ICFLibKeyHash256, ICFBamBoolColObj > > indexByTableIdx;
	public static String TABLE_NAME = "BoolCol";
	public static String TABLE_DBNAME = "boolcol";

	public CFBamBoolColTableObj() {
		schema = null;
		members = new HashMap<ICFLibKeyHash256, ICFBamBoolColObj>();
		allBoolCol = null;
	...
	public ICFBamBoolColObj realiseBoolCol( ICFBamBoolColObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByScopeIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapScopeIdx = indexByScopeIdx.get( keyScopeIdx );
				if( mapScopeIdx != null ) {
			...
			if( indexByDefSchemaIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapDefSchemaIdx = indexByDefSchemaIdx.get( keyDefSchemaIdx );
			...
			if( indexByPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapPrevIdx = indexByPrevIdx.get( keyPrevIdx );
				if( mapPrevIdx != null ) {
			...
			if( indexByNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapNextIdx = indexByNextIdx.get( keyNextIdx );
				if( mapNextIdx != null ) {
			...
			if( indexByContPrevIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapContPrevIdx = indexByContPrevIdx.get( keyContPrevIdx );
			...
			if( indexByContNextIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapContNextIdx = indexByContNextIdx.get( keyContNextIdx );
			...
			if( indexByTableIdx != null ) {
				...
				Map<ICFLibKeyHash256, ICFBamBoolColObj > mapTableIdx = indexByTableIdx.get( keyTableIdx );
				if( mapTableIdx != null ) {
	...
	@Override
	public ICFBamBoolColObj readBoolCol( ICFLibKeyHash256 pkey ) {
		return( readBoolCol( pkey, false ) );
	}

	@Override
	public ICFBamBoolColObj readBoolCol( ICFLibKeyHash256 pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamBoolColObj readCachedBoolCol( ICFLibKeyHash256 pkey ) {
		ICFBamBoolColObj obj = null;
	...
	@Override
	public void deepDisposeBoolCol( ICFLibKeyHash256 pkey ) {
	...
	@Override
	public ICFBamBoolColObj lockBoolCol( ICFLibKeyHash256 pkey ) {
	...
	public List<ICFBamBoolColObj> readAllBoolCol( boolean forceRead ) {
		...
		if( ( allBoolCol == null ) || forceRead ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> map = new HashMap<ICFLibKeyHash256,ICFBamBoolColObj>();
			allBoolCol = map;
		...
		boolean forceRead )
	{
		...
		key.setRequiredScopeId( ScopeId );
		Map<ICFLibKeyHash256, ICFBamBoolColObj> dict;
		if( indexByScopeIdx == null ) {
			indexByScopeIdx = new HashMap< ICFBamValueByScopeIdxKey,
				Map< ICFLibKeyHash256, ICFBamBoolColObj > >();
		}
		if( ( ! forceRead ) && indexByScopeIdx.containsKey( key ) ) {
			dict = indexByScopeIdx.get( key );
		}
		else {
			dict = new HashMap<ICFLibKeyHash256, ICFBamBoolColObj>();
			ICFBamValueObj obj;
	...
	public void deleteBoolColByScopeIdx( ICFLibKeyHash256 ScopeId )
	{
		...
		if( indexByScopeIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByScopeIdx.get( key );
	...
	public void deleteBoolColByDefSchemaIdx( ICFLibKeyHash256 DefSchemaId )
	{
		...
		if( indexByDefSchemaIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByDefSchemaIdx.get( key );
	...
	public void deleteBoolColByPrevIdx( ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByPrevIdx.get( key );
	...
	public void deleteBoolColByNextIdx( ICFLibKeyHash256 NextId )
	{
		...
		if( indexByNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByNextIdx.get( key );
		...
		ICFLibKeyHash256 PrevId )
	{
		...
		if( indexByContPrevIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByContPrevIdx.get( key );
		...
		ICFLibKeyHash256 NextId )
	{
		...
		if( indexByContNextIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByContNextIdx.get( key );
	...
	public void deleteBoolColByTableIdx( ICFLibKeyHash256 TableId )
	{
		...
		if( indexByTableIdx.containsKey( key ) ) {
			Map<ICFLibKeyHash256, ICFBamBoolColObj> dict = indexByTableIdx.get( key );
