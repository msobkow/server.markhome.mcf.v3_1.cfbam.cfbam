	...
	implements ICFBamMinorVersionTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> allMinorVersion;
	private Map< ICFIntMinorVersionByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj > > indexByTenantIdx;
	private Map< ICFIntMinorVersionByMajorVerIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj > > indexByMajorVerIdx;
	...
	public CFBamMinorVersionTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj>();
	...
	public static int getBackingClassCode() {
		return( CFIntMinorVersionTableObj.getBackingClassCode() );
	}
	...
	public ICFIntMinorVersionObj realiseMinorVersion( ICFIntMinorVersionObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByMajorVerIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj > mapMajorVerIdx = indexByMajorVerIdx.get( keyMajorVerIdx );
	...
	@Override
	public ICFIntMinorVersionObj readMinorVersion( $implCommaIJavaOptAtomType$ pkey ) {
		return( readMinorVersion( pkey, false ) );
	}

	@Override
	public ICFIntMinorVersionObj readMinorVersion( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFIntMinorVersionObj readCachedMinorVersion( $implCommaIJavaOptAtomType$ pkey ) {
		ICFIntMinorVersionObj obj = null;
	...
	public void reallyDeepDisposeMinorVersion( ICFIntMinorVersionObj obj )
	{
		...
		keyNameIdx.setRequiredName( existing.getRequiredName() );
					...
					schema.getSchemaDefTableObj().deepDisposeSchemaDefByMinorVersionIdx( existing.getRequiredId() );
	...
	@Override
	public void deepDisposeMinorVersion( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFIntMinorVersionObj lockMinorVersion( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFIntMinorVersionObj> readAllMinorVersion( boolean forceRead ) {
		...
		if( ( allMinorVersion == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFIntMinorVersionObj>();
			allMinorVersion = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFIntMinorVersionByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFIntMinorVersionObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj>();
			ICFIntMinorVersionObj obj;
	...
	public void deleteMinorVersionByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> dict = indexByTenantIdx.get( key );
	...
	public void deleteMinorVersionByMajorVerIdx( ICFLibKeyHash256 MajorVersionId )
	{
		...
		if( indexByMajorVerIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFIntMinorVersionObj> dict = indexByMajorVerIdx.get( key );
