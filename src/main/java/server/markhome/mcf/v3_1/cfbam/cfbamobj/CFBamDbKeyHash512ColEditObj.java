// Description: Java 25 edit object instance implementation for CFBam DbKeyHash512Col.
	...
	implements ICFBamDbKeyHash512ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash512ColTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash512Col().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash512Col().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsDbKeyHash512Col().getSchema()).getTableTableObj().readTableByIdIdx( getDbKeyHash512ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		if( rec == null ) {
			getDbKeyHash512ColRec();
		}
		if( value != null ) {
			requiredContainerTable = value;
			getDbKeyHash512ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamDbKeyHash512Col origRec = getOrigAsDbKeyHash512Col().getDbKeyHash512ColRec();
		ICFBamDbKeyHash512Col myRec = getDbKeyHash512ColRec();
		origRec.set( myRec );
	}
