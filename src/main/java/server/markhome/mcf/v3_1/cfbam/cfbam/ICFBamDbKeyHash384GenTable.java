...
/*
 *	CFBamDbKeyHash384GenTable database interface for DbKeyHash384Gen has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
