// Description: Java 25 edit object instance implementation for CFBam UInt64Col.
	...
	implements ICFBamUInt64ColEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getUInt64ColTableObj().getClassCode() );
	}
	...
	public ICFBamTableObj getRequiredContainerTable( boolean forceRead ) {
		if( forceRead || ( requiredContainerTable == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamTableObj obj = ((ICFBamSchemaObj)getOrigAsUInt64Col().getSchema()).getTableTableObj().readTableByIdIdx( getUInt64ColRec().getRequiredTableId() );
	...
	public void setRequiredContainerTable( ICFBamTableObj value ) {
		...
		if( value != null ) {
			...
			getUInt64ColRec().setRequiredContainerTable(value.getTableRec());
		}
		requiredContainerTable = value;
	...
	public void copyRecToOrig() {
		ICFBamUInt64Col origRec = getOrigAsUInt64Col().getUInt64ColRec();
		ICFBamUInt64Col myRec = getUInt64ColRec();
		origRec.set( myRec );
	}
