...
public interface ICFBamTable extends ICFBamScope
{
	...
	public static final String S_PRIMARYINDEXID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	...
	public static final String S_LOOKUPINDEXID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	public static final CFLibDbKeyHash256 LOOKUPINDEXID_INIT_VALUE = CFLibDbKeyHash256.fromHex( S_LOOKUPINDEXID_INIT_VALUE );
	public static final String S_ALTINDEXID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
	public static final CFLibDbKeyHash256 ALTINDEXID_INIT_VALUE = CFLibDbKeyHash256.fromHex( S_ALTINDEXID_INIT_VALUE );
	public static final String S_QUALIFYINGTABLEID_INIT_VALUE = "$switch HasInitValue yes InitValue default Zero256bits$";
