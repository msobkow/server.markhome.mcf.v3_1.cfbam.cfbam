	...
	implements ICFBamSchemaDefTableObj
{
	...
	private Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> members;
	private Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> allSchemaDef;
	private Map< ICFBamScopeByTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > > indexByTenantIdx;
	private Map< ICFBamSchemaDefByCTenantIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > > indexByCTenantIdx;
	private Map< ICFBamSchemaDefByMinorVersionIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > > indexByMinorVersionIdx;
	private Map< ICFBamSchemaDefByUNameIdxKey,
		ICFBamSchemaDefObj > indexByUNameIdx;
	private Map< ICFBamSchemaDefByAuthEMailIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > > indexByAuthEMailIdx;
	private Map< ICFBamSchemaDefByProjectURLIdxKey,
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > > indexByProjectURLIdx;
	...
	public CFBamSchemaDefTableObj() {
		schema = null;
		members = new HashMap<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj>();
		allSchemaDef = null;
	...
	public ICFBamSchemaDefObj realiseSchemaDef( ICFBamSchemaDefObj Obj ) {
		...
		if( members.containsKey( pkey ) && ( null != members.get( pkey ) ) ) {
			...
			if( indexByTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > mapTenantIdx = indexByTenantIdx.get( keyTenantIdx );
			...
			if( indexByCTenantIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > mapCTenantIdx = indexByCTenantIdx.get( keyCTenantIdx );
			...
			if( indexByMinorVersionIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > mapMinorVersionIdx = indexByMinorVersionIdx.get( keyMinorVersionIdx );
			...
			if( indexByUNameIdx != null ) {
				ICFBamSchemaDefByUNameIdxKey keyUNameIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByUNameIdxKey();
			...
			if( indexByAuthEMailIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > mapAuthEMailIdx = indexByAuthEMailIdx.get( keyAuthEMailIdx );
			...
			if( indexByProjectURLIdx != null ) {
				...
				Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > mapProjectURLIdx = indexByProjectURLIdx.get( keyProjectURLIdx );
			...
			if( indexByPubURIIdx != null ) {
				ICFBamSchemaDefByPubURIIdxKey keyPubURIIdx =
					schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByPubURIIdxKey();
	...
	@Override
	public ICFBamSchemaDefObj readSchemaDef( $implCommaIJavaOptAtomType$ pkey ) {
		return( readSchemaDef( pkey, false ) );
	}

	@Override
	public ICFBamSchemaDefObj readSchemaDef( $implCommaIJavaOptAtomType$ pkey, boolean forceRead ) {
	...
	@Override
	public ICFBamSchemaDefObj readCachedSchemaDef( $implCommaIJavaOptAtomType$ pkey ) {
		ICFBamSchemaDefObj obj = null;
	...
	public void reallyDeepDisposeSchemaDef( ICFBamSchemaDefObj obj )
	{
		...
		members.remove( pkey );
		ICFBamSchemaDefByCTenantIdxKey keyCTenantIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByCTenantIdxKey();
		keyCTenantIdx.setRequiredCTenantId( existing.getRequiredCTenantId() );

		ICFBamSchemaDefByMinorVersionIdxKey keyMinorVersionIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByMinorVersionIdxKey();
		keyMinorVersionIdx.setRequiredMinorVersionId( existing.getRequiredMinorVersionId() );

		ICFBamSchemaDefByUNameIdxKey keyUNameIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByUNameIdxKey();
		keyUNameIdx.setRequiredMinorVersionId( existing.getRequiredMinorVersionId() );
		keyUNameIdx.setRequiredName( existing.getRequiredName() );

		ICFBamSchemaDefByAuthEMailIdxKey keyAuthEMailIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByAuthEMailIdxKey();
		...
		ICFBamSchemaDefByProjectURLIdxKey keyProjectURLIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByProjectURLIdxKey();
		...
		ICFBamSchemaDefByPubURIIdxKey keyPubURIIdx = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByPubURIIdxKey();
	...
	@Override
	public void deepDisposeSchemaDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	@Override
	public ICFBamSchemaDefObj lockSchemaDef( $implCommaIJavaOptAtomType$ pkey ) {
	...
	public List<ICFBamSchemaDefObj> readAllSchemaDef( boolean forceRead ) {
		...
		if( ( allSchemaDef == null ) || forceRead ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> map = new HashMap<$implCommaIJavaOptAtomType$,ICFBamSchemaDefObj>();
			allSchemaDef = map;
		...
		boolean forceRead )
	{
		...
		Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict;
		if( indexByTenantIdx == null ) {
			indexByTenantIdx = new HashMap< ICFBamScopeByTenantIdxKey,
				Map< $implCommaIJavaOptAtomType$, ICFBamSchemaDefObj > >();
		}
		if( ( ! forceRead ) && indexByTenantIdx.containsKey( key ) ) {
			dict = indexByTenantIdx.get( key );
		}
		else {
			dict = new HashMap<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj>();
			ICFBamScopeObj obj;
		...
		String Name, boolean forceRead )
	{
		...
		ICFBamSchemaDefByUNameIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByUNameIdxKey();
		key.setRequiredMinorVersionId( MinorVersionId );
		...
		String PublishURI, boolean forceRead )
	{
		...
		ICFBamSchemaDefByPubURIIdxKey key = schema.getCFBamBackingStore().getCFBamFactory().getFactorySchemaDef().newByPubURIIdxKey();
		key.setRequiredCTenantId( CTenantId );
	...
	public void deleteSchemaDefByTenantIdx( ICFLibKeyHash256 TenantId )
	{
		...
		if( indexByTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict = indexByTenantIdx.get( key );
	...
	public void deleteSchemaDefByCTenantIdx( ICFLibKeyHash256 CTenantId )
	{
		...
		if( indexByCTenantIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict = indexByCTenantIdx.get( key );
	...
	public void deleteSchemaDefByMinorVersionIdx( ICFLibKeyHash256 MinorVersionId )
	{
		...
		if( indexByMinorVersionIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict = indexByMinorVersionIdx.get( key );
		...
		String AuthorEMail )
	{
		...
		if( indexByAuthEMailIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict = indexByAuthEMailIdx.get( key );
		...
		String ProjectURL )
	{
		...
		if( indexByProjectURLIdx.containsKey( key ) ) {
			Map<$implCommaIJavaOptAtomType$, ICFBamSchemaDefObj> dict = indexByProjectURLIdx.get( key );
