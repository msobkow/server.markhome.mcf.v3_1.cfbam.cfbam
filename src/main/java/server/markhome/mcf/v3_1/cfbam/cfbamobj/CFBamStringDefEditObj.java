// Description: Java 25 edit object instance implementation for CFBam StringDef.
	...
	implements ICFBamStringDefEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getStringDefTableObj().getClassCode() );
	}
	...
	public void copyRecToOrig() {
		ICFBamStringDef origRec = getOrigAsStringDef().getStringDefRec();
		ICFBamStringDef myRec = getStringDefRec();
		origRec.set( myRec );
	}
