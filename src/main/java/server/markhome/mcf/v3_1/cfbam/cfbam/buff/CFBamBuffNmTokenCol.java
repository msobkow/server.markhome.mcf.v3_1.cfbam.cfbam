	...
	implements ICFBamNmTokenCol
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenCol rhs ) {
		...
		else if( obj instanceof ICFBamNmTokenColH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNmTokenCol ) {
			setNmTokenCol( (CFBamProtBuffNmTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenCol ) {
			setNmTokenCol( (CFBamPubBuffNmTokenCol)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
