	...
	implements ICFBamUInt16Type
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamUInt16Type rhs ) {
		...
		else if( obj instanceof ICFBamUInt16TypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffUInt16Type ) {
			setUInt16Type( (CFBamProtBuffUInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffUInt16Type ) {
			setUInt16Type( (CFBamPubBuffUInt16Type)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
