...
// Description: Java 25 Factory service implementation for DbKeyHash128Type buffers
...
/*
 *	Java 25 Factory service implementation for DbKeyHash128Type buffers.
 */
@Service("cfbam31BuffDbKeyHash128TypeFactoryService")
public class CFBamBuffDbKeyHash128TypeFactoryService
	implements ICFBamDbKeyHash128TypeFactory
{
	public CFBamBuffDbKeyHash128TypeFactoryService() {
	}
