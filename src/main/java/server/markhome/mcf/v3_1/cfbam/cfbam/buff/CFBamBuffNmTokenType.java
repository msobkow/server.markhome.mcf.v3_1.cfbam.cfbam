	...
	implements ICFBamNmTokenType
{
	...
	public boolean equals( Object obj ) {
		...
		else if( obj instanceof ICFBamNmTokenType rhs ) {
		...
		else if( obj instanceof ICFBamNmTokenTypeH rhs ) {
			if( getRequiredId() != null ) {
				if( rhs.getRequiredId() != null ) {
					if( ! getRequiredId().equals( rhs.getRequiredId() ) ) {
						return( false );
	...
	public void set( ICFBamProtValue src ) {
		if( src instanceof CFBamProtBuffNmTokenType ) {
			setNmTokenType( (CFBamProtBuffNmTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
	...
	public void set( ICFBamPubValue src ) {
		if( src instanceof CFBamPubBuffNmTokenType ) {
			setNmTokenType( (CFBamPubBuffNmTokenType)src );
		}
		else {
			throw new CFLibUnsupportedClassException( getClass(),
				"compareTo",
