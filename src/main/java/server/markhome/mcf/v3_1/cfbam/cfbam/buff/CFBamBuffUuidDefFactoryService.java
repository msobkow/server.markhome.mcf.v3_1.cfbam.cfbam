...
// Description: Java 25 Factory service implementation for UuidDef buffers
...
/*
 *	Java 25 Factory service implementation for UuidDef buffers.
 */
@Service("cfbam31BuffUuidDefFactoryService")
public class CFBamBuffUuidDefFactoryService
	implements ICFBamUuidDefFactory
{
	public CFBamBuffUuidDefFactoryService() {
	}
			...
			switch (rec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureRec",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUuidDef",
						"Unsupported class code " + rec.getClassCode() + " is not a derivative of CFBamUuidDef");
			}
		}
	}
			...
			switch (hrec.getClassCode()) {
				...
				default:
					throw new CFLibUnsupportedClassException(getClass(), "ensureHRec",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUuidDef",
						"Unsupported class code " + hrec.getClassCode() + " is not a derivative of CFBamUuidDef");
			}
		}
	}
