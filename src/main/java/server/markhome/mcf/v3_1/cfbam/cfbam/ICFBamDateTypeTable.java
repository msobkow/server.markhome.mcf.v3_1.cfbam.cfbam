...
// Description: Java 25 DbIO interface for DateType.
...
/*
 *	CFBamDateTypeTable database interface for DateType has CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamDateTypeTable
{
	 ...
	 */
	ICFBamDateType createDateType( ICFSecAuthorization Authorization,
		ICFBamDateType rec );
	 ...
	 */
	ICFBamDateType updateDateType( ICFSecAuthorization Authorization,
		ICFBamDateType rec );
	 ...
	 */
	void deleteDateType( ICFSecAuthorization Authorization,
		ICFBamDateType rec );
	/**
	 ...
	 */
	ICFBamDateType[] readAllDerived( ICFSecAuthorization Authorization );
	 ...
	 */
	ICFBamDateType[] readAllRec( ICFSecAuthorization Authorization );
