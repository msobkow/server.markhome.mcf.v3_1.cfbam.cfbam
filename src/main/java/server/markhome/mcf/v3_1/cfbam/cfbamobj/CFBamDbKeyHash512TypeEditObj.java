// Description: Java 25 edit object instance implementation for CFBam DbKeyHash512Type.
	...
	implements ICFBamDbKeyHash512TypeEditObj
{
	...
	public int getClassCode() {
		return( ((ICFBamSchemaObj)orig.getSchema()).getDbKeyHash512TypeTableObj().getClassCode() );
	}
	...
	public ICFBamValue getRec() {
		if( rec == null ) {
			rec = getOrigAsDbKeyHash512Type().getSchema().getCFBamBackingStore().getCFBamFactory().getFactoryDbKeyHash512Type().newRec();
			rec.set( orig.getRec() );
		}
		return( rec );
	}
	...
	public ICFBamSchemaDefObj getRequiredContainerSchemaDef( boolean forceRead ) {
		if( forceRead || ( requiredContainerSchemaDef == null ) ) {
			...
			if( ! anyMissing ) {
				ICFBamSchemaDefObj obj = ((ICFBamSchemaObj)getOrigAsDbKeyHash512Type().getSchema()).getSchemaDefTableObj().readSchemaDefByIdIdx( getDbKeyHash512TypeRec().getRequiredSchemaDefId() );
	...
	public void setRequiredContainerSchemaDef( ICFBamSchemaDefObj value ) {
		if( rec == null ) {
			getDbKeyHash512TypeRec();
		}
		if( value != null ) {
			requiredContainerSchemaDef = value;
			getDbKeyHash512TypeRec().setRequiredContainerSchemaDef(value.getSchemaDefRec());
		}
		requiredContainerSchemaDef = value;
	...
	public void copyRecToOrig() {
		ICFBamDbKeyHash512Type origRec = getOrigAsDbKeyHash512Type().getDbKeyHash512TypeRec();
		ICFBamDbKeyHash512Type myRec = getDbKeyHash512TypeRec();
		origRec.set( myRec );
	}
