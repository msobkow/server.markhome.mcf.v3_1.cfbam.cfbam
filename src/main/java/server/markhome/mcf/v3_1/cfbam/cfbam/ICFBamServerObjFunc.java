// Description: Java 25 interface for a ServerObjFunc record implementation
...
/**
 *	ICFBamServerObjFunc persistence instances have CodeVis Public, meaning that any user interface or referencing schema can access it.
 */
public interface ICFBamServerObjFunc extends ICFBamServerMethod
{
